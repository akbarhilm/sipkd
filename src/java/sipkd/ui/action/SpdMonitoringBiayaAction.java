 ...
 */
@Controller
@RequestMapping("/spd/monitoringbiaya")
public class SpdMonitoringBiayaAction {

    private static final Logger log = LoggerFactory.getLogger(SpdMonitoringBiayaAction.class);
    @Autowired
    ...
    public String index(HttpServletRequest request) {
        ...
        return "spd/monitoring/monitoringbiaya";
   ...
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            map.put("np", spdService.getnilaiparam(map));
                        ...
                        final String filename = tahunAnggaran+"-"+"SPD-MONITORING-BIAYA"+"-" +idskpd+".pdf";
