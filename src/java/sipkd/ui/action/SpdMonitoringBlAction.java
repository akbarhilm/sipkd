 ...
 */
@Controller
@RequestMapping("/spd/monitoringbl")
public class SpdMonitoringBlAction {

    private static final Logger log = LoggerFactory.getLogger(SpdMonitoringBlAction.class);
    @Autowired
    ...
    public String index(HttpServletRequest request) {
        ...
        return "spd/monitoring/monitoringbl";
   ...
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            map.put("np", spdService.getnilaiparam(map));
                        ...
                        final String filename = tahunAnggaran+"-"+"SPD-MONITORING-BL"+"-"+idskpd+".pdf";
