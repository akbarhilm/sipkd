 ...
 */
@Controller
@RequestMapping("/spd/monitoringbantuan")
public class SpdMonitoringBantuanAction {

    private static final Logger log = LoggerFactory.getLogger(SpdMonitoringBantuanAction.class);
    @Autowired
    ...
    public String index(HttpServletRequest request) {
        ...
        return "spd/monitoring/monitoringbantuan";
   ...
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            map.put("np", spdService.getnilaiparam(map));
                        ...
                        final String filename = tahunAnggaran+"-"+"SPD-MONITORING-BANTUAN"+"-"+idskpd+".pdf";
