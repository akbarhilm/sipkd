...
import sipkd.services.SpdBiayaService;
import sipkd.util.BigDecimalPropertyEditor;
import sipkd.util.SipkdHelpers;
import sipkd.util.SqlDatePropertyEditor;

@Controller
@RequestMapping("/spd/pengajuanbiaya")
public class SpdPengajuanBiayaAction {

    private static final Logger log = LoggerFactory.getLogger(SpdPengajuanBiayaAction.class);
    @Autowired
    SpdBiayaService spdBiayaService;
    ...
    @RequestMapping(value = "/biaya/index", method = RequestMethod.GET)
    public String index(final HttpServletRequest request) {
        ...
        return "spd/pengajuanspd/indexbiaya";
    ...
    Map<String, BigDecimal> getpagudansisa(@PathVariable Integer id, final HttpServletRequest request) {
        final String tahunAnggaran = (String) request.getSession().getAttribute("tahunAnggaran");
        return spdBiayaService.getPaguDanSisa(id, tahunAnggaran);
    }
    ...
    Map<String, Object> getlistspd(final HttpServletRequest request) {
        ...
        final Map<String, Object> mapData = new HashMap<String, Object>(4);
        final long banyak = spdBiayaService.getBanyakAnggaranBtlSkpd(param);
        mapData.put("sEcho", request.getParameter("sEcho"));
        mapData.put("iTotalRecords", banyak);
        mapData.put("iTotalDisplayRecords", banyak);
        mapData.put("aaData", spdBiayaService.getAnggaranBtlSkpd(param));
        return mapData;
    ...
    public ModelAndView spdbtladd(SpdBTLMaster spdBTLMaster, final HttpServletRequest request) {
        ...
        return new ModelAndView("spd/pengajuanspd/addpengajuanspdbiaya", "spdBTLMaster", spdBTLMaster);
    ...
    @RequestMapping(value = "/biaya/edit/{id}", method = RequestMethod.GET)
    public ModelAndView spdbtledit(@PathVariable Integer id, final HttpServletRequest request) {
        ...
        return new ModelAndView("spd/pengajuanspd/addpengajuanspdbiaya", "spdBTLMaster", spdBiayaService.getdataspdbtlmaster(id));
    ...
    Map<String, BigDecimal> getanggarandanspd(@PathVariable Integer id, final HttpServletRequest request) {
        ...
        param.put("tahun", tahunAnggaran);
        param.put("idskpd", id);
        return spdBiayaService.getTotalAnggaranDanSpd(param);
    }
    ...
    List<SpdBtlDetail> getspddetaillist(@PathVariable Integer id, final HttpServletRequest request) {
        ...
        return spdBiayaService.getListSPDDetailBySKPDDanTahun(param, 1);
    }
    ...
    Map<String, Object> getlistspddetailbyskpddantahun(final HttpServletRequest request) {
        ...
        final Map<String, Object> mapData = new HashMap<String, Object>(4);
        final int banyak = spdBiayaService.getBanyakTotalSPDBySKPDDanTahun(param);
        mapData.put("sEcho", request.getParameter("sEcho"));
        mapData.put("iTotalRecords", banyak);
        mapData.put("iTotalDisplayRecords", banyak);
        mapData.put("aaData", spdBiayaService.getListSPDDetailBySKPDDanTahun(param, (SipkdHelpers.equals(addoredit, "1") ? 1 : 2)));
        return mapData;
    }
    ...
    public String prosessimpanspdbtl(@Valid @ModelAttribute("spdBTLMaster") SpdBTLMaster spdBTLMaster,
        ...
        StringBuilder sburl = new StringBuilder("redirect:/spd/pengajuanbiaya/biaya/edit/");
        if (result.hasErrors()) {
            return "spd/pengajuanspd/addpengajuanspdbiaya";
        } else {
            ...
            if (spdBTLMaster.getIdSpd() != null && spdBTLMaster.getIdSpd().longValue() > 0) {
                spdBiayaService.updatespdmaster(spdBTLMaster);
                sburl.append(spdBTLMaster.getIdSpd());
            } else {
                spdBiayaService.insertspdmaster(spdBTLMaster);
        ...
        for (String nospdakun : listNomorSpd) {
            ...
            if (nilaiSpdX != null && !nilaiSpdX.isEmpty()) {
                ...
                if (nilaiAnggSpd.compareTo(new BigDecimal(0)) > 0) {
                    ...
                    final boolean isupdate = spdBiayaService.getcekspddetailbyidspdandidbtl(parammap) > 0;
                    int  idpengguna = 0;
                    try {
                    ...
                    spdBiayaService.hapusspdrincibtlbyakundanspd(parammaphapus);
                }
    ...
    String submitcetak(@RequestBody List<Map<String, Object>> mapdata, final HttpServletRequest request) {
        ...
        for (Map<String, Object> mapdetil : mapdata) {
            ...
            spdBiayaService.insertspdcetak(mapdetil);
        }
    ...
    String hapusspddanrincibyspd(@RequestBody Map<String, Object> mapdata, final HttpServletRequest request) {
        spdBiayaService.hapusspddanspdrincibtl((Integer) mapdata.get("idspd"));
    ...
    Map<String, Object> getlistspdcetak(final HttpServletRequest request) {
        ...
        log.debug(param.toString());
        final Map<String, Object> mapData = new HashMap<String, Object>(4);
        final long banyak = spdBiayaService.getbanyakcetakspdbtl(param);
        mapData.put("sEcho", request.getParameter("sEcho"));
        mapData.put("iTotalRecords", banyak);
        mapData.put("iTotalDisplayRecords", banyak);
        mapData.put("aaData", spdBiayaService.getlistcetakspdbtl(param));
        return mapData;
    ...
    public void downloadPdfSpdBtl(HttpServletResponse response, @PathVariable Integer id) throws IOException {
        ...
        final Map uploadlog = spdBiayaService.getcetakspdbyidspd(id);
    ...
    String submitvalidasi(@RequestBody List<String> listidspd, final HttpServletRequest request) {
        ...
        for (String idspd : listidspd) {
            ...
            spdBiayaService.insertspdsah(parameter);
        }
