...
public interface SpdBlRevMapper {
    ...
    Integer getBanyakSPDDetailBelanjaLangsungBySKPDDanTahunEdit(Map< String, Object> param);

    Integer getBanyakTotalSPDBySKPDDanTahunEdit(Map< String, Object> param);
}
