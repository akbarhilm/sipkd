...
public class SipkdHelpers {
    ...
    public static String getStringDateFormatFromString(String param, final String formatOut, final String formatIn) {
        logger.debug("param = " + param);
        if (param != null && StringUtils.isNotEmpty(param) && StringUtils.isNotBlank(param)) {
            try {
    ...
    public static void main(String[] args) {
        logger.error(" = " + SipkdHelpers.getStringDateFormatFromString("05/03/2015","yyyyMMdd","dd/MM/yyyy"));
    }
