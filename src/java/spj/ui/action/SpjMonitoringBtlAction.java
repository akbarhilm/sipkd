...
public class SpjMonitoringBtlAction {

    private static final Logger log = LoggerFactory.getLogger(SpjMonitoringBtlAction.class);
    @Autowired
   ...
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            map.put("np", spjService.getnilaiparam(map));
                        ...
                        final String filename = tahunAnggaran+"-"+"SPJ-MONITORING-BTL"+"-"+idskpd+".pdf";
