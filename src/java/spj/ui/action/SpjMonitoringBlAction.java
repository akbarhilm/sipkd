 ...
 */
@Controller
@RequestMapping("/monitoringbl")
public class SpjMonitoringBlAction {

    private static final Logger log = LoggerFactory.getLogger(SpjMonitoringBlAction.class);
    @Autowired
    ...
    @RequestMapping(value = "/indexmonitoringbl", method = RequestMethod.GET)
    public String index(HttpServletRequest request) {
        final Pengguna pengguna = (Pengguna) request.getSession().getAttribute("pengguna");
              
        return "monitoring/monitoringbl";

    }

    
    
  @RequestMapping(value = "/json/prosescetakbl", method = RequestMethod.GET)
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            map.put("np", spjService.getnilaiparam(map));
                        ...
                        map.put("pathreport", pathReport + "/Report_MonitoringPengeluaran_BL.jasper");
                        JasperPrint jasperPrint = cetakReportServices.cetakReport(map);
                        //JasperPrint jasperPrint = JasperFillManager.fillReport( pathReport+"/Report_MonitoringPengeluaran_BL.jasper", map, jdbcConnection);
                        final String filename = tahunAnggaran+"-"+"SPJ-MONITORING-BL"+"-"+idskpd+".pdf";
