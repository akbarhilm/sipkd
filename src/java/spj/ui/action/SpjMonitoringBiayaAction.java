...
public class SpjMonitoringBiayaAction {

    private static final Logger log = LoggerFactory.getLogger(SpjMonitoringBiayaAction.class);
    @Autowired
   ...
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            map.put("np", spjService.getnilaiparam(map));
                        ...
                        final String filename = tahunAnggaran+"-"+"SPJ-MONITORING-BIAYA"+"-"+idskpd+".pdf";
