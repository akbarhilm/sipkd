...
import spj.services.BukuBesarJurnalSkpdAllServices;
 ...
 */
@Controller
@RequestMapping("/bukubesarskpdall")
public class BukuBesarJurnalSkpdAllAction {

    private static final Logger log = LoggerFactory.getLogger(BukuBesarJurnalSkpdAllAction.class);
    @Autowired
    CetakReportServices cetakReportServices;
    
    @Autowired
    BukuBesarJurnalSkpdAllServices cetakService;
    ...
    @RequestMapping(value = "/indexbbskpdall", method = RequestMethod.GET)
    public ModelAndView addjournal(final BukuBesar bukubesar, final HttpServletRequest request) {
        
        return new ModelAndView("bukubesar/bukubesarskpdall", "refbukubesar", bukubesar);
    }
    ...
    public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if (kodeakun.equals(ppkd)){
                map.put("pathreport", pathReport + "/Report_JurnalBukuBesar-PPKD.jasper");
                        JasperPrint jasperPrint = cetakReportServices.cetakReport(map);
                 //JasperPrint jasperPrint = JasperFillManager.fillReport( pathReport+"/Report_JurnalBukuBesar-PPKD.jasper", map, jdbcConnection);
                 final String filename = tahunAnggaran+"-"+"JURNAL-BUKU-BESAR-PPKD"+"-"+idskpd+"-"+kodeakun+".pdf";
