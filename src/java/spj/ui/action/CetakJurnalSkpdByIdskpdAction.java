 ...
 */
@Controller
@RequestMapping("/cetakbyidskpd")
public class CetakJurnalSkpdByIdskpdAction {

    private static final Logger log = LoggerFactory.getLogger(CetakJurnalSkpdByIdskpdAction.class);
    @Autowired
    ...
    public ModelAndView add(final CetakSkpd cetak, final HttpServletRequest request, Model model) {
        ...
        return new ModelAndView("cetak/jurskpdbyidskpd", "refcetak", cetak);
    }
