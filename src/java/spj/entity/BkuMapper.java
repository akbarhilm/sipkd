...
public interface BkuMapper {
    ...
    Integer getBkuNoPpkd(Map param);

    void insertBkuCek(BukuKasUmum param);

    void insertBkuCekPg(BukuKasUmum param);

    void updateBkuCek(BukuKasUmum param);

    void updateBkuCekPg(BukuKasUmum param);
    ...
    void insertBkuNpPn(BukuKasUmum param);

    void insertBkuNpPg(BukuKasUmum param);

    void insertBkuNmPn(BukuKasUmum param);

    void insertBkuNmPg(BukuKasUmum param);
    ...
    void updateBkuNP(BukuKasUmum param);

    void updateBkuNPTunai(BukuKasUmum param);

    void updateBkuNM(BukuKasUmum param);

    void updateBkuNMTunai(BukuKasUmum param);
    ...
    void deleteById(BukuKasUmum param);
    ...
    void updateBkuNpd(BukuKasUmum param);

    void updateBkuNpdPg(BukuKasUmum param);
    ...
    void updateBkuNoRef(BukuKasUmum param);

    void updateBkuPjPg(BukuKasUmum param);

    void updateNilaiPajak(BukuKasUmum param);
