 ...
 */
@Controller
@RequestMapping("/cetaksp2dpotbtlblhardaf")
public class CetakSp2dPotBtlBlHarDafAction {

    private static final Logger log = LoggerFactory.getLogger(CetakSp2dPotBtlBlHarDafAction.class);
    @Autowired
    ...
    @RequestMapping(value = "/indexsp2dpotbtlblhardaf", method = RequestMethod.GET)
    public String indexspmup(HttpServletRequest request) {
        ...
        return "cetak/sp2d/potonganbtlblhariandaf";
   ...
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            map.put("np", cetakValidasiSP2DServices.getnilaiparam(map));
                        ...
                        JasperPrint jasperPrint = JasperFillManager.fillReport( pathReport+"/Report_DaftarPotongan-Harian.jasper", map, jdbcConnection);
                        final String filename = tahunAnggaran+"-"+"SP2D-DAFTAR-POT-BTLBL-HARIAN"+"-"+kodewilayah+"-"+tanggal+".pdf";
