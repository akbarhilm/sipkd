...
public class Sp2dMonitoringBiayaAction {

    private static final Logger log = LoggerFactory.getLogger(Sp2dMonitoringBiayaAction.class);
    @Autowired
   ...
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            map.put("np", sp2dService.getnilaiparam(map));
                        ...
                        final String filename = tahunAnggaran+"-"+"SP2D-MONITORING-BIAYA"+"-" +idskpd+".pdf";
