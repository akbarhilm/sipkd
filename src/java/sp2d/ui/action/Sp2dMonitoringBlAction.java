...
public class Sp2dMonitoringBlAction {

    private static final Logger log = LoggerFactory.getLogger(Sp2dMonitoringBlAction.class);
    @Autowired
   ...
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            map.put("np", sp2dService.getnilaiparam(map));
                        ...
                        final String filename = tahunAnggaran+"-"+"SP2D-MONITORING-BL"+"-"+idskpd+".pdf";
