 ...
 */
@Controller
@RequestMapping("/cetaksspppn")
public class CetakSSPPPNAction {

    private static final Logger log = LoggerFactory.getLogger(CetakSSPPPNAction.class);
    @Autowired
    ...
    @RequestMapping(value = "/indexppn", method = RequestMethod.GET)
   ...
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            map.put("np", cetakValidasiSP2DServices.getnilaiparam(map));
                        ...
                        JasperPrint jasperPrint = JasperFillManager.fillReport( pathReport+"/Report_CetakSSP_PPN.jasper", map, jdbcConnection);
                        final String filename = tahunAnggaran+"-"+"SSP-PPN"+"-"+kodewilayah+"-"+nosp2d+".pdf";
