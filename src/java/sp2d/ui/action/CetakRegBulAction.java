 ...
 */
@Controller
@RequestMapping("/registerbul")
public class CetakRegBulAction {

    private static final Logger log = LoggerFactory.getLogger(CetakRegBulAction.class);
    @Autowired
    ...
    @RequestMapping(value = "/indexregbul", method = RequestMethod.GET)
    public String indexspmup(HttpServletRequest request) {
        ...
        return "cetak/register/registerbulan";
   ...
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        final String kodewilayah = request.getParameter("kproses");
            ...
            final String bln = SipkdHelpers.getStringDateFormatFromString(bulan, "yyyyMM", "MM/yyyy");
        ...
        try {
            ...
            map.put("np", cetakValidasiSP2DServices.getnilaiparam(map));
                        ...
                        JasperPrint jasperPrint = JasperFillManager.fillReport( pathReport+"/Report_RegisterSP2D_Bulanan.jasper", map, jdbcConnection);
                        final String filename = tahunAnggaran+"-"+"REGISTER_SP2D_BULANAN"+"-"+kodewilayah+"-"+bulan+".pdf";
