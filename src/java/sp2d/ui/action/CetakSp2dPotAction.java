 ...
 */
@Controller
@RequestMapping("/cetaksp2dpot")
public class CetakSp2dPotAction {

    private static final Logger log = LoggerFactory.getLogger(CetakSp2dPotAction.class);
    @Autowired
    ...
    @RequestMapping(value = "/indexsp2dpot", method = RequestMethod.GET)
   ...
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            map.put("np", cetakValidasiSP2DServices.getnilaiparam(map));
                        ...
                        map.put("KODE_WILAYAH",kodewilayah);
                        ...
                        final String filename = tahunAnggaran+"-"+"SP2DPOT"+"-"+kodewilayah+"-"+tanggal+".pdf";
