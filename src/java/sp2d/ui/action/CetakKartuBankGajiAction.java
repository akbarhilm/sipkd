 ...
 */
@Controller
@RequestMapping("/cetakkartubankgaji")
public class CetakKartuBankGajiAction {

    private static final Logger log = LoggerFactory.getLogger(CetakKartuBankGajiAction.class);
    @Autowired
    ...
    @RequestMapping(value = "/indexgaji", method = RequestMethod.GET)
    public String indexspmup(HttpServletRequest request) {
        ...
        return "cetak/kartubank/kartubankgaji";
   ...
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            map.put("np", cetakValidasiSP2DServices.getnilaiparam(map));
                        ...
                        JasperPrint jasperPrint = JasperFillManager.fillReport( pathReport+"/Report_KartuBank-GAJI.jasper", map, jdbcConnection);
                        final String filename = tahunAnggaran+"-"+"KARTUBANKGAJI"+"-"+kodewilayah+"-"+tanggal+".pdf";
