 ...
 */
@Controller
@RequestMapping("/registerhar")
public class CetakRegHarAction {

    private static final Logger log = LoggerFactory.getLogger(CetakRegHarAction.class);
    @Autowired
    ...
    @RequestMapping(value = "/indexreghar", method = RequestMethod.GET)
    public String indexspmup(HttpServletRequest request) {
        ...
        return "cetak/register/registerhari";
   ...
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            map.put("np", cetakValidasiSP2DServices.getnilaiparam(map));
                        ...
                        JasperPrint jasperPrint = JasperFillManager.fillReport( pathReport+"/Report_RegisterSP2D_Harian.jasper", map, jdbcConnection);
                        final String filename = tahunAnggaran+"-"+"REGISTER_SP2D_HARIAN"+"-"+kodewilayah+"-"+tanggal+".pdf";
