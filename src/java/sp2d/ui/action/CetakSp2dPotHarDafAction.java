 ...
 */
@Controller
@RequestMapping("/cetaksp2dpothardaf")
public class CetakSp2dPotHarDafAction {

    private static final Logger log = LoggerFactory.getLogger(CetakSp2dPotHarDafAction.class);
    @Autowired
    ...
    @RequestMapping(value = "/indexsp2dpothardaf", method = RequestMethod.GET)
    public String indexspmup(HttpServletRequest request) {
        ...
        return "cetak/sp2d/potonganhariandaf";
   ...
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            map.put("np", cetakValidasiSP2DServices.getnilaiparam(map));
                        ...
                        JasperPrint jasperPrint = JasperFillManager.fillReport( pathReport+"/Report_PotonganHarian.jasper", map, jdbcConnection);
                        final String filename = tahunAnggaran+"-"+"SP2DDAFTARPOTHARIAN"+"-"+kodewilayah+"-"+tanggal+".pdf";
