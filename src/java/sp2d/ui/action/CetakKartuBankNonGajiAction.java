 ...
 */
@Controller
@RequestMapping("/cetakkartubanknongaji")
public class CetakKartuBankNonGajiAction {

    private static final Logger log = LoggerFactory.getLogger(CetakKartuBankNonGajiAction.class);
    @Autowired
    ...
    @RequestMapping(value = "/indexnongaji", method = RequestMethod.GET)
    public String indexspmup(HttpServletRequest request) {
        ...
        return "cetak/kartubank/kartubanknongaji";
   ...
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            map.put("np", cetakValidasiSP2DServices.getnilaiparam(map));
                        ...
                        JasperPrint jasperPrint = JasperFillManager.fillReport( pathReport+"/Report_KartuBank-KPKD.jasper", map, jdbcConnection);
                        final String filename = tahunAnggaran+"-"+"KARTUBANKNONGAJI"+"-"+kodewilayah+"-"+tanggal+".pdf";
