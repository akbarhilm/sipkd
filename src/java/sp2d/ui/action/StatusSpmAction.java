...
import sp2d.services.StatusSpmServices;
 ...
 */
@Controller
@RequestMapping("/statusspm")
public class StatusSpmAction {

    private static final Logger log = LoggerFactory.getLogger(StatusSpmAction.class);

    @Autowired
    StatusSpmServices akunServices;
    @Autowired
    ...
    */
    ...
    Map<String, Object> listakunjson(final HttpServletRequest request) {
        ...
        final String wilayahsp2d = request.getParameter("wilayahsp2d");
        ...
        param.put("wilayahsp2d", wilayahsp2d);
        ...
        final long banyak = akunServices.getBanyakSp2dWilayah(param);
        mapData.put("sEcho", request.getParameter("sEcho"));
        mapData.put("iTotalRecords", banyak);
        mapData.put("iTotalDisplayRecords", banyak);
        mapData.put("aaData", akunServices.getSp2dWilayah(param));
        return mapData;
    }
   ...
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            final String wilayahsp2d = request.getParameter("wilayahsp2d");
          log.debug("Path nya ==> "+pathReport);
            map.put("SUBREPORT_DIR", pathReport);
            map.put("TAHUN", tahunAnggaran);
            map.put("WILAYAHSP2D",wilayahsp2d);
            JasperPrint jasperPrint = JasperFillManager.fillReport( pathReport+"/STATUS_SPM.jasper", map, jdbcConnection);
            final String filename = tahunAnggaran+"-"+wilayahsp2d+"STATUS-SPM.pdf";
