 ...
 */
@Controller
@RequestMapping("/cetakssppph21")
public class CetakSSPPPh21Action {

    private static final Logger log = LoggerFactory.getLogger(CetakSSPPPh21Action.class);
    @Autowired
    ...
    @RequestMapping(value = "/indexpph21", method = RequestMethod.GET)
   ...
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            map.put("np", cetakValidasiSP2DServices.getnilaiparam(map));
                        ...
                        JasperPrint jasperPrint = JasperFillManager.fillReport( pathReport+"/Report_CetakSSP_PPH21.jasper", map, jdbcConnection);
                        final String filename = tahunAnggaran+"-"+"SSP-PPh21"+"-"+kodewilayah+"-"+nosp2d+".pdf";
