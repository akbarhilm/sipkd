 ...
 */
@Controller
@RequestMapping("/cetaksp2dpotbuldaf")
public class CetakSp2dPotBulDafAction {

    private static final Logger log = LoggerFactory.getLogger(CetakSp2dPotBulDafAction.class);
    @Autowired
    ...
    @RequestMapping(value = "/indexsp2dpotbuldaf", method = RequestMethod.GET)
    public String indexspmup(HttpServletRequest request) {
        ...
        return "cetak/sp2d/potonganbulanandaf";
   ...
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            final String bulan =  tahunAnggaran+request.getParameter("tgl");
            //log.debug(data);
            ...
            map.put("np", cetakValidasiSP2DServices.getnilaiparam(map));
                        ...
                        JasperPrint jasperPrint = JasperFillManager.fillReport( pathReport+"/Report_PotonganBulanan.jasper", map, jdbcConnection);
                        final String filename = tahunAnggaran+"-"+"SP2DDAFTARPOTBULANAN"+"-"+kodewilayah+"-"+bulan+".pdf";
