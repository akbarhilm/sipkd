 ...
 */
@Controller
@RequestMapping("/cetaksp2dpotharrek")
public class CetakSp2dPotHarRekAction {

    private static final Logger log = LoggerFactory.getLogger(CetakSp2dPotHarRekAction.class);
    @Autowired
    ...
    @RequestMapping(value = "/indexsp2dpotharrek", method = RequestMethod.GET)
    public String indexspmup(HttpServletRequest request) {
        ...
        return "cetak/sp2d/potonganharianrek";
    ...
    public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            final String data = request.getParameter("data");
             log.debug("|  pathReport  "+pathReport);
            ...
            JasperPrint jasperPrint = JasperFillManager.fillReport(pathReport+"/Report_PotonganHarian_Rekap.jasper", map, jdbcConnection);
            
            final String filename = tahunAnggaran+"-"+"SP2DREKAPPOTHARIAN"+"-"+kodewilayah+"-"+tanggal+".pdf";
