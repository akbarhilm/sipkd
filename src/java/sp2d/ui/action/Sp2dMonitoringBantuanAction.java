...
public class Sp2dMonitoringBantuanAction {

    private static final Logger log = LoggerFactory.getLogger(Sp2dMonitoringBantuanAction.class);
    @Autowired
    CetakValidasiSP2DServices sp2dService;
  ...
  @RequestMapping(value = "/json/prosescetakbantuan", method = RequestMethod.GET)
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            map.put("np", sp2dService.getnilaiparam(map));
                        ...
                        final String filename = tahunAnggaran+"-"+"SP2D-MONITORING-BANTUAN"+"-"+idskpd+".pdf";
