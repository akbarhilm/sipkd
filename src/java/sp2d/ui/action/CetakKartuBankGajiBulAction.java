 ...
 */
@Controller
@RequestMapping("/cetakkartubankgajibul")
public class CetakKartuBankGajiBulAction {

    private static final Logger log = LoggerFactory.getLogger(CetakKartuBankGajiBulAction.class);
    @Autowired
    ...
    @RequestMapping(value = "/indexgajibul", method = RequestMethod.GET)
    public String indexspmup(HttpServletRequest request) {
        ...
        return "cetak/kartubank/kartubankgajibul";
   ...
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            map.put("np", cetakValidasiSP2DServices.getnilaiparam(map));
                        ...
                        JasperPrint jasperPrint = JasperFillManager.fillReport( pathReport+"/Report_KartuBank-GAJI_BLN.jasper", map, jdbcConnection);
                        final String filename = tahunAnggaran+"-"+"KARTUBANKGAJI-BULANAN"+"-"+kodewilayah+"-"+tanggal+".pdf";
