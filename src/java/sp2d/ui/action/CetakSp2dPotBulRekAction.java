 ...
 */
@Controller
@RequestMapping("/cetaksp2dpotbulrek")
public class CetakSp2dPotBulRekAction {

    private static final Logger log = LoggerFactory.getLogger(CetakSp2dPotBulRekAction.class);
    @Autowired
    ...
    @RequestMapping(value = "/indexsp2dpotbulrek", method = RequestMethod.GET)
    public String indexspmup(HttpServletRequest request) {
        ...
        return "cetak/sp2d/potonganbulananrek";
    ...
    public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            JasperPrint jasperPrint = JasperFillManager.fillReport(pathReport + "/Report_PotonganBulanan_Rekap.jasper", map, jdbcConnection);
            final String filename = tahunAnggaran + "-" + "SP2DREKAPPOTBULANAN" + "-" + kodewilayah + "-" + bulan + ".pdf";
