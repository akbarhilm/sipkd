 ...
 * @author sapto
 */
@Service("userManagement2Services")
public class UserManagementImpl_tanpaencrypt extends JdbcDaoSupport implements UserManagementServices {
    
     private static final Logger log = LoggerFactory.getLogger(UserManagementImpl_tanpaencrypt.class);
    
    @Autowired
    public UserManagementImpl_tanpaencrypt(DataSource dataSource) {
        setDataSource(dataSource);
    }

    public UserManagementImpl_tanpaencrypt() {
    }
