...
@Service("SpmBtlLsServices")
public class SpmBtlLsImpl implements SpmBtlLsServices {

    private static final Logger log = LoggerFactory.getLogger(SpmBtlLsImpl.class);
    @Autowired
    private SpmBtlLsMapper spmBtlLsMapper;
    
    @Autowired
    private GenNumberMapper genNumberMapper;
    
    @Override
    public List<SpmBtlLs> getAllSpmBtlLs(Map param) {
        return spmBtlLsMapper.getAllSpmBtlLs(param);
    }

    @Override
    public Integer getBanyakSpmBtlLs(Map param) {
        return spmBtlLsMapper.getBanyakSpmBtlLs(param);

    }
    
     @Override
    public SpmBtlLs getSpmBtlLsById(Integer param) {
        return spmBtlLsMapper.getSpmBtlLsById(param);
    }
    
     @Override
    public BigDecimal getPotonganValidator(Integer param) {
        return spmBtlLsMapper.getPotonganValidator(param);
    }
        
     @Override
    public Integer getIdSpmByIdSpp(Integer param) {
        return spmBtlLsMapper.getIdSpmByIdSpp(param);
    }
    
     @Override
    public Integer getCekSpm(Integer param) {
        return spmBtlLsMapper.getCekSpm(param);
    }
    ...
    public Map<String, BigDecimal> getTotalAnggaranDanSpd(Map<String, Object> param) {
        ...
        BigDecimal totalanggup = spmBtlLsMapper.getTotalPaguBySkpd(param);
        hasil.put("anggaran", totalanggup);
        try {
            hasil.put("spd", totalanggup.subtract(spmBtlLsMapper.getTotalSPDBySKPDDanTahun(param)));
        } catch (Exception e) {
    ...
    public void updateSpmBtlLsMaster(SpmBtlLs spmBtlLs) {
        spmBtlLsMapper.updateSpmBtlLsMaster(spmBtlLs);
    }  
    
    @Override
    public List<SpmBtlLsRinci> getAllSpdBtl(Map param) {
        return spmBtlLsMapper.getAllSpdBtl(param);
    }

    @Override
    public Integer getBanyakSpdBtl(Map param) {
        return spmBtlLsMapper.getBanyakSpdBtl(param);

    }
    
    @Override
    @Transactional(readOnly = false)
    public void insertSpmBtlLsMaster(SpmBtlLs spmBtlLs) {
        ...
        spmBtlLsMapper.insertSpmBtlLsMaster(spmBtlLs);
