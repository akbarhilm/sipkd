...
public class SpmMonitoringBtlAction {

    private static final Logger log = LoggerFactory.getLogger(SpmMonitoringBtlAction.class);
    @Autowired
   ...
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            map.put("np", spmService.getnilaiparam(map));
                        ...
                        final String filename = tahunAnggaran+"-"+"SPM-MONITORING-BTL"+"-"+idskpd+".pdf";
