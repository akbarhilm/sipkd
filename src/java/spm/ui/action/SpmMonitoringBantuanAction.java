...
public class SpmMonitoringBantuanAction {

    private static final Logger log = LoggerFactory.getLogger(SpmMonitoringBantuanAction.class);
    @Autowired
   ...
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            map.put("np", spmService.getnilaiparam(map));
                        ...
                        final String filename = tahunAnggaran+"-"+"SPM-MONITORING-BANTUAN"+"-"+idskpd+".pdf";
