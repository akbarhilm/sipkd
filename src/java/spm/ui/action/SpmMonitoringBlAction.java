...
public class SpmMonitoringBlAction {

    private static final Logger log = LoggerFactory.getLogger(SpmMonitoringBlAction.class);
    @Autowired
   ...
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            map.put("np", spmService.getnilaiparam(map));
                        ...
                        final String filename = tahunAnggaran+"-"+"SPM-MONITORING-BL"+"-"+idskpd+".pdf";                        response.setHeader("Content-disposition", "attachment; filename="+ filename);
                        response.setContentType("application/pdf");
