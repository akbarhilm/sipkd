 ...
 * @author Admin
 */
public class SpmUp extends SppUp {
    ...
    private List<SpmUpRinci> spmUpRinci;
    ...
    /**
     * @return the spmUpRinci
     */
    public List<SpmUpRinci> getSpmUpRinci() {
        return spmUpRinci;
    }

    /**
     * @param spmUpRinci the spmUpRinci to set
     */
    public void setSpmUpRinci(List<SpmUpRinci> spmUpRinci) {
        this.spmUpRinci = spmUpRinci;
    }
