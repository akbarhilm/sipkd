...
public class SppBiaya extends BaseModel {
    ...
    private List<SppBiayaRinci> sppBiayaRinci;
     ...
     */
    public List<SppBiayaRinci> getSppBiayaRinci() {
        return sppBiayaRinci;
    }

    /**
     * @param sppBiayaRinci the sppBiayaRinci to set
     */
    public void setSppBiayaRinci(List<SppBiayaRinci> sppBiayaRinci) {
        this.sppBiayaRinci = sppBiayaRinci;
    }
