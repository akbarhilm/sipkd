...
public class Kontrak extends BaseModel {
    ...
    private String kodeBlj;
    private String kodeSkb;
     ...
     * @return the kodeBlj
     */
    public String getKodeBlj() {
        return kodeBlj;
    }

    /**
     * @param kodeBlj the kodeBlj to set
     */
    public void setKodeBlj(String kodeBlj) {
        this.kodeBlj = kodeBlj;
    }

    /**
     * @return the kodeSkb
     */
    public String getKodeSkb() {
        return kodeSkb;
    }

    /**
     * @param kodeSkb the kodeSkb to set
     */
    public void setKodeSkb(String kodeSkb) {
        this.kodeSkb = kodeSkb;
    }
