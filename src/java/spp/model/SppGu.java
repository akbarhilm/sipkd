...
public class SppGu extends BaseModel {
    ...
    private String nilaivalidasiPaguSpp;
    private String validasiPaguSpp;
    ...
    /**
     * @param presentase the presentase to set
     */
    ...
    /**
     * @return the nilaivalidasiPaguSpp
     */
    public String getNilaivalidasiPaguSpp() {
        return nilaivalidasiPaguSpp;
    }

    /**
     * @param nilaivalidasiPaguSpp the nilaivalidasiPaguSpp to set
     */
    public void setNilaivalidasiPaguSpp(String nilaivalidasiPaguSpp) {
        this.nilaivalidasiPaguSpp = nilaivalidasiPaguSpp;
    }

    /**
     * @return the validasiPaguSpp
     */
    public String getValidasiPaguSpp() {
        return validasiPaguSpp;
    }

    /**
     * @param validasiPaguSpp the validasiPaguSpp to set
     */
    public void setValidasiPaguSpp(String validasiPaguSpp) {
        this.validasiPaguSpp = validasiPaguSpp;
    }
