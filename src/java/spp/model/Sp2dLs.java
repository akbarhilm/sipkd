...
public class Sp2dLs extends BaseModel {
    ...
    private BigDecimal nilaiPotSp2d;
     private BigDecimal nilaiBersihSp2d;
    ...
    /**
     * @return the nilaiBersihSp2d
     */
    public BigDecimal getNilaiBersihSp2d() {
        return nilaiBersihSp2d;
    }

    /**
     * @param nilaiBersihSp2d the nilaiBersihSp2d to set
     */
    public void setNilaiBersihSp2d(BigDecimal nilaiBersihSp2d) {
        this.nilaiBersihSp2d = nilaiBersihSp2d;
    }
    ...
    /**
     * @return the terimaSpm
     */
    public String getTerimaSpm() {
        return terimaSpm;
    }

    /**
     * @param terimaSpm the terimaSpm to set
     */
    public void setTerimaSpm(String terimaSpm) {
        this.terimaSpm = terimaSpm;
    }
