...
public class SppBl extends BaseModel {
    ...
    /**
     * @return the potonganNihil
     */
    public boolean isPotonganNihil() {
        return potonganNihil;
    }

    /**
     * @param potonganNihil the potonganNihil to set
     */
    public void setPotonganNihil(boolean potonganNihil) {
        this.potonganNihil = potonganNihil;
    }

    /**
     * @return the potonganAyat
     */
    public boolean isPotonganAyat() {
        return potonganAyat;
    }

    /**
     * @param potonganAyat the potonganAyat to set
     */
    public void setPotonganAyat(boolean potonganAyat) {
        this.potonganAyat = potonganAyat;
    }
