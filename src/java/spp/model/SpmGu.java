 ...
 * @author Admin
 */
public class SpmGu extends SppGu {
    ...
    private List<SpmGuRinci> spmGuRinci;
    ...
    /**
     * @return the spmGuRinci
     */
    public List<SpmGuRinci> getSpmGuRinci() {
        return spmGuRinci;
    }

    /**
     * @param spmGuRinci the spmGuRinci to set
     */
    public void setSpmGuRinci(List<SpmGuRinci> spmGuRinci) {
        this.spmGuRinci = spmGuRinci;
    }
