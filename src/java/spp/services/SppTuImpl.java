...
public class SppTuImpl implements SppTuServices {
    ...
    public Map getBankDki(Map param) {
        return sppTuMapper.getBankDki(param);
    }
    ...
    @Override
    public String cekTglSpjTuJurnal(Map<String, Object> param) {
        return sppTuMapper.cekTglSpjTuJurnal(param);
    }

    @Override
    public Integer getBanyakTU(Map param) {
        return sppTuMapper.getBanyakTU(param);
    }
