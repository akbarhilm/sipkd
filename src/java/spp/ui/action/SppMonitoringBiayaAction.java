...
public class SppMonitoringBiayaAction {

    private static final Logger log = LoggerFactory.getLogger(SppMonitoringBiayaAction.class);
    @Autowired
   ...
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            map.put("np", sppService.getnilaiparam(map));
                        ...
                        final String filename = tahunAnggaran+"-"+"SPP-MONITORING-BIAYA"+"-"+idskpd+".pdf";
