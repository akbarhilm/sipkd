...
public class SppMonitoringBlAction {

    private static final Logger log = LoggerFactory.getLogger(SppMonitoringBlAction.class);
    @Autowired
   ...
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            map.put("np", sppService.getnilaiparam(map));
                        ...
                        final String filename = tahunAnggaran+"-"+"SPP-MONITORING-BL"+"-"+idskpd+".pdf";                        response.setHeader("Content-disposition", "attachment; filename="+ filename);
                        response.setContentType("application/pdf");
