...
public class SppMonitoringBantuanAction {

    private static final Logger log = LoggerFactory.getLogger(SppMonitoringBantuanAction.class);
    @Autowired
   ...
   public void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            map.put("np", sppService.getnilaiparam(map));
                        ...
                        final String filename = tahunAnggaran+"-"+"SPP-MONITORING-BANTUAN"+"-"+idskpd+".pdf";
