...
public class MySiteMeshFilter extends ConfigurableSiteMeshFilter {
    ...
    protected void applyCustomConfiguration(SiteMeshFilterBuilder builder) {
        builder
                ...
                .addDecoratorPath("*/kontrak/listbankinduk/*", "/WEB-INF/template/popup.jsp")
                .addDecoratorPath("*/kontrak/listrekananpopup", "/WEB-INF/template/popup.jsp")
                .addDecoratorPath("*/kontrakrinci/addkontrakrinci", "/WEB-INF/template/popup.jsp")
                ...
                .addDecoratorPath("*/listbastpopup2*", "/WEB-INF/template/popup.jsp")
