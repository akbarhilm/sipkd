    ...
    if (typeof myTable == 'undefined') {
        myTable = $('#cetakspdtable').dataTable({
            ...
            "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                var idPen = aData['idPenerimaan'];
                var noVal = aData['noValidasi'];
              ...
              //  alert(statcet1);
                ...
                var namaPa = "<input type='hidden'    id='namaPa" + aData['id'] + "' value='" + aData['namaPa'] + "'  />";
                var nipPa = "<input type='hidden'    id='nipPa" + aData['id'] + "' value='" + aData['nipPa'] + "'  />";
                ...
                {
                    donlod = "<a class='icon-book' href='" + getbasepath() + "/cetaksetor/" + aData['kodeBeban'] + "/" + aData['kodeJenis'] + "/" + aData['id'] + "/" + aData['noSetor'] + "/" + iskpd + "/" + lskpd + "/" + namafile + "' ></a>";
                    cekprint = "-";
               ...
               // $('td:eq(7)', nRow).html("<span id='namaPptk" + aData['id'] + "'>" + aData['namaPptk'] + nipPptk + "</span>");
                ...
                $('td:eq(9)', nRow).html(cekprint + namaPa + nipPa + namaPptk + nipPptk);
...
function trigercetak() {
    ...
    $('.checkbox:checked').each(function () {
        ...
        if (namaPa == null || namaPa == '' || namaPa == 'undefined' || $.trim(namaPa).length < 1) {
            statuscek++;
        } else {
            var map = {"id": idspd,
                "namaPa": namaPa,
