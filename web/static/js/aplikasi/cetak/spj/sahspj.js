              ...
              //  alert(nilaispjtu);
               // alert(tnj);
                ...
                if (cetakstatus == 1) {
                    ...
                    var cekprint = cekprint = "<input type='checkbox' class='checkbox' name='cek" + aData['idSpj'] + "'  id='cek" + aData['idSpj'] + "' value='" + aData['idSpj'] + "' />";
               }
                ...
                $('td:eq(8)', nRow).html(cekprint + nipPa + nrkPa + namaPa + nipV + nrkV + namaV + nju + nomorspj);
