        ...
        myTable = $('#cetakspdtable').dataTable({
            ...
            "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
              ...
              //  alert(statcet1);
                ...
                $('td:eq(3)', nRow).html(aData['tahunSetor']);
               ...
               // $('td:eq(7)', nRow).html(aData['status']);
                $('td:eq(2)', nRow).html(aData['tglSetor'] != null && aData['tglSetor'] != '' && aData['tglSetor'] != 'undefined' ? moment.utc(aData['tglSetor'], 'SSS').format('DD-MM-YYYY') : '-');
            ...
            "aoColumns": [
                ...
                {"mDataProp": "kodeBeban", "bSortable": true, sDefaultContent: "-", sClass: "kanan"},
...
function batalspd(idspd, nospm) {
    ...
    bootbox.confirm("Anda akan membatalkan cetak data Setoran dengan nomor " + nospm + " di SKPD " + $("#skpd").val() + ",  lanjutkan ? ", function (result) {
        if (result) {
            return   $.ajax({
                type: "POST",
                url: urlhapusspd,
