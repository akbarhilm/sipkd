...
function cetakpotbulrek() {
    ...
    //
    var eee = aaa+"-"+"SP2DREKAPPOTBULANAN"+bbb+"-"+qqq+".pdf";
    //alert(eee);
   window.location.href= getbasepath() + "/cetaksp2dpotbulrek/json/prosescetak?tahun="+aaa+"&kproses="+bbb+"&tgl="+p+"&namafile="+eee;
