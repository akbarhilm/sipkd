        ...
        myTable = $('#cetakspdtable').dataTable({
            ...
            "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                } else if (stat == 'CETAK')
                {
                    ...
                    batal = "<a class='icon-remove linkpilihan' href='#' onclick=batalspd(" + aData['id'] + ",'" + aData['spmUp']['noSpm'] + "') ></a>";
                    cekprint = "-";
...
function batalspd(idspd, nospm) {
    ...
    var urlhapusspd = getbasepath() + "/cetakspm/json/hapusspmcetak1"; // edit by anita
