...
function cetaksspppn() {
  ...
  //  var www =  moment.utc(ccc, 'SSS').format('DDMM');
    ...
    var eee = aaa+"-"+"SSP-PPN-"+bbb+"-"+fff+".pdf";
    
   window.location.href= getbasepath() + "/cetaksspppn/json/prosescetak?tahun="+aaa+"&kproses="+bbb+"&nsp2d="+fff+"&idskpd="+ggg+"&namafile="+eee;
