...
function gridsppbl() {
    var urljson = getbasepath() + "/bl/json/getlistsppbl";
    if (typeof myTable == 'undefined') {
        myTable = $('#btlspdtable').dataTable({
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                var edit = "<a href='" + getbasepath() + "/bl/editsppbl/" + aData['id'] + "' class='icon-edit' ></a> - <a href='" + getbasepath() + "/bl/deletesppbl/" + aData['id'] + "' class='icon-remove' ></a>";
...
function pindahhalamanadd() {
    ...
    if (idskpd) {
        window.location.replace(getbasepath() + "/bl/addsppbl/" + idskpd);
    } else {
        window.location.replace(getbasepath() + "/bl/addsppbl");
    }
