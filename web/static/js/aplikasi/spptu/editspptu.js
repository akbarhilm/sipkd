...
function getbanyakspdrinci( ) {
    $.getJSON(getbasepath() + "/spptu/json/getlistspdblbanyak",
            {tahunAnggaran: $("#tahun").val(), idskpd: $("#idskpd").val(), idspp: $("#id").val()},
    function (result) {
    ...
    if (typeof myTable == 'undefined') {
        myTable = $('#spprincitable').dataTable({
            ...
            "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                var idbl = "<input type='hidden' id='idblhidden" + index + "'   name='idblhidden" + index + "'  value='" +  aData['idBl']  + "'  />";
                ...
                var namaKegiatan = "<textarea name='namaKegiatan' readonly='true' style='border:none;margin:0;width:99%;'>" + aData['kegiatan']['namaKegiatan'] + "</textarea>"
                var namaakun = "<textarea name='namaAkun' readonly='true' style='border:none;margin:0;width:99%;'>" + aData['akun']['namaAkun'] + "</textarea>"

                var nilaispd = accounting.formatNumber(aData['nilaiSpd'], 2, '.', ",");
                var nilaispdtext = "<input type='text' name='nilaispd" + aData['idBl'] + "' id='nilaispd" + index + "'  class='inputmoney'  readonly='true'   value='" + nilaispd + "' />"
                var nilaisppsisa = accounting.formatNumber(aData['nilaiSppSisa'], 2, '.', ",");
                var nilaisppsisatext = "<input type='text' name='nilaiSppSisa" +index + "' id='nilaiSppSisa" + index + "'  class='inputmoney'  readonly='true'   value='" + nilaisppsisa + "' />"
                var nilaisppsebelum = accounting.formatNumber(aData['nilaiSppSebelum'], 2, '.', ",");
                var nilaisppsebelumtext = "<input type='text' name='nilaiSppSebelum" + index + "' id='nilaiSppSebelum" + index + "'  class='inputmoney'  readonly='true'   value='" + nilaisppsebelum + "' />"
                ...
                $('td:eq(0)', nRow).html(index + idspd + idkegiatan + idakun+idbl);
            ...
            "aoColumns": [
                ...
                {"mDataProp": "noSpd", "bSortable": true, sClass: "center", "sWidth": "7%"},
                {"mDataProp": "kegiatan.kodeKegiatan", sClass: "center", "bSortable": true, "sWidth": "7%"},
                {"mDataProp": "akun.namaAkun", "bSortable": true, "sWidth": "15%"},
                {"mDataProp": "akun.kodeAkun", "bSortable": true, "sWidth": "7%"},
                {"mDataProp": "kegiatan.namaKegiatan", "bSortable": true, "sWidth": "15%"},
                {"mDataProp": "nilaiSpd", "bSortable": false, sClass: "kanan", "sWidth": "11%"},
                {"mDataProp": "nilaiSppSebelum", "bSortable": false, sClass: "kanan", "sWidth": "11%"},
                {"mDataProp": "nilaiSppSisa", "bSortable": false, sClass: "kanan", "sWidth": "11%"},
                {"mDataProp": "nilaiSpp", "bSortable": false, sClass: "kanan", "sWidth": "11%"},
                {"mDataProp": "idBl", "bSortable": false, sClass: "center", "sWidth": "3%"}
            ]
        });
...
function setdisabled(param, idbl) {
    ...
    if (param == false) {
        ...
        var sppsisa = accounting.unformat($("#nilaiSppSisa" + idbl).val(), ",");
