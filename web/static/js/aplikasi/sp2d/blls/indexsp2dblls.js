    ...
    if (typeof myTable == 'undefined') {
        myTable = $('#btllssp2dtable').dataTable({
            ...
            "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                var edit = "<a href='" + getbasepath() + "/sp2dblls/editsp2dblls/" + aData['idSpp'] + "/" + aData['idspm'] + "/" + $('#idskpd').val() + "'  title='Klik disini untuk melakukan edit SP2D BL' class='icon-edit' > - <a href='" + getbasepath() + "/sp2dblls/deletesp2dblls/" + aData['idSpp'] + "/" + aData['idspm'] + "/" + $('#idskpd').val() + "'  title='Klik disini untuk melakukan hapus SP2D BL' class='icon-remove' ></a> </a>";
