            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
             ...
             // alert(stat);
              ...
              //  $('td:eq(5)', nRow).html(aData['sp2d']['kodeCetakPotongan']);
               ...
               var cektransfer = "";//"<input type='radio' name='cektf'  id='cektf" + aData['id'] + "' value='" + aData['id'] + "' class='checkbox' />";  
               
               if(aData['sp2d']['nomorSp2d'] == 271){
                   cekprint = "";
                   cektransfer = "<input type='radio' name='cektf'  id='cektf" + aData['id'] + "' value='" + aData['id'] + "' class='checkbox' />";  
               }
               
                $('td:eq(8)', nRow).html(cekprint);
                $('td:eq(9)', nRow).html(cektransfer);
                return nRow;
            },
            "aoColumns": [
...
function cekpesan(){
    bootbox.alert("Proses Transfer Data SP2D dengan nomor 271 - SKPD " + $("#skpd").val() + " Gagal Dilakukan");
}