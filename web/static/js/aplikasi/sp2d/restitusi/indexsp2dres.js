...
function gridsp2dbtlls() {
    var urljson = getbasepath() + "/sp2drestitusi/json/getlistsp2drestitusi";
    if (typeof myTable == 'undefined') {
        myTable = $('#btllssp2dtable').dataTable({
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                var edit = "<a href='" + getbasepath() + "/sp2drestitusi/editsp2dres/" + aData['idSpp'] + "/"+ aData['idspm'] +"/"+ $('#idskpd').val() +"'  title='Klik disini untuk melakukan edit SP2D BTL LS' class='icon-edit' ></a>";
                var tambah = "<a href='" + getbasepath() + "/sp2drestitusi/addsp2dres/" + aData['idSpp'] + "/"+ aData['idspm'] +"/"+ $('#idskpd').val() +"'  title='Klik disini untuk melakukan entry SP2D' class='icon-plus' ></a>";
                var pilihan = "";
