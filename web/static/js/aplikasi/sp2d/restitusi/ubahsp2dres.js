...
function gridsp2drincibtlls() {
   ...
   var urljson = getbasepath() + "/sp2drestitusi/json/getlistsp2drincirestitusi";
    if (typeof myTable == 'undefined') {
        myTable = $('#btllssp2drincitable').dataTable({
            ...
            "aoColumns": [
                ...
                {"mDataProp": "akun.kodeAkun", "bSortable": false, sClass: "left"},
                {"mDataProp": "akun.namaAkun", "bSortable": false, sClass: "left"},
