...
function gridsp2dbltu() {
    var urljson = getbasepath() + "/sp2dbltu/json/getlistsp2dbltu";
    if (typeof myTable == 'undefined') {
        myTable = $('#btllssp2dtable').dataTable({
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                //var edit = "<a href='" + getbasepath() + "/sp2dbltu/editsp2dbltu/" + aData['idSpp'] + "/"+ aData['idspm'] +"/"+ $('#idskpd').val() +"'  title='Klik disini untuk melakukan edit SP2D BTL LS' class='icon-edit' ></a>";
                var edit = "<a href='" + getbasepath() + "/sp2dbltu/editsp2dbltu/" + aData['idSpp'] + "/"+ aData['idspm'] +"/"+ $('#idskpd').val() +"'  title='Klik disini untuk melakukan edit SP2D TU' class='icon-edit' > - <a href='" + getbasepath() + "/sp2dbltu/deletesp2dbltu/" + aData['idSpp'] + "/"+ aData['idspm'] +"/"+ $('#idskpd').val() +"'  title='Klik disini untuk melakukan hapus SP2D TU' class='icon-remove' ></a> </a>";

                var tambah = "<a href='" + getbasepath() + "/sp2dbltu/addsp2dbltu/" + aData['idSpp'] + "/"+ aData['idspm'] +"/"+ $('#idskpd').val() +"'  title='Klik disini untuk melakukan entry SP2D' class='icon-plus' ></a>";
                var pilihan = "";
