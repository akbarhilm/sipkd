    ...
    if (typeof myTable == 'undefined') {
        myTable = $('#btllssp2dtable').dataTable({
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                var edit = "<a href='" + getbasepath() + "/sp2dbiayals/editsp2dbiayals/" + aData['idSpp'] + "/"+ aData['idspm']+"'  title='Klik disini untuk melakukan edit SP2D BIAYA' class='icon-edit' > - <a href='" + getbasepath() + "/sp2dbiayals/deletesp2dbiayals/" + aData['idSpp'] + "/"+ aData['idspm']+"'  title='Klik disini untuk melakukan hapus SP2D BIAYA' class='icon-remove' ></a> </a>";
