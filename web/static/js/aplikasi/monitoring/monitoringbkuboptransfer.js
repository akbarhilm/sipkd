...
function gridbku() {
    ...
    if (typeof myTable == 'undefined') {
        ...
        myTable = $('#monjourtable').dataTable({
            ...
            "iDisplayLength": 50,
            "sAjaxSource": getbasepath() + "/monbop/json/listindexmontransfer",
            "aaSorting": [[1, "asc"]],
...
function getTotal() {
    ...
    $.getJSON(getbasepath() + "/monbop/json/getTotal", {tahun: tahun, idsekolah: idsekolah, triwulan: triwulan},
    function(result) {
...
function getSaldo(tk) {
    ...
    $.getJSON(getbasepath() + "/monbop/json/getSaldo", {tahun: tahun, idsekolah: idsekolah, triwulan: triwulan},
    function(result) {
