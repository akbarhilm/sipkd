...
function tambahRow() {
    ...
    cell2.innerHTML = "<td class='center'><input type='hidden' id='idskpd" + idrow + "' name='idskpd" + idrow + "' > <textarea type='text' id='ketskpd" + idrow + "' name='ketskpd" + idrow + "' readonly='true' ></textarea> <a id='pilih" + idrow + "'  class='fancybox fancybox.iframe FontSmall' onclick='getbutton(" + idrow + ")' href='" + getbasepath() + "/journal/listskpd?target='_top'' title='Pilih SKPD'  ><i class='icon-zoom-in'></i> Pilih</a> </td>";
    ...
    cell4.innerHTML = "<td class='center'><textarea  id='namaakun" + idrow + "' name='namaakun" + idrow + "' class='m-wrap large valid' readonly='true' > </textarea> </td>";
    cell5.innerHTML = "<td> <input type='text' name='debet" + idrow + "' id='debet" + idrow + "' class='inputmoney'  onkeyup='getTotal(),validasiDebet(" + idrow + ")' onclick = 'validasiDebet(" + idrow + ")' /> </td>";
    cell6.innerHTML = "<td> <input type='text' name='kredit" + idrow + "' id='kredit" + idrow + "' class='inputmoney'  onkeyup='getTotal(),validasiKredit(" + idrow + ")' onclick = 'validasiKredit(" + idrow + ")' /> </td>";
