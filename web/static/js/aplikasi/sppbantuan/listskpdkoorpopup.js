...
function ambilskpdkoor(id) {
    ...
    $('#kodeSkpdKoor', window.parent.document).val($("#kodeSkpdKoor" + id).val());
    $('#namaSkpdKoor', window.parent.document).val($("#namaSkpdKoor" + id).val());
...
function grid( ) {
    ...
    if (typeof myTable == 'undefined') {
        myTable = $('#fungsitable').dataTable({
            ...
            "bFilter": false,
            "sAjaxSource": getbasepath() + "/sppbantuan/json/listjsonskpdkoorpopup",
            "aaSorting": [[1, "asc"]],
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                $('td:eq(2)', nRow).html(namaSkpdKoor + pilih);
