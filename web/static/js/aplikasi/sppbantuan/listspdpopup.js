...
function ambilspd(id) {
    $('#idBtlBantuan', window.parent.document).val(id).change();
    ...
    if (typeof myTable == 'undefined') {
        myTable = $('#fungsitable').dataTable({
            ...
            "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                var idSpd = "<input type='hidden'  id='idSpd" + aData['idBtlBantuan'] + "'   name='idSpd" + aData['idBtlBantuan'] + "' value='" + aData['idSpd'] + "'/>  "
                ...
                var noSpd = "<input type='hidden'  id='noSpd" + aData['idBtlBantuan'] + "'   name='noSpd" + aData['idBtlBantuan'] + "' value='" + aData['noSpd'] + "'/>  "
                var namaKegiatan = "<input type='hidden'  id='namaKegiatan" + aData['idBtlBantuan'] + "'   name='namaKegiatan" + aData['idBtlBantuan'] + "' value='" + aData['kegiatan']['namaKegiatan'] + "'/>  "
                var namaAkun = "<input type='hidden'  id='namaAkun" + aData['idBtlBantuan'] + "'   name='namaAkun" + aData['idBtlBantuan'] + "' value='" + aData['akun']['namaAkun'] + "'/>  "
                var idKegiatan = "<input type='hidden' id='idKegiatan" + aData['idBtlBantuan'] + "'   name='idKegiatan" + aData['idBtlBantuan'] + "'  value='" + aData['kegiatan']['idKegiatan'] + "'  />";
                var idAkun = "<input type='hidden' id='idAkun" + aData['idBtlBantuan'] + "'   name='idAkun" + aData['idBtlBantuan'] + "'  value='" + aData['akun']['idAkun'] + "'  />";
                var nilaiSpd = "<input type='hidden'  id='nilaiSpd" + aData['idBtlBantuan'] + "'   name='nilaiSpd" + aData['idBtlBantuan'] + "' value='" + aData['nilaiSpd'] + "'/>  "
                var pilih = "<span class='icon-ok-sign linkpilihan' onclick='ambilspd(" + aData['idBtlBantuan'] + ")'></span>  "
            ...
            "aoColumns": [
                ...
                {"mDataProp": "kegiatan.namaKegiatan", "bSortable": false, sClass: "center"},
                {"mDataProp": "akun.namaAkun", "bSortable": false, sClass: "center"},
                {"mDataProp": "nilaiSpd", "bSortable": false, sClass: "center"},
                {"mDataProp": "idSpd", "bSortable": false, sClass: "center"},
            ]
        });
