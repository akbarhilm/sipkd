    ...
    if (typeof myTable == 'undefined') {
        ...
        myTable = $('#jourtable').dataTable({
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                var editrt = "<a href='" + getbasepath() + "/bkubop/editbkurt/" + "?idbku=" + aData['idBku'] + "&tahun=" + tahun + "' class='icon-edit' ></a>-<a href='" + getbasepath() + "/bkubop/hapusbkurt/" + "?idbku=" + aData['idBku'] + "&tahun=" + tahun + "' class='icon-remove' ></a>";
                ...
                var arsiprt = "<a href='" + getbasepath() + "/bkubop/arsipbkurt/" + "?idbku=" + aData['idBku'] + "&tahun=" + tahun + "' class='icon-file-text' ></a>";
                var arsipjg = "<a href='" + getbasepath() + "/bkubop/arsipbkujg/" + "?idbku=" + aData['idBku'] + "&tahun=" + tahun + "' class='icon-file-text' ></a>";
                var arsipjgcetak = "<a href='" + getbasepath() + "/bkubop/arsipbkujg/" + "?idbku=" + aData['idBku'] + "&tahun=" + tahun + "' class='icon-file-text' ></a> - <a href='" + getbasepath() + "/bkubop/json/prosescetakbku/" + "?idbku=" + aData['idBku'] + "&idsekolah=" + idsekolah + "' class='icon-print' ></a>";
                var arsippajak = "<a href='" + getbasepath() + "/bkubop/arsipbkupajak/" + "?idbku=" + aData['idBku'] + "&tahun=" + tahun + "' class='icon-file-text' ></a>";
                var arsippajakcetak = "<a href='" + getbasepath() + "/bkubop/arsipbkupajak/" + "?idbku=" + aData['idBku'] + "&tahun=" + tahun + "' class='icon-file-text' ></a> - <a href='" + getbasepath() + "/bkubop/json/prosescetakbpn/" + "?idbku=" + aData['idBku'] + "&tahun=" + tahun + "&idsekolah=" + idsekolah + "&kodetrx=" + aData['kodeTransaksi'] + "' class='icon-print' ></a>";
                var arsipspj = "<a href='" + getbasepath() + "/bkubop/arsipbkuspj/" + "?idbku=" + aData['idBku'] + "&tahun=" + tahun + "' class='icon-file-text' ></a>";
                var arsipspjcetak = "<a href='" + getbasepath() + "/bkubop/arsipbkuspj/" + "?idbku=" + aData['idBku'] + "&tahun=" + tahun + "' class='icon-file-text' ></a> - <a href='" + getbasepath() + "/bkubop/json/prosescetakbku/" + "?idbku=" + aData['idBku'] + "&idsekolah=" + idsekolah + "' class='icon-print' ></a>";
                var arsipjgcetak = "<a href='" + getbasepath() + "/bkubop/arsipbkujg/" + "?idbku=" + aData['idBku'] + "&tahun=" + tahun + "' class='icon-file-text' ></a> - <a href='" + getbasepath() + "/bkubop/json/prosescetakbku/" + "?idbku=" + aData['idBku'] + "&idsekolah=" + idsekolah + "' class='icon-print' ></a>";
                var arsipst = "<a href='" + getbasepath() + "/bkubop/arsipbkust/" + "?idbku=" + aData['idBku'] + "&tahun=" + tahun + "' class='icon-file-text' ></a>";
                var arsipstcetak = "<a href='" + getbasepath() + "/bkubop/arsipbkust/" + "?idbku=" + aData['idBku'] + "&tahun=" + tahun + "' class='icon-file-text' ></a> - <a href='" + getbasepath() + "/bkubop/json/prosescetakbku/" + "?idbku=" + aData['idBku'] + "&idsekolah=" + idsekolah + "' class='icon-print' ></a>";
                var arsipc12 = "<a href='" + getbasepath() + "/bkubop/arsipbkuc12/" + "?idbku=" + aData['idBku'] + "&tahun=" + tahun + "' class='icon-file-text' ></a>";
                var arsiprtcetak = "<a href='" + getbasepath() + "/bkubop/arsipbkurt/" + "?idbku=" + aData['idBku'] + "&tahun=" + tahun + "' class='icon-file-text' ></a> - <a href='" + getbasepath() + "/bkubop/json/prosescetakbku/" + "?idbku=" + aData['idBku'] + "&idsekolah=" + idsekolah + "' class='icon-print' ></a>";
                    ...
                    if (aData['tglPosting'] == "" || aData['tglPosting'] == null) { //  jika belum ditransfer
                        if (aData['banyakPajak'] != 0) {
                         ...
                         editvalid = editspjsusulan;
                            ...
                            editvalid = arsipspj; // jika sudah diajukan ke PA tapi belum diajukan ke sudin
                        }
...
//                if (aData['tglPosting'] == "" || aData['tglPosting'] == null) {
//                    tanda = "";
//                }
