...
function grid() {
    ...
    if (typeof myTable == 'undefined') {
        myTable = $('#skpdtable').dataTable({
            ...
            "bFilter": false,
            "sAjaxSource": getbasepath() + "/bkubop/json/listpajakpn",
            "aaSorting": [[1, "asc"]],
            ...
            "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                $('td:eq(0)', nRow).html(index + idbku + nobku);
                $('td:eq(3)', nRow).html(kegiatan + idkeg + kodekeg);
                //$('td:eq(4)', nRow).html(akun + idbas + kodeakun);
                //$('td:eq(5)', nRow).html(komponen + idkomponen);
