...
function setComboTriwulan() {
    ...
    $.getJSON(getbasepath() + "/tutupbkubos/json/setComboTriwulan", {idsekolah: idsekolah, tahun: tahun},
    function(result) {
        var banyak, kode, ket;
...
function cetakjurnalxls() {
    window.location.href = getbasepath() + "/tutupbkubos/xls/bkuxls?tahun=" + $("#tahun").val()
            + "&idsekolah=" + $('#idsekolah').val() + "&triwulan="
            + $('#triwulan').val();
}

function gridbkupengeluaran() {
    var urljson = getbasepath() + "/tutupbkubos/json/gridbku";
...
function cetakbkukeluar() {
    ...
    window.location.href = getbasepath() + "/tutupbkubos/json/prosescetak?tahun=" + tahun + "&triwulan=" + triwulan + "&idsekolah=" + idsekolah;
...
function cekBapKasValidasi() {
    ...
    $.getJSON(getbasepath() + "/tutupbkubos/json/getBapKasValidasi", {idsekolah: idsekolah, tahun: tahun, triwulan: triwulan},
    function(result) {
        //var ket = "";
