...
//global variable
var id_value, bln_value, bton_value, saldobapkas_value;
...
function getNilaiSaldo() {
    ...
    $.getJSON(getbasepath() + "/tutupbkubop/json/getNilaiSaldo", {tahun: tahun, idsekolah: idsekolah, triwulan: triwulan}, //, kodewilproses: kodewilproses},
    function(result) {
...
function validatePajak(callback) {
    ...
    $.getJSON(getbasepath() + "/tutupbkubop/json/validatePajak", {tahun: tahun, idsekolah: idsekolah, triwulan: triwulan}, //, kodewilproses: kodewilproses},
    function(result) {
        callback(result);
    });
}
...
function getNilaiKas() {
    ...
    $.getJSON(getbasepath() + "/tutupbkubop/json/getNilaiKas", {tahun: tahun, idsekolah: idsekolah, triwulan: triwulan}, //, kodewilproses: kodewilproses},
    function(result) {
...
function getBendahara() {
    ...
    $.getJSON(getbasepath() + "/tutupbkubop/json/getBendahara", {tahun: tahun, idsekolah: idsekolah},
    function(result) {
...
function simpan() {
    validatePajak(function(value) {
        if (value && bton_value == 1) {
            ...
            //var varurl = getbasepath() + "/tutupbkubop/json/simpan";
            var dataac = [];
