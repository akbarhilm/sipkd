$(document).ready(function () {
    ...
    loadupdate(getbasepath() + "/spd/pengajuanbtlbantuan/json/getlistspddetailbyskpddantahun");
    statusbreadcrum();
    $("#kodekegiatanfilter").keyup(function () {
        ...
        if (panjang > 2 || panjang == 0) {
            ...
            gridspdbtllist(getbasepath() + "/spd/pengajuanbtlbantuan/json/getlistspddetailbyskpddantahun", idskpd, idSpd, tahunAnggaran);
        }
    });
...
function getpagudanspd(id) {
    ...
    var noSpd = $("#noSpd").val();
    statusbreadcrum();
    $.getJSON(getbasepath() + "/spd/pengajuanbtlbantuan/json/getanggarandanspd/" + id,
            function (result) {
    ...
    if (noSpd && $.trim(noSpd).length > 0) {
        ...
        gridspdbtllist(getbasepath() + "/spd/pengajuanbtlbantuan/json/getlistspddetailbyskpddantahun", id, idSpd, tahunAnggaran);
    }
...
function simpan() {
    ...
    var idSpd = $("#idSpd").val();
    var tahunAnggaran = $("#tahunAnggaran").val();
    submispddetail(getbasepath() + '/spd/pengajuanbtlbantuan/json/addspddetail', getbasepath() + "/spd/pengajuanbtlbantuan/json/getlistspddetailbyskpddantahun", idskpd, idSpd, tahunAnggaran);
}
function pindahhalamanadepan() {
    window.location.replace(getbasepath() + "/spd/pengajuanbtlbantuan/btlbantuan/index");
...
function pasangvalidatebesarperfield(idakun) {
    ...
    var nilaiangg =accounting.unformat($("#idSisaTAPDX" + idakun).val(), ",");// parseFloat($("#idAnggaranTAPDX" + idakun).val());//;
