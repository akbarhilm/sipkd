...
function cetakmonbantuan() {
    ...
    //alert(aaa);
   // alert(ccc);
    var eee = aaa+"-"+"SPD-MONITORING-BANTUAN"+"-"+ccc+".pdf";
    //alert(eee);
   window.location.href= getbasepath() + "/spd/monitoringbantuan/json/prosescetakbantuan?tahun="+aaa+"&idskpd="+ccc+"&tgl="+ddd+"&namafile="+eee;
