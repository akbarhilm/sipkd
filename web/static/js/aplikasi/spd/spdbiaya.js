...
function getlistspdbiaya(id) {
    $.getJSON(getbasepath() + "/spd/pengajuanbiaya/json/getpagudansisabiaya/" + id,
            function(result) {
...
function pindahhalamanadd() {
    if ($("#idskpd").val().trim()) {
        window.location.replace(getbasepath() + "/spd/pengajuanbiaya/biaya/addskpd/" + $("#idskpd").val().trim());
    } else {
        window.location.replace(getbasepath() + "/spd/pengajuanbiaya/biaya/add");
    }
}

function gridspdbiayamasterlist() {
    var urljson = getbasepath() + "/spd/pengajuanbiaya/biaya/json/getlistspd";
    ...
    if (typeof myTable == 'undefined') {
        myTable = $('#btlspdtable').dataTable({
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                var urledit = baseurl + "/spd/pengajuanbiaya/biaya/edit";
                var urldel = "#"
...
function hapusspddanrincibyidspd(nospd, idspd, baseurl) {
    var urlhapusspd = baseurl + "/spd/pengajuanbiaya/json/hapusspddanrincibyspd";
