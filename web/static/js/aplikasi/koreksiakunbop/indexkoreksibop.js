...
function cekSekolah() {
    ...
    if ($('#idsekolah').val() == ""){
        ...
        a.href = getbasepath() + "/koreksiakunbop/addkoreksi/"+$('#idsekolah').val();
    }
}
...
function getMaxTriwulan() {
    ...
    $.getJSON(getbasepath() + "/koreksiakunbop/json/getMaxTriwulan", {tahun: tahun, idsekolah: idsekolah},
    function(result) {
...
function grid() {
    var urljson = getbasepath() + "/koreksiakunbop/json/listindex";
    ...
    if (typeof myTable == 'undefined') {
        myTable = $('#bkutable').dataTable({
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {///cetakspp
                ...
                var edit = "<a href='" + getbasepath() + "/koreksiakunbop/editkoreksi/" + "?idbku=" + aData['idBku'] + "' class='icon-edit' ></a>";
                var arsip = "<a href='" + getbasepath() + "/koreksiakunbop/arsipkoreksi/" + "?idbku=" + aData['idBku'] + "&idsekolah=" + "' class='icon-file-text' ></a>";
