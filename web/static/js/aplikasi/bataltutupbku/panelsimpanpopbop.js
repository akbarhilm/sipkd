...
function getNilaiSaldo() {
    ...
    console.log("getNilaiSaldo idsekolah= "+idsekolah);

    $.getJSON(getbasepath() + "/bataltutupbkubop/json/getNilaiSaldo", {tahun: tahun, idsekolah: idsekolah, triwulan: triwulan}, //, kodewilproses: kodewilproses},
    function(result) {
...
function getNilaiKas() {
    ...
    console.log("getNilaiKas idsekolah= "+idsekolah);

    //console.log("bulan == " + bulan);

    $.getJSON(getbasepath() + "/bataltutupbkubop/json/getNilaiKas", {tahun: tahun, idsekolah: idsekolah, triwulan: triwulan}, //, kodewilproses: kodewilproses},
    function(result) {
...
function getBendahara() {
    ...
    console.log("getBendahara idsekolah= "+idsekolah);

    $.getJSON(getbasepath() + "/bataltutupbkubop/json/getBendahara", {tahun: tahun, idsekolah: idsekolah},
    function(result) {
...
function simpan() {
    ...
    //var varurl = getbasepath() + "/bataltutupbkubop/json/simpan";
    var dataac = [];
