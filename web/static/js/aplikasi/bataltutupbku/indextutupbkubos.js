...
function setComboTriwulan() {
    ...
    $.getJSON(getbasepath() + "/bataltutupbkubos/json/setComboTriwulan", {idsekolah: idsekolah, tahun: tahun},
    function(result) {
        var banyak, kode, ket;
...
function cetakjurnalxls() {
    window.location.href = getbasepath() + "/bataltutupbkubos/xls/bkuxls?tahun=" + $("#tahun").val()
            + "&idsekolah=" + $('#idsekolah').val() + "&triwulan="
            + $('#triwulan').val();
}

function gridbkupengeluaran() {
    var urljson = getbasepath() + "/bataltutupbkubos/json/gridbku";
...
function cetakbkukeluar() {
    ...
    window.location.href = getbasepath() + "/bataltutupbkubos/json/prosescetak?tahun=" + tahun + "&triwulan=" + triwulan + "&idsekolah=" + idsekolah;
