...
function gridtransfer() {
    ...
    if (typeof myTable == 'undefined') {
        ...
        myTable = $('#jourtable').dataTable({
            ...
            "iDisplayLength": 50,
            "sAjaxSource": getbasepath() + "/bkutf/json/listindexbos",
            "aaSorting": [[1, "asc"]],
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                if (aData['kodeVA'] == "1") { // JIKA VIRTUAL ACCOUNT
                    ...
                    va = "<a href='" + getbasepath() + "/bkutf/tfbosva/" + "?idbku=" + aData['idBku'] + "&tahun=" + tahun + "&idskpd=" + aData['idskpd'] + "' class='icon-edit' ></a>";

                } else if (kodetrans.substr(0, 1) == "P") { // untuk pajak
                    transfer = "<a href='" + getbasepath() + "/pajaktf/tfpajakbos/" + "?idbku=" + aData['idBku'] + "&kodetrx=" + kodetrans + "&idsekolah=" + $('#idsekolah').val() + "' class='icon-edit' ></a>";
                    va = "";
                } else {
                    transfer = "<a href='" + getbasepath() + "/bkutf/tfbos/" + "?idbku=" + aData['idBku'] + "&tahun=" + tahun + "&idskpd=" + aData['idskpd'] + "' class='icon-edit' ></a>";
                    va = "";
                }
