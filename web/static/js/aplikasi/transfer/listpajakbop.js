...
function grid() {
    ...
    if (typeof myTable == 'undefined') {
        myTable = $('#spjtable').dataTable({
            ...
            "bFilter": false,
            "sAjaxSource": getbasepath() + "/bkutf/json/listpajakspjbop",
            "aaSorting": [[1, "asc"]],
...
function simpanPajak() {
    ...
    var varurl = getbasepath() + "/bkutf/json/prosessimpanpajakbop";
    var dataac = [];
    var nilailist = [];
    var i;
    var banyak = 0;
...
function getDataPajakSpj(idblrinci, nobkuref) {
    ...
    $.getJSON(getbasepath() + "/bkutf/json/getDataPajakSpjBop", {tahun: tahun, idsekolah: idsekolah, nobkuref: nobkuref, idblrinci: idblrinci},
    function(result) {
