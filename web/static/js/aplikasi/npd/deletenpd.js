    ...
    if (typeof myTable2 == 'undefined') {
        myTable2 = $('#kegiatantable').dataTable({
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                var nilaiNpdText = "<input type='text' name='nilaiNpd" + aData['akun']['idAkun'] + "' id='nilaiNpd" + aData['akun']['idAkun'] + "'  class='inputmoney'   value='" + nilaiNpd + "' readOnly='true' onkeyup='pasangvalidatebesarperfield(" + aData['akun']['idAkun'] + ");hitungnilainpd()'/>";
