...
function getpagudanspd(idskpd) {
    $.getJSON(getbasepath() + "/spmbtlls/json/getanggarandanspdbantuanlangsung/" + idskpd,
            function (result) {
...
function gridspprinci() {
    ...
    var urljson = getbasepath() + "/spmrestitusi/json/getlistspdbtl";
    ...
    if (typeof myTable == 'undefined') {
        myTable = $('#spprincitable').dataTable({
            ...
            "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                var akun = aData['nAkun'];
                //console.log("nama akun : " + akun);
