...
function gridsppup() {
    var urljson = getbasepath() + "/spmrestitusi/json/getlistspmrestitusi";
    ...
    if (typeof myTable == 'undefined') {
        myTable = $('#btlspdtable').dataTable({
            ...
            "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                var edit = "<a href='" + getbasepath() + "/spmrestitusi/editspmres/" + aData['id'] + "'  title='Klik disini untuk melakukan entry/update SPM' class='icon-edit' ></a>";
            ...
            "aoColumns": [
                ...
                {"mDataProp": "id", "bSortable": false, sClass: "right", sDefaultContent: "-"},
                {"mDataProp": "noSpm", "bSortable": false,  sDefaultContent: "-"},
                {"mDataProp": "id", "bSortable": false, sClass: "center", sDefaultContent: "-"},
               // {"mDataProp": "id", "bSortable": false, sClass: "center", sDefaultContent: "-"}
            ]
        });
