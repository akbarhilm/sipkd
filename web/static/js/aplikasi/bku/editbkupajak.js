$(document).ready(function() {
    ...
    if ($('#noBkuPj').val() == "" || $('#noBkuPj').val() == null){
        $('#noBkuPj').val("BELUM ADA PG");
    }
...
function tambahRow() {
    ...
    cell1.innerHTML = "<td class= 'center' >" + idrow + " <input type='hidden' id='idBku" + idrow + "' name='idBku" + idrow + "' > <input type='hidden' id='idbkuref" + idrow + "' name='idbkuref" + idrow + "' > <input type='hidden'  id='namaakun" + idrow + "' name='namaakun" + idrow + "' / > <input type='hidden'  id='valkodeakun" + idrow + "' name='valkodeakun" + idrow + "' / > </td>";
    ...
    function(result) {
        ...
        if (result.aData[0]['nilaiMasuk'] > 0) {
            ...
            for (i = 0; i < valbanyak; i++) {
                ...
                $('#idbkuref' + c).val(result.aData[i]['idBkuRef']);
...
function cekLengkap() {
    ...
    if (jenisbayar == "PN") {
        ...
        if (tglPost == "" || nobukti == "" || tglDok == "" || filling == "" || uraian == "") {
            bootbox.alert("Pengisian Data Harus Lengkap");
        } else if (bulanTglPost !== bulan) {
            bootbox.alert("Tanggal Transaksi Harus Sesua Bulan yang Dipilih");
        } else {
...
function updatepengeluaran() {
    ...
    var varurl = getbasepath() + "/bku/json/prosesupdatepjpg";
    var dataac = [];
    var tglPost = $("#tglPosting").val();
...
function gridpgpajak() {
    ...
    if (typeof myTablepjpn == 'undefined') {
        myTablepjpn = $('#pnpajaktable').dataTable({
            ...
            "bFilter": false,
            "sAjaxSource": getbasepath() + "/bku/json/listpajakpgedit",
            "aaSorting": [[1, "asc"]],
