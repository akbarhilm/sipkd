$(document).ready(function() {
    ...
    if ($('#kodeTransaksi').val() == "SB" && $('#jenis').val() == 3) {
...
function setAkunCombo(id) {
    ...
    $.getJSON(getbasepath() + "/bku/json/getAkunCombo", {tahun: tahun, idskpd: idskpd, idkegiatan: id, keterangan: ket, pajak: pajak},
    function(result) {
        var banyak, kode, ket;
        var opt = "";
...
function getbanyakrinci() {
    ...
    $.getJSON(getbasepath() + "/bku/json/getBanyakEdit", {idskpd: idskpd, tahun: tahun, nobukti: nobukti, tglpos: tglpost, ket: "LS2", nobku: nobku},
    function(result) {
        banyakdata = result;
...
function getrincilist() {
    ...
    $.getJSON(getbasepath() + "/bku/json/valtabel", {idskpd: idskpd, tahun: tahun, nobukti: nobukti, tglpos: tglpost, ket: "LS2", nobku: nobku},
    function(result) {
        var i, c;
...
function update() {
    ...
    var varurl = getbasepath() + "/bku/json/simpanupdatels2";
    var dataac = [];
    var nilainr = [];
    var nilailist = [];
    var i;
    ...
    var datajour = {
        ...
        jenis: $("#jenis").val(),
        beban: $("#beban").val(),
        idkeg: idkeg, //$("#idKegiatan").val(),
        kodekeg: kodekeg, //$("#kodeKeg").val(),
        jumNR: jumNR,
        fileinbox: fileinbox,
        namapptk: namaPPTK,
        nippptk: nipPPTK,
