...
var ketval, ketcarabayar, ketjenistrx;
...
function grid() {
    ...
    if (typeof myTable == 'undefined') {
        myTable = $('#skpdtable').dataTable({
            ...
            "bFilter": false,
            "sAjaxSource": getbasepath() + "/bku/json/listkegiatanjson",
            "aaSorting": [[1, "asc"]],
            "fnServerParams": function(aoData) {
                ...
                {name: "keterangan", value: ketval},
                {name: "idskpd", value: $('#idskpd').val()},
                {name: "carabayar", value: ketcarabayar},
                {name: "jenistrx", value: ketjenistrx}
                );
            },
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                //var textkodesekolah = "<input type='hidden' id='kodeanggsekolah" + index + "' value='" + aData['kodeAnggSekolah'] + "' />";
