    ...
    if (typeof myTable == 'undefined') {
        myTable = $('#jourtable').dataTable({
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                var editspjpajak = "<a href='" + getbasepath() + "/bkuspjpajak/editbkuspj/" + "?tahun=" + tahun + "&nobukti=" + nobukti + "&tglpost=" + dpost + "' class='icon-edit' ></a>-";
                ...
                if (index == 1 || aData['bkuStatus'] == 1 || (aData['noJournal'] !== null && aData['kodeTransaksi'] !== "JO")) {
                    ...
                    if (aData['kodeKoreksi'] == "1") {
                        ...
                        //editvalid = editspjpajak; // edit SPJ + pajak
                    }
                    ...
                    if (aData['kodeKoreksi'] == "1") {
                        ...
                        if (aData['nilaiMasuk'] > 0) {
                            if (nobkuref > 0) { // SPJ + Pajak
                                editvalid = editspjpajak;
                            } else {
                                editvalid = editpajak; // edit Pajak Penerimaan Tanpa SPJ
                            }

                        } else {
                            editvalid = editpajak; // edit Pajak Pengeluaran
                        }
...
function gridbkuppkd() {

    if (typeof myTable2 == 'undefined') {
        myTable2 = $('#jourtableppkd').dataTable({
            "bPaginate": true,
            "sPaginationType": "bootstrap",
            "bJQueryUI": false,
            "bProcessing": true,
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                if (index == 1 || aData['bkuStatus'] == 1 || (aData['noJournal'] !== null && aData['kodeTransaksi'] !== "JO")) {
                    ...
                    if (aData['kodeKoreksi'] == "1") {
                        ...
                        editvalid = editspjpajak; //editspj; // edit SPJ
            ...
            "aoColumns": [
                ...
                {"mDataProp": "kodeakun", "bSortable": false, sClass: "center"},
                {"mDataProp": "uraianBukti", "bSortable": false, sClass: "left"},
                {"mDataProp": "nilaiMasuk", "bSortable": false, "sWidth": "15%", sClass: "right"},
                {"mDataProp": "nilaiKeluar", "bSortable": false, "sWidth": "15%", sClass: "right"},
                {"mDataProp": "saldoKas", "bSortable": false, "sWidth": "15%", sClass: "right"},
                {"mDataProp": "idBas", "bSortable": false, "sWidth": "5%", sClass: "center"}
            ]
        });
    }
...
function getTotal() {
    ...
    function(result) {
        ...
        if ($("#idskpd").val() == "761" || $("#idskpd").val() == "1234") {
            $("#totmasukppkd").val(accounting.formatNumber(tm, 2, '.', ","));
            $("#totkeluarppk").val(accounting.formatNumber(tk, 2, '.', ","));
            $("#totsaldokasppkd").val(accounting.formatNumber(ts, 2, '.', ","));
