...
function grid() {
    ...
    if (typeof myTable == 'undefined') {
        myTable = $('#spjtable').dataTable({
            ...
            "bFilter": false,
            "sAjaxSource": getbasepath() + "/bku/json/listpajak",
            "aaSorting": [[1, "asc"]],
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                if (aData['jenis'] == "P1") { // PPh 21
                    hitung = "";
                } else if (aData['jenis'] == "P2") { // PPh 22
                ...
                } else if (aData['jenis'] == "P4") { // PPh Pasal 4 ayat (2)
            ...
            "aoColumns": [
                ...
                {"mDataProp": "ketakun", "bSortable": false, sClass: "left"},
                {"mDataProp": "jenis", "bSortable": false, sClass: "center"},
