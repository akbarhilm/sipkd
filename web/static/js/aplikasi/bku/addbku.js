$(document).ready(function() {
    ...
    if ($("#idskpd").val() == 761 || $("#idskpd").val() == 1234) { // 1234 idskpd PPKD baru, mulai 2018
...
var saldojg = 0;
var saldobpjs = 0;
var saldoawaljgbp = -9999; // nilai awal sebelum panggil function
...
function setJenisBKU(suadana) {
    ...
    $.getJSON(getbasepath() + "/bku/json/getJenisBku", {},
            function(result) {
                ...
                try {
                    ...
                    if (banyak > 0) {
                        ...
                        for (var i = 0; i < banyak; i++) {
                            kode = result.aData[i]['kodeKeg'];
                            ket = result.aData[i]['namaKeg'];
                            if (idskpd == 761 || idskpd == 1234) { // 1234 idskpd PPKD baru, mulai 2018
                                if (kode == "KM" || kode == "JG") {
    ...
    /*
     ...
     opt += '<option value="JG">4 - Jasa Giro</option>';
     opt += '<option value="BP">5 - BPJS</option>';
     ...
     opt += '<option value="-">JASA GIRO -------------------------------------------------------------------------------------------------------</option>';
     opt += '<option value="JG">10 - Jasa Giro</option>';
     opt += '<option value="-">BPJS ---------------------------------------------------------------------------------------------------------------</option>';
     opt += '<option value="BP">11 - BPJS</option>';
...
function gantiText(valjenis) {
    ...
    if (valjenis == 'JO') {
    ...
    } else if (valjenis == 'NP' || valjenis == 'JG' || valjenis == 'BP') {
        var teks = "<input type='text' name='noBuktiDok' id='noBuktiDok' size='55' maxlength='50' />";
        $("#nobuktiketerangan").html(teks);
        document.getElementById("btnTambah").style.visibility = "hidden";
        document.getElementById("btnHapus").style.visibility = "hidden";
        ...
        teks = "<input type='text' name='noBuktiDok' id='noBuktiDok'  size='55' maxlength='50' readonly='true'/> &nbsp; <a id='pilihnosetor' onclick='setNoBku()' class='fancybox fancybox.iframe btn dark' href='#' title='Pilih Setoran'  ><i class='icon-zoom-in'></i> Pilih</a>";
        $("#nobuktiketerangan").html(teks);
        var a = document.getElementById("pilihnosetor");
        a.href = getbasepath() + "/bku/liststbl?target='_top'";
    ...
    } else if (valjenis == 'ST' && $("#beban").val() == "TU") {
        teks = "<input type='text' name='noBuktiDok' id='noBuktiDok'  size='55' maxlength='50' readonly='true'/> &nbsp; <a id='pilihnosetor' onclick='setNoBku()' class='fancybox fancybox.iframe btn dark' href='#' title='Pilih Setoran'  ><i class='icon-zoom-in'></i> Pilih</a>";
        $("#nobuktiketerangan").html(teks);
        var a = document.getElementById("pilihnosetor");
        a.href = getbasepath() + "/bku/liststbl?target='_top'";
    ...
    } else if (valjenis == 'ST' && $("#beban").val() == "LS" && ($("#jenis").val() == 1 || $("#jenis").val() == 3)) {
        var teks = "<input type='text' name='noBuktiDok' id='noBuktiDok'  size='55' maxlength='50' readonly='true'/> &nbsp; <a id='pilihnosetor'  class='fancybox fancybox.iframe btn dark' href='#' title='Pilih Setoran'  ><i class='icon-zoom-in'></i> Pilih</a>";
        $("#nobuktiketerangan").html(teks);
        document.getElementById("btnTambah").style.visibility = "hidden";
        document.getElementById("btnHapus").style.visibility = "hidden";
        document.getElementById("pilihKegSpj").style.visibility = "hidden";
...
function simpan() {
    ...
    var table6 = document.getElementById('pnpajaktablebody');
    var rows6 = table6.rows;
    var jumpjpg = rows6.length;
        ...
        if (jum2 > 0) {
            if (jenis == 1) { // BTL = tanpa kegiatan
                for (var a = 1; a <= idrow; a++) {
                    var nilai = parseFloat(accounting.unformat($('#nilaiMasuk' + a).val(), ","));


                    if ($('#akun' + a).val() == "" || $('#nilaiMasuk' + a).val() == "" || $('#nilaiKeluar' + a).val() == "" || nilai <= 0) {
                        datalengkap = false;
                    }
                }
    ...
    if (jenistransaksi == "ST") { // SETORAN
        var kodesa = $('#kodeSA').val();

        if (beban == "UP" || kodesa == "1") {
            ...
            if (jum2 > 0 || jumbarisstbtl > 0 || jumbarisstbl > 0) {
                if (jenis == 1 || jenis == 4) { // BTL dan Biaya = tanpa kegiatan
                    for (var a = 1; a <= idrow; a++) {
                        var nilai = parseFloat(accounting.unformat($('#nilaiKeluar' + a).val(), ","));
                    ...
                    for (var a = 1; a <= idrow; a++) {
                        var nilai = parseFloat(accounting.unformat($('#nilaiKeluar' + a).val(), ","));
                        if ($('#akun' + a).val() == "" || $('#idkeg' + a).val() == "" || $('#nilaiMasuk' + a).val() == "" || $('#nilaiKeluar' + a).val() == "" || nilai <= 0) {
                            datalengkap = false;
                        }
                    }
    ...
    if (jenistransaksi == "P1" || jenistransaksi == "P2" || jenistransaksi == "P3" || jenistransaksi == "P4" || jenistransaksi == "P5" || jenistransaksi == "P6") { // PAJAK
        ...
        if ($("#jenisPembayaran").val() == "PG") {
            ...
            if (document.getElementById("cbSA").checked == true) {
                if (tglPost == "" || nobukti == "" || tglDok == "" || uraian == "" || filling == "") {
                    bootbox.alert("Pengisian Data Harus Lengkap");
                    enableBtnSimpan();
                } else if ($("#beban").val() == "") {
                    bootbox.alert("Pilih Beban Terlebih Dulu");
                    enableBtnSimpan();
                } else if (bulanTglPost !== bulan) {
                    bootbox.alert("Tanggal Transaksi Harus Sesuai Bulan yang Dipilih");
                    enableBtnSimpan();
    ...
    if (jenistransaksi == "KM") {
        var nilaikm = accounting.unformat($("#pengeluaran").val(), ",");
        ...
        if (tglPost == "" || nobukti == "" || tglDok == "" || pengeluaran == "" || filling == "" || uraian == "" || nippptk == "" || namapptk == "") {
            ...
            bootbox.alert("Isi Nilai Kas Terlebih Dulu");
            enableBtnSimpan();
        } else {
            simpanKasMasuk();
        }
...
function simpanSetorBendahara() {
    ...
    var varurl = getbasepath() + "/bku/json/prosessimpansetorsb";
    var dataac = [];
...
function simpanKasMasuk() {
    ...
    nilaimasuk = (accounting.unformat($("#pengeluaran").val(), ",")).toString();
    var nilaiformat = nilaimasuk.replace(".", ",");
    //console.log("nilai kas masuk : "+nilaiformat);
    nilaikeluar = "0";
    ...
    var datajour = {
        ...
        uraian: uraian,
        carabayar: $("#kodePembayaran").val(),
        nilaimasuk: nilaiformat, //nilaimasuk,
        nilaikeluar: nilaikeluar,
        akun: akun,
        idbas: idbas
    };
...
function simpanSetorUP() {
    ...
    } else if ($('#jenisTransaksi').val() == "ST") {
        namaPPTK = "";
        nipPPTK = "";
        beban = $("#beban").val();
        jenis = "3";
        akun = "1.1.01.03.01.001.02";
        idbas = "3895";
...
function simpanJasaGiro() {
    ...
    var varurl = getbasepath() + "/bku/json/prosessimpanjasagiro";
    var dataac = [];
...
function simpanCek() {
    ...
    if (jenistransaksi == "C1") { // Pencairan cek dari rekening bendahara pengeluaran skpd
         ...
         * akunpn = "1.1.1.03.01.001"; // tunai
         ...
         idbaspn = "9947";
         idbaspg = "9948"; */
        // TRBAS BARU -- DEFAULT KAS UP/GU

        akunpn = "1.1.01.03.01.001.01"; // tunai
        akunpg = "1.1.01.03.01.001.02"; // bank
        idbaspn = "3894";
        idbaspg = "3895";
        ...
        akunpn = "1.1.01.03.01.001.02"; // bank
        akunpg = "1.1.01.03.01.001.01"; // tunai
        idbaspn = "3895";
        idbaspg = "3894";

    }

    var varurl = getbasepath() + "/bku/json/prosessimpancek";
    var dataac = [];
...
function simpanSTtanpakeg() {
    ...
    if ($('#jenisTransaksi').val() == "ST" && $("#beban").val() == "LS" && $("#jenis").val() == 1) {
        jumlahrow = jumbarisstbtl;
    } else if ($('#jenisTransaksi').val() == "ST" && $("#beban").val() == "LS" && $("#jenis").val() == 3) {
        jumlahrow = jumbarisstbl;
    } else {
        jumlahrow = idrow;
    }
...
function simpanNPD() {
    ...
    if (jenistrans == "ST" && $("#beban").val() == "LS" && $("#jenis").val() == 1) {
        jumlahrow = jumbarisstbtl;
    } else if (jenistrans == "ST" && $("#jenis").val() == 3) {
        jumlahrow = jumbarisstbl;
    } else {
        jumlahrow = idrow;
    }
    ...
    var nilailist = [];
    var i;
    var idkeg, kodekeg, idbas, kodeakun;
    ...
    for (i = 0; i < jumlahrow; i++) { // list
        ...
        if (jenistrans == "SB") {
            idkeg = $("#idKegiatanSb").val();
            kodekeg = $("#kodeKegSb").val();
        } else {
            idkeg = $("#idkeg" + id).val();
            kodekeg = $("#kegiatan" + id).val();
        }
        ...
        var pararr = {
            ...
            nilaikeluar: parseFloat(accounting.unformat($('#nilaiKeluar' + id).val(), ",")),
            idbas: idbas, //$("#akun" + id).val(),
            kodekegiatan: kodekeg, //$("#kegiatan" + id).val(),
            uraianbukti: $("#uraian").val(), //$("#namaakun" + id).val(),
            idkegiatan: idkeg, //$("#idkeg" + id).val(),
            kodeakun: kodeakun, //$("#valkodeakun" + id).val(), //$('select[name="akun' + id + '"]').find(":selected").text()
            idspd: idspd
        };
        nilailist[i] = pararr;
...
function simpanNPNM() {
    ...
    var akunbayar, idbayar, akunpanjar, idbaspanjar;
    var beban = $("#beban").val();
    ...
    if (carabayar == 1) { // TUNAI
        if (beban == "UP") {
            akunbayar = "1.1.01.03.01.001.01";
            idbayar = "3894";
        } else { // TU
            akunbayar = "1.1.01.03.01.003.01";
            idbayar = "3899";
        }

    } else if (carabayar == 2) { // BANK
        if (beban == "UP") {
            akunbayar = "1.1.01.03.01.001.02";
            idbayar = "3895";
        } else { // TU
            akunbayar = "1.1.01.03.01.003.02";
            idbayar = "3900";
        }
    }
    ...
    if (beban == "UP") {
        akunpanjar = "1.1.01.03.01.001.03";
        idbaspanjar = "3896";

    } else { // TU
        akunpanjar = "1.1.01.03.01.003.03";
        idbaspanjar = "3901";
    }
    ...
    var varurl = getbasepath() + "/bku/json/prosessimpannpnm";
    var dataac = [];
    var nilailist = [];
    var i;
...
function clearrowpjpg() {
    var i;
    var table = document.getElementById('pnpajaktablebody');
    var rows = table.rows;
    var jum = rows.length;
...
function clearrowstbl() {
    var i;
    var table = document.getElementById('stbltablebody');
    var rows = table.rows;
    var jum = rows.length;
...
function clearrowstbtl() {
    var i;
    var table = document.getElementById('stbtltablebody');
    var rows = table.rows;
    var jum = rows.length;
...
function getKegiatan() {
    ...
    } else if (jenistrans == "SB" && $('#jenis').val() == 3) {
        //console.log("masuk NM");
        $('#idKegiatanSb').val($('#idKegpop').val());
        $("#keteranganKegPopSb").val($('#ketKegpop').val());
        $("#kodeKegSb").val($('#kodeKegpop').val());
        clearrow();
...
function setAkunCombo(id, idspd) {
    ...
    if (jenistrans == "SB" && $('#jenis').val() == 3) {
        //console.log("setAkunCombo jenistrans SB");
        id = $('#idKegiatanSb').val();
        idcombo = 1;
    }

    $.getJSON(getbasepath() + "/bku/json/getAkunCombo", {tahun: tahun, idskpd: idskpd, idkegiatan: id, keterangan: ketcombo, pajak: pajak, beban: beban, idspd: idspd},
    function(result) {
        var banyak, kode, ket, baris;
        var opt = "";
        banyak = result.aData.length;
...
function setBeban() {
    ...
    document.getElementById("labelkegiatanpajak").style.display = "none";
    document.getElementById("labelkegiatansb").style.display = "none";
    document.getElementById("labelsaldojasagiro").style.display = "none";
    document.getElementById("labeljenisbpjs").style.display = "none";
    document.getElementById("labelsaldobpjs").style.display = "none";
    document.getElementById("labelSAPajak").style.display = "none";
    ...
    if (jenistransaksi == "NP") {   // NPD ke PPTK
        ...
        if ($('#idskpd').val() == 761 || $('#idskpd').val() == 1234) { // 1234 idskpd PPKD baru, mulai 2018
            ...
            if ((bulan == "01" || bulan == "12" || bulan == "02" || bulan == "03" || bulan == "04" || bulan == "05") && banyakSetorUp <= 5) { // jika belum ada setoran UP/GU; persemester
                ...
                opt = '<option value="" ></option>';
                //opt += '<option value="UP" >UP/GU</option>'; // BUAT TES UP/GU.. NANTI HAPUS LAGI KL UDAH BERES
                opt += '<option value="TU" >TU</option>';
                opt += '<option value="LS" >LS</option>';
            }
        }
        ...
        if ($("#jenis").val() == 3) {
            document.getElementById("labelkegiatansb").style.display = "block";
        }

        setColumn($("#jenis").val());

    } else if (jenistransaksi == "JG") {   // Jasa Giro
        document.getElementById("labelkegiatanspj").style.display = "none";
        document.getElementById("labeljenis").style.display = "none";
        ...
        document.getElementById("labelkegiatansb").style.display = "none";
        document.getElementById("labelbeban").style.display = "none";
        // document.getElementById("labelsaldojasagiro").style.display = "block";

    } else if (jenistransaksi == "BP") {   // BPJS
        document.getElementById("labelkegiatanspj").style.display = "none";
        document.getElementById("labeljenis").style.display = "none";
        ...
        document.getElementById("labelkegiatansb").style.display = "none";
        document.getElementById("labelbeban").style.display = "none";
        //document.getElementById("labelsaldobpjs").style.display = "block";
        document.getElementById("labeljenisbpjs").style.display = "block";
...
function setJenisPajak() {
    ...
    var opt = "";
    // untuk idskpd baru mulai 2018 : 13165, 13189; untuk 396 (dinas pelayanan pajak) tdk ada skpd mapping nya
    if ($('#idskpd').val() == 396 || $('#idskpd').val() == 995 || $('#idskpd').val() == 980 || $('#idskpd').val() == 13165 || $('#idskpd').val() == 13189) { // KHUSUS bayar  pajak kdh & wkdh dan DPP (BPRD) tuk insentifnya
        opt = '<option value="1" >BTL</option>';
...
function setPengeluaran() {
    ...
    if (jenistrans == "JJ") { // ditambah 25 Jan 2016 by zainab.. tambah validasi2 untuk SPj berdasarkan hasil diskusi pelampauan
     ...
     $('#jourtable2').hide();
        ...
        document.getElementById("labelpengeluaran").style.visibility = "visible";
        document.getElementById("labelpengeluaran").style.display = "block";
        document.getElementById('labelpengeluarantext').innerHTML = 'Nilai BPJS :';
        ...
        //$("#jenis").val(3);
        //$('#jenis').attr("disabled", true);
        //console.log("jenisbayar = "+jenisbayar);
        if (jenisbayar == "PN") {
            document.getElementById("pengeluaran").style.visibility = "hidden";
            document.getElementById("labelpengeluaran").style.visibility = "hidden";
            document.getElementById("labelpengeluaran").style.display = "none";
    ...
    if (jenistrans == "ST" && beban == "UP") {
        document.getElementById("btnTambah").style.visibility = "hidden";
        document.getElementById("btnHapus").style.visibility = "hidden";
    } else if (jenistrans == "ST" && kodesa == "1") {
        document.getElementById("btnTambah").style.visibility = "hidden";
        document.getElementById("btnHapus").style.visibility = "hidden";
    } else if (jenistrans == "JG" || jenistrans == "BP") {
        document.getElementById("btnTambah").style.visibility = "hidden";
        document.getElementById("btnHapus").style.visibility = "hidden";
    } else if (jenistrans == "SB") {
        document.getElementById("btnTambah").style.visibility = "visible";
        document.getElementById("btnHapus").style.visibility = "visible";
    } else if ((jenistrans == "ST" && beban == "LS" && ($("#jenis").val() == 2 || $("#jenis").val() == 4))) { //|| (jenistrans == "ST" && beban == "TU")
        document.getElementById("btnTambah").style.visibility = "visible";
        document.getElementById("btnHapus").style.visibility = "visible";
    } else if ((jenistrans == "ST" && ($("#jenis").val() == 1 || $("#jenis").val() == 3))) { //&& beban == "LS"
        document.getElementById("btnTambah").style.visibility = "hidden";
        document.getElementById("btnHapus").style.visibility = "hidden";
...
function setUraian() {
    ...
    if (jenistrans == "ST") {
    ...
    } else if (jenistrans == "SB" || jenistrans == "JG" || jenistrans == "BP") {
        document.getElementById("labeluraian").style.display = "block";
        $("#uraian").val("");
        ...
        $("#uraiankeluar").val("Dibayar dari kas ");
...
function setCaraBayar() {
    ...
    if (jenistrans == "JG" || jenistrans == "BP") {
        document.getElementById("labelcarabayar").style.display = "block";
...
function setLabel() {
    ...
    if (jenistransaksi == "ST") {
        document.getElementById('labeltglpost').innerHTML = 'Tgl Transaksi / Tgl Validasi :';
        document.getElementById('labelnobuktidok').innerHTML = 'No Bukti Dok / No Validasi :';
        document.getElementById('labeltgldok').innerHTML = 'Tgl Dokumen / Tgl STS :';
        $("#tglPosting").attr("disabled", true);
        $("#tglDok").attr("disabled", true);

        console.log("setLabel jenistransaksi == ST");
    } else {
        document.getElementById('labeltglpost').innerHTML = 'Tanggal Transaksi :';
        document.getElementById('labelnobuktidok').innerHTML = 'No Bukti Dok :';
        document.getElementById('labeltgldok').innerHTML = 'Tanggal Dokumen :';
        $("#tglPosting").attr('disabled', false);
...
function setST() {
    var jenis = $('#stjenis').val();
    var beban = $('#stbeban').val();
    var optbeban = "";
    var optjenis = "";
    var kodesa = $('#kodeSA').val();
    ...
    if (beban == "UP") {
        ...
        document.getElementById("pengeluaran").style.visibility = "visible";
        document.getElementById('labelpengeluarantext').innerHTML = 'Nilai Pengeluaran :';
        //console.log("labelpengeluaran block");
        setPengeluaran();
        optbeban = '<option value="UP" >UP/GU</option>';
    } else if (beban == "TU") {
        optbeban = '<option value="TU" >TU</option>';
    } else if (beban == "LS") {
        optbeban = '<option value="LS" >LS</option>';
...
function setnobuktidok() {
    ...
    if (jenistransaksi == "ST") {
        ...
        $("#nobuktiketerangan").html(teks);
        var a = document.getElementById("pilihnosetor");
        a.href = getbasepath() + "/bku/listsetoran?target='_top'";

        if ($('#jenisTransaksi').val() == "UP") {
            document.getElementById('pengeluaran').readOnly = true;
        }

    } else if (jenistransaksi == "JG" || jenistransaksi == "BP") {
        saldoawaljgbp = -9999; // set ulang nilai saldo awal nya
        $('#pengeluaran').val("");
        document.getElementById('pengeluaran').readOnly = true;
    } else {
...
function setGrid() {
    ...
    } else if (jenistransaksi == "ST" && jenis == 1 && beban !== "UP") { //&& beban == "LS"
    ...
    } else if (jenistransaksi == "ST" && jenis == 3 && beban !== "UP") { //&& beban == "LS"
    ...
    } else if (jenistransaksi == "ST" && beban == "TU") { //&& beban == "TU"
    ...
    } else if (jenistransaksi == "ST" && beban == "UP") {
    ...
    } else if (jenistransaksi == "JG" || jenistransaksi == "BP" || jenistransaksi == "LL" || jenistransaksi == "C1" || jenistransaksi == "C2" || jenistransaksi == "KM") {
        $('#tabelNP').hide();
        $('#tabelSPJ').hide();
        $('#tabelDLL').hide();
        $('#tabelSP2D').hide();
...
function getNipPPTK() {
    ...
    $.getJSON(getbasepath() + "/bku/json/getNipPPTK", {tahun: tahun, idskpd: idskpd, idkegiatan: idkegiatan},
    function(result) {
        var banyak;
        ...
        myTablestbl = $('#stbltable').dataTable({
            ...
            "fnServerParams": function(aoData) {
                aoData.push(
                        {name: "tahun", value: $("#tahun").val()},
                {name: "idskpd", value: $("#idskpd").val()},
                {name: "nobku", value: "-999"},
                {name: "beban", value: $("#beban").val()},
                {name: "novalidasi", value: $("#noBuktiDok").val()}
                );
            },
            "fnFooterCallback": function(nRow, aaData, iStart, iEnd, iDisplay) {
...
function getSuadana() {
    ...
    $.getJSON(getbasepath() + "/bku/json/getStatusSuadana", {tahun: tahun, idskpd: idskpd},
    function(result) {
...
function getNilaiSisaSpj() {
    ...
    $.getJSON(getbasepath() + "/bku/json/getNilaiSisaSpj", {tahun: tahun, idskpd: idskpd, nobku: "0", beban: beban, idkegiatan: idkegiatan, bulan: bulan},
    function(result) {
        var banyak;
...
function getNilaiValidasiSisaSpj() { // dibuat 22 jan 16 by zainab, untuk memvalidasi total bku
    ...
    if (idkegiatan !== "") {
        $.getJSON(getbasepath() + "/bku/json/getNilaiValidasiSisaSpj", {tahun: tahun, idskpd: idskpd, nobku: "0", idkegiatan: idkegiatan, beban: beban},
        function(result) {
...
function getNamaNipSpjPanjar() {
    ...
    if (kodePembayaran == 3 && idkegiatan !== "") {
        $.getJSON(getbasepath() + "/bku/json/getNamaNipSpjPanjar", {tahun: tahun, idskpd: idskpd, idkegiatan: idkegiatan},
        function(result) {
            var banyak = result.aData.length; // untuk ngambil length nya, type keluarannya harus list
            var nama, nip;
            var opt;
...
function getBebanSetorUP() {
    ...
    $.getJSON(getbasepath() + "/bku/json/getSetorUPSemester", {idskpd: $("#idskpd").val(), semester: semester},
    function(result) {
...
function getBendahara() {
    ...
    if (jenistrans == "LL") {
        $.getJSON(getbasepath() + "/bku/json/getBendahara", {tahun: tahun, idskpd: idskpd},
        function(result) {
            $("#nipPptk").val(result.aData[0]['nipPptk']);
            $("#namaPptk").val(result.aData[0]['namaPptk']);
        });
...
function getDataKBUD() {

    $.getJSON(getbasepath() + "/bku/json/getDataKBUD", {},
            function(result) {
...
function getSaldoAwalPajak() {
    ...
    $.getJSON(getbasepath() + "/bku/json/getSaldoAwalPajak", {tahun: tahun, idskpd: idskpd, jenis: jenis},
    function(result) {
...
function getSisaPajak() {
    ...
    $.getJSON(getbasepath() + "/bku/json/getSisaPajak", {tahun: tahun, idskpd: idskpd, jenis: jenis, beban: beban, keterangan: "ADD"},
    function(result) {
        document.getElementById("labelsisapajak").style.display = "block";
        ...
        if (sisapajak > 0) {
            if (jenisbayar == "PG") {
                document.getElementById("labelSAPajak").style.display = "block";
            } else {
                document.getElementById("labelSAPajak").style.display = "none";
            }
...
function setNoBku() {
    /* GANTI CARA NGIRIM PARAMETER .. JADI PAKE -> $('#noBKU', window.parent.document).val()
     window.localStorage.setItem("ketNoBku", "-999");
     window.localStorage.setItem("ketBeban", $('#beban').val());
     window.localStorage.setItem("ketJenis", $('#jenis').val());
     */
}
...
function setPajak() {
    ...
    var jenistrans = $('#jenisTransaksi').val();
    var jenis = $('#jenis').val();
    var opt, ketpajak, uraian;

    var a = document.getElementById("pilihKegPajak");
    document.getElementById("cbSA").checked = false;
    ...
    if (jenistrans == "P1") {
        ketpajak = "PPH PS 21";
    } else if (jenistrans == "P2") {
        ketpajak = "PPH PS 22 ";
    } else if (jenistrans == "P3") {
        ketpajak = "PPH PS 23 JASA I";
    } else if (jenistrans == "P4") {
        ketpajak = "PPH PS 4 Ayat 2";
    } else if (jenistrans == "P5") {
        ketpajak = "PPN";
    } else if (jenistrans == "P6") {
        ketpajak = "PPH Pasal 26 - Hadiah Undian";
    }
    ...
    if (jenistrans.substr(0, 1) == "P") {
        ...
        if (jenisbayar == "PN") {
            ...
            document.getElementById("pilihKegPajak").style.visibility = "visible";

            if (jenis == "1") { //BTL
                document.getElementById("labelkegiatanpajak").style.display = "none";
            }

            a.href = getbasepath() + "/bku/listkegiatan?target='_top'";
            document.getElementById("labelSAPajak").style.display = "none";
            document.getElementById("btnTambah").style.visibility = "visible";
            document.getElementById("btnHapus").style.visibility = "visible";
            $('#tabelDLL').show();
            ...
            uraian = "Diterima Pajak " + ketpajak + " atas kegiatan ";
            $('#uraian').val(uraian);
            ...
            opt = '<option value="PN" >Penerimaan</option>';
            opt += '<option value="PG" selected>Pengeluaran</option>';
            $("#jenisPembayaran").html(opt);

            document.getElementById("pilihKegPajak").style.visibility = "visible";

            a.href = getbasepath() + "/bku/listpajakterima?target='_top'";
            document.getElementById("btnTambah").style.visibility = "hidden";
            document.getElementById("btnHapus").style.visibility = "hidden";
            if (sisapajak > 0) {
                document.getElementById("labelSAPajak").style.display = "block";
            ...
            uraian = "Disetor Pajak " + ketpajak + " atas ";
            $('#uraian').val(uraian);
        }
    }
...
function setSA() {
    ...
    if (jenistrans.substr(0, 1) == 'P') {
        ...
        if (document.getElementById("cbSA").checked == true) {
            ...
            uraian = "Disetor Pajak " + ketpajak + " atas Saldo Awal Tahun" + $('#tahun').val();
            $('#uraian').val(uraian);
...
function gridpgpajak() {
    jumbarispjpg = 0
    if (typeof myTablepjpn == 'undefined') {
        myTablepjpn = $('#pnpajaktable').dataTable({
            "bPaginate": true,
            "sPaginationType": "bootstrap",
            "bJQueryUI": false,
            "bProcessing": true,
            ...
            //"sScrollY": ($(window).height() * 108 / 100),
            "bFilter": false,
            "sAjaxSource": getbasepath() + "/bku/json/listpajakpg",
            "aaSorting": [[1, "asc"]],
            "fnDrawCallback": function() {
                $(".inputmoney").autoNumeric('init', {aSep: '.', aDec: ','});
            },
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                var idbas = "<input type='hidden' id='idbas" + index + "' value='" + aData['idBas'] + "' />";
                var namaakun = "<textarea id='akunnama" + index + "'readonly style='border:none;margin:0;width:800px;'>" + aData['namaakun'] + "</textarea>";
                var textkodeakun = "<input type='hidden' id='kodeakun" + index + "' value='" + aData['kodeakun'] + "' />";
                ...
                $('td:eq(0)', nRow).html(index);
                $('td:eq(3)', nRow).html(namaakun + idbas + textkodeakun);
...
function simpanPJPG() {
    ...
    if ($('#jenis').val() == "1") {
        ...
        kodekeg = $('#kodeKegPajak').val();
    }

    if (jumbarispjpg > 0) {

        var varurl = getbasepath() + "/bku/json/prosessimpanpjpg";
        var dataac = [];
        var nilailist = [];
        var i;

        for (i = 0; i < jumbarispjpg; i++) { // list
            var id = i + 1;

            var pararr = {
                nilaimasuk: "0",
                nilaikeluar: parseFloat(accounting.unformat($('#nilaipajak' + id).val(), ",")),
                idbas: $("#idbas" + id).val(),
                kodeakun: $("#kodeakun" + id).val()
            };
            nilailist[i] = pararr;
...
function simpanPajakSA() {
    ...
    var varurl = getbasepath() + "/bku/json/prosessimpanpajaksa";
    var dataac = [];
    ...
    var datajour = {
        ...
        carabayar: $("#kodePembayaran").val(),
        nilaimasuk: "0",
        nobku: "-1" // NO BKU REF UNTUK PAJAK SALDO AWAL = -1
    }
...
function setjenisbebanpj() {
    $("#beban").val($("#bebanPajak").val());
    $("#jenis").val($("#jenisPajak").val());

    var bayar = $("#bayarPajak").val();
    var opt = "";
...
function setJenisPembayaran() {
    ...
    if (jenistrans.substr(0, 1) == "P" || jenistrans == "BP" || jenistrans == "JG") {
        opt = '<option value="-" >Pilih</option>';
        opt += '<option value="PN" >Penerimaan</option>';
        opt += '<option value="PG" >Pengeluaran</option>';

        if (jenistrans.substr(0, 1) == "P") { // Khusus Pajak
            document.getElementById("pilihKegPajak").style.visibility = "hidden";
        }
...
function setnilaijgbp() {
    var jenistrans = $('#jenisTransaksi').val();
    var jenisbayar = $('#jenisPembayaran').val();

    $('#pengeluaran').val("");

    if (jenistrans == "BP" || jenistrans == "JG") {
        if (jenisbayar == "PG") {
            document.getElementById("pilihjgbp").style.visibility = "visible";
            document.getElementById('pengeluaran').readOnly = true;
            document.getElementById("labelSAPajak").style.display = "block";
...
function getSaldoAawalJGBP() {
    ...
    var idskpd = $('#idskpd').val();
    var akun = $('#jenisbpjs').val();
    var kodetrx = $('#jenisTransaksi').val();
    var jenisbayar = $('#jenisPembayaran').val();
    var nobku = "-9999";

    if (jenisbayar == "PG" && document.getElementById("cbSA").checked == true) {
