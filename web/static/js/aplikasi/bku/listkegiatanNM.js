    ...
    if (typeof myTable == 'undefined') {
        myTable = $('#skpdtable').dataTable({
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                var nilaisebelum = accounting.formatNumber(aData['nilaiBkuSebelum'], 2, '.', ",");
                
                $('td:eq(0)', nRow).html(index);
                $('td:eq(3)', nRow).html(nilainpd);
                $('td:eq(4)', nRow).html(nilaisebelum);
                $('td:eq(5)', nRow).html(textket+textkode+textnama+"<span class='icon-ok-sign linkpilihan' onclick='ambilskpd(" + aData['idKegiatan'] + ")'></span>");
            ...
            "aoColumns": [
                ...
                {"mDataProp": "nilaiNpd", "bSortable": true, sClass: "right"},
                {"mDataProp": "nilaiBkuSebelum", "bSortable": true, sClass: "right"},
                {"mDataProp": "idKegiatan", "bSortable": false, sClass: "center"}
            ]
        });
    }
