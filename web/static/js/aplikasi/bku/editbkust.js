...
function simpan() {
    ...
    var saldokas = accounting.unformat($("#saldokas").val(), ",");
    ...
    } else if (sisakas < saldokas) {
        bootbox.alert("Setoran Tidak Boleh Lebih Besar Dari Sisa Kas");
    } else {
        update();
    }
