$(document).ready(function() {
    ...
    $('#keteranganAkunLain').val($('#ketakun').val());
    console.log("$('#nilaiKeluar').val() == " + parseFloat(accounting.unformat($('#nilaiKeluar').val(), ",")));
    if (parseFloat(accounting.unformat($('#nilaiKeluar').val(), ",")) > 0) {
...
function setAkun() {
    ...
    var id = $('#idbaslain').val();
    var kode = $('#kodeAkunLain').val();
...
function unformatnilai() {
    ...
    if (parseFloat(accounting.unformat($('#nilaiKeluar').val(), ",")) > 0) {
        nilai = $('#nilaiKeluar').val(); //parseFloat(accounting.unformat($('#nilaiKeluar').val(), ","));
    } else {
        nilai = $('#nilaiMasuk').val(); //parseFloat(accounting.unformat($('#nilaiMasuk').val(), ","));
    }
