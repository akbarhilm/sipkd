                ...
                try {
                    ...
                    if (banyak > 0) {
                        ...
                        for (var i = 0; i < banyak; i++) {
                            ...
                            if (kode !== "JJ") {
                                if (idskpd == 761) {
                                    if (kode == "KM" || kode.substr(0, 1) == 'P' || kode == "KG" || kode == "BP") {
...
function setJenisPajak() {
    ...
    if ($('#idskpd').val() == 396 || $('#idskpd').val() == 995 || $('#idskpd').val() == 980) { // KHUSUS bayar  pajak kdh & wkdh dan DPP (BPRD) tuk insentifnya
        opt = '<option value="1" >BTL</option>';
...
function setUraian() {
    ...
    if (jenistrans == "ST") {
        ...
        var uraianawal;
        if (jenisbayar == "PN") {
            uraianawal = "Diterima Pajak ";
        } else {
            uraianawal = "Disetor Pajak ";
        }

        var uraian = uraianawal + ketpajak + " atas ";
        $('#uraian').val(uraian);
    }
...
function setGrid() {
    ...
    if (jenistransaksi == "JO") {
        ...
        if ($('#idskpd').val() == 396 || $('#idskpd').val() == 995) {
            if (jenisbayar == "PN") {
                $('#tabelDLL').show();
            } else if (jenisbayar == "PG") {
                $('#tabelPNPJ').show();
    ...
    } else if (jenistransaksi == "ST" && beban == "TU") { //&& beban == "LS"
...
function setPajak() {
    ...
    var jenistrans = $('#jenisTransaksi').val();
    var jenis = $('#jenis').val();
    var opt, ketpajak, uraian, optjenis;
    ...
    if (jenistrans.substr(0, 1) == "P") {
        ...
        if (jenisbayar == "PN") {
            ...
            optjenis = '<option value="1" >BTL</option>';
            optjenis += '<option value="3" selected>BL</option>';
            $("#jenis").html(optjenis);
...
function setJenisPembayaran() {
    ...
    } else if (jenistrans == "BP" || jenistrans == "JG") {
        opt = '<option value="-" >Pilih</option>';
        opt += '<option value="PN" >Penerimaan</option>';
        opt += '<option value="PG" >Pengeluaran</option>';
