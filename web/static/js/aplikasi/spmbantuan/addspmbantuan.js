...
function getpagudanspd(idskpd) {
    $.getJSON(getbasepath() + "/spmbtlbantuan/json/getanggarandanspdbantuanlangsung/" + idskpd,
            function(result) {
...
function getbanyakspdrinci( ) {
    $.getJSON(getbasepath() + "/spmbtlbantuan/json/getlistspdblbanyak", {tahunAnggaran: $("#tahun").val(), idskpd: $("#idskpd").val()},
    function(result) {
...
function gridspprinci() { 
    var urljson = getbasepath() + "/spmbtlbantuan/json/getlistspdbtl";
