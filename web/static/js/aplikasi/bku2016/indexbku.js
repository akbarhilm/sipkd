...
function gridbku() {
    ...
    if (typeof myTable == 'undefined') {
        myTable = $('#jourtable').dataTable({
            ...
            "iDisplayLength": 50,
            "sAjaxSource": getbasepath() + "/bku2016/json/listbkuindex",
            "aaSorting": [[1, "asc"]],
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                var edit = "<a href='" + getbasepath() + "/bku2016/editbku/" + "?noBKU=" + aData['noBKU'] + "&tahun=" + tahun + "' class='icon-edit' ></a>-";
                var editpajak = "<a href='" + getbasepath() + "/bku2016/editbkupajak/" + "?noBKU=" + aData['noBKU'] + "&tahun=" + tahun + "' class='icon-edit' ></a>-";
                var editStUp = "<a href='" + getbasepath() + "/bku2016/editbkustup/" + aData['idBku'] + "?tahun=" + tahun + "' class='icon-edit' ></a>-";
                var editStLs = "<a href='" + getbasepath() + "/bku2016/editbkuls/" + aData['kodeTransaksi'] + "?noBKU=" + aData['noBKU'] + "&tahun=" + tahun + "' class='icon-edit' ></a>-";
                var editStLs2 = "<a href='" + getbasepath() + "/bku2016/editbkuls2/" + aData['kodeTransaksi'] + "?noBKU=" + aData['noBKU'] + "&tahun=" + tahun + "' class='icon-edit' ></a>-";
                var editspj = "<a href='" + getbasepath() + "/bku2016/editbkuspj/" + aData['noBKU'] + "?tahun=" + tahun + "' class='icon-edit' ></a>-";
                var editspjkoreksi = "<a href='" + getbasepath() + "/bku2016/editbkuspjkoreksi/" + aData['noBKU'] + "?tahun=" + tahun + "' class='icon-edit' ></a>-";
                var editCek = "<a href='" + getbasepath() + "/bku2016/editbkucek/" + aData['noBKU'] + "?tahun=" + tahun + "' class='icon-edit' ></a>-";
                var editSp2d = "<a href='" + getbasepath() + "/bku2016/editbkusp2d/" + aData['idTransaksi'] + "/" + aData['noBKU'] + "?tahun=" + tahun + "' class='icon-edit' ></a>-";
                var editNPD = "<a href='" + getbasepath() + "/bku2016/editbkunpd/" + aData['kodeTransaksi'] + "?nobku=" + aData['noBKU'] + "&tahun=" + tahun + "' class='icon-edit' ></a>-";
                var editLainLain = "<a href='" + getbasepath() + "/bku2016/editbkulainlain/" + aData['idBku'] + "?tahun=" + tahun + "' class='icon-edit' ></a>-";
                var editKasMasuk = "<a href='" + getbasepath() + "/bku2016/editbkukasmasuk/" + aData['idBku'] + "?tahun=" + tahun + "' class='icon-edit' ></a>-";
               var editpajakkoreksi = "<a href='" + getbasepath() + "/bku2016/editbkupajakkoreksi/" + "?noBKU=" + aData['noBKU'] + "&tahun=" + tahun + "' class='icon-edit' ></a>-";
...
function getTotal() {
    ...
    $.getJSON(getbasepath() + "/bku2016/json/getTotal", {tahun: tahun, idskpd: idskpd, bulan: bulan},
    function(result) {
