...
function setAkunCombo(id,idspd) {
    ...
    $.getJSON(getbasepath() + "/bku2016/json/getAkunCombo", {tahun: tahun, idskpd: idskpd, idkegiatan: id, keterangan: ket, pajak:pajak, beban:beban, idspd:idspd},
    function(result) {
        var banyak, kode, ket;
        var opt = "";
...
function getbanyakrinci() {
    ...
    $.getJSON(getbasepath() + "/bku2016/json/getBanyakEdit", {idskpd: idskpd, tahun: tahun, nobukti: nobukti, tglpos: tglpost, nobku: nobku},
    function(result) {
        banyakdata = result;
...
function getrincilist() {
    ...
    $.getJSON(getbasepath() + "/bku2016/json/valtabel", {idskpd: idskpd, tahun: tahun, nobukti: nobukti, tglpos: tglpost, nobku: nobku},
    function(result) {
        var i, c;
...
function update() {
    ...
    var varurl = getbasepath() + "/bku2016/json/prosessimpanupdate";
    var dataac = [];
    var nilainr = [];
    var nilailist = [];
    var i;
