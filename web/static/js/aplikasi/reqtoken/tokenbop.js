...
function getTimeLimit(index) {
    $.getJSON(getbasepath() + "/token/json/getTimeLimit", {kodesumbdana: 2, nomohon: $('#noBkuMohon' + index).val(), idsekolah: $('#idsekolah').val(),tahun:$("#tahun").val()},
    function(result) {
...
function simpan() {
    ...
    for (var i = 1; i <= length; i++) {
        ...
        console.log($("#token" + i).val() + " " + $("#requesttimedki" + i).val())
