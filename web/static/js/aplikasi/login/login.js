...
function createSlideTidakAdaBerita() {
    ...
    $("#isiberita").val("Surat Perintah Membayar yang selanjutnya disingkat SPM adalah dokumen yang digunakan/diterbitkan oleh pengguna anggaran/kuasa pengguna anggaran untuk penerbitan SP2D atas beban pengeluaran DPA-SKPD.");
