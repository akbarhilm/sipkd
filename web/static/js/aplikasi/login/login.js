...
function createSlideTidakAdaBerita() {
    ...
    $("#isiberita").val("(1) Bendahara pengeluaran / bendahara pengeluaran pembantu wajib mempertanggungjawabkan penggunaan uang yang menjadi tanggung jawabnya dengan menyampaikan laporan pertanggungjawaban pengeluaran secara administratif kepada SKPD/UKPD melalui PPK-SKPD untuk dilakukan verifikasi dan secara fungsional kepada PPKD selaku BUD paling lambat tanggal 10 (sepuluh) bulan berikutnya.\n\
\n\
(2) Untuk tertib laporan pertanggungjawaban pengeluaran dana bulan Desember disampaikan paling lambat tanggal 31 Desember.");
    document.getElementById("isiberita").style.fontSize = "14px";
