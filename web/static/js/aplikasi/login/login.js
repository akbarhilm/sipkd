...
function createSlideTidakAdaBerita() {
    ...
    $("#isiberita").val("Surat Penyediaan Dana yang selanjutnya disingkat SPD adalah dokumen yang menyatakan tersedianya dana untuk melaksanakan kegiatan sebagai dasar penerbitan SPP.");
...
function tesManual() {
    ...
    document.getElementById('labelberitaawal').innerHTML = "Ditujukan : Seluruh Pelaksana Bidang Anggaran";
    //document.getElementById("labelberitaawal").style.fontSize = "16px";
    document.getElementById("labelberitaawal").style.textShadow = "none";

    var berita = "SPD yang dikeluarkan oleh Bidang Anggaran meliputi SPD Belanja Tidak Langsung/SPD Gaji untuk XX SKPD dan SPD Belanja Langsung untuk XX SKPD. Selanjutnya masing-masing SKPD dapat mengambil SPD-nya masing-masing di Bidang Anggaran selama jam kerja.";
    $("#isiberita").val(berita);
    document.getElementById("isiberita").style.fontWeight = 'bold';
    document.getElementById('dari').innerHTML = "Dari : Kominfo";
    document.getElementById('tgl').innerHTML = "Berlaku s.d 31/08/2017";

    document.getElementById("dari").style.textShadow = "none";
    document.getElementById("tgl").style.textShadow = "none";
