...
function tambahRow() {
    ...
    cell2.innerHTML = "<td class='center'><select id='akun" + idrow + "' name='akun" + idrow + "' disabled='true' style='width: 500px;' onchange='setNamaAkun(this.id)' ><option></option></select> </td>";
...
function getrincilist() {
    ...
    function(result) {
        var i, c;
        console.log("kodeTransaksi = "+$("#kodeTransaksi").val());
...
function setAkunComboEdit(id, idbaris, ketidbas) {
    var tahun = $('#tahun').val();
    var idskpd = $('#idskpd').val();
    var ket;
...
function setNamaAkunEdit(textid, ketidbas) {
    ...
    //onsole.log("setNamaAkunEdit, ketidbas = "+ketidbas);
