...
function tambahRow() {
    ...
    cell2.innerHTML = "<td class='center'><select id='akun" + idrow + "' name='akun" + idrow + "' disabled='true'  style='width: 900px;' onchange='setNamaAkun(this.id)' ><option></option></select> </td>";
...
function setAkunCombo(id) {
    ...
    $.getJSON(getbasepath() + "/bku/json/getAkunCombo", {tahun: tahun, idskpd: idskpd, idkegiatan: id, keterangan: ket},
    function(result) {
        var banyak, kode, ket;
        var opt = "";
