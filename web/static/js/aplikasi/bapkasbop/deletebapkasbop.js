...
function setBulanEdit(tahun,idskpd) {
    ...
    $.getJSON(getbasepath() + "/bapkasbop/json/setBulanEdit", {tahun: tahun,idskpd: idskpd},
    function(result) {
        //console.log(result);
    ...
    if (typeof myTable == 'undefined') {
        myTable = $('#bapkasrincitable').dataTable({
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) { //format untuk tampilan body tabel
                ...
                var pilih = "<a class='icon-edit' href='" + getbasepath() + "/bapkasbop/updatebapkas/" + aData['idBapKas'] + "'  ></a> - <a class='icon-remove' href='#' onclick='hapusrinci(" + index + ")' ></a>";
...
function getbanyakrincibapkas( ) {
    $.getJSON(getbasepath() + "/bapkasbop/json/getbanyakrincibapkas", {idSkpdBAPKas: $("#idSkpdBAPKas").val()},
    function (result) {
