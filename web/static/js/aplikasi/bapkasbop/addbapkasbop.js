...
function setTw() {
    ...
    $.getJSON(getbasepath() + "/bapkasbop/json/setTriwulan", {tahun: tahun, idsekolah: idsekolah},
    function(result) {
...
function getNilaiKas() {
    ...
    $.getJSON(getbasepath() + "/bapkasbop/json/getNilaiKas", {tahun: tahun, idsekolah: idsekolah, triwulan: triwulan},
    function(result) {
