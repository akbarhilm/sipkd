    ...
    if (typeof myTable == 'undefined') {
        myTable = $('#kontrakpopup').dataTable({
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                var idKegiatan = "<input type='hidden' id='idkegiatan" + aData['kontrak']['idKontrak'] + "' value='" + aData['idkegiatan'] + "' />";
                //var idAkun = "<input type='hidden' id='idAkun" + aData['kontrak']['idKontrak'] + "' value='" + aData['akun']['idAkun'] + "' />";
