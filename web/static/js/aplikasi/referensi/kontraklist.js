    ...
    if (typeof myTable == 'undefined') {
        myTable = $('#fungsitable').dataTable({
            ...
            "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                {
                    pilih = "<a class='icon-edit' href='" + getbasepath() + "/kontrak/updatekontrak/" + aData['idKontrak'] + "'  ></a> - <a class='icon-remove' href='" + getbasepath() + "/kontrak/delkontrak/" + aData['idKontrak'] + "' ></a>";
                }
