        ...
        myTable = $('#basttable').dataTable({
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                if (parseInt(aData['idspp']) == 0 ) {
                    ...
                    pilih = "<a class='icon-edit' href='" + getbasepath() + "/bast/updatebast/" + aData['idBast'] + "'  ></a> - <a class='icon-remove' href='" + getbasepath() + "/bast/deletebast/" + aData['idBast'] + "' ></a>";
                }
                ...
                $('td:eq(6)', nRow).html(accounting.formatNumber(aData['nilaiPrestasi']));
            ...
            "aoColumns": [
                ...
                {"mDataProp": "nilaiPrestasi", "bSortable": false, sClass: "kanan", "sWidth": "1%"},
