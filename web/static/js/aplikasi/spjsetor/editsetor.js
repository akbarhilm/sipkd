...
function getdatakegiatan(){
    $.getJSON(getbasepath() + "/setor/json/getdatakegiatan", {idskpd: $("#idskpd").val(), tahunAnggaran: $("#tahun").val(), idSetor: $("#idSetor").val()},
    function(result) {
        $('#kegiatan').val(result.aData[0]['kodeKegiatan']);
...
function getbanyaksetoredit() {
    $.getJSON(getbasepath() + "/setor/json/getlistsetoreditbanyak", {idskpd: $("#idskpd").val(), idkegiatan: $("#idkegiatan").val(), tahunAnggaran: $("#tahun").val(), idSetor: $("#idSetor").val()},
    function(result) {
...
function gridedit() {
    ...
    //bootbox.alert("CEK KEGIATAN GRID = "+ $('#kegiatan').val());
...
function getdata(){
    $.getJSON(getbasepath() + "/setor/json/getdata/" + $('#kegiatan').val() + ".0",
    function (result) {
        if($('#kegiatan').val() !== ''){
            $('#namakegiatan').val(result.aData[0]['namaKeg']);
            $('#idkegiatan').val(result.aData[0]['idKegiatan']).change();
            ...
            //bootbox.confirm("Anda akan membatalkan cetak data SPD dengan nomor " );
