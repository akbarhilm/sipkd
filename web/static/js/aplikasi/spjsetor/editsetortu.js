...
function getbanyaksetoredit() {
    ...
    $.getJSON(getbasepath() + "/setor/json/getbanyaklisttu", {idskpd: $("#idskpd").val(), idkegiatan: $("#idKegiatan").val(), tahun: $("#tahunAngg").val(), idspd: $("#idSpd").val(), idsetor: $("#idSetor").val()},
    function(result) {
...
function gridedit() {
    ...
    var urljson = getbasepath() + "/setor/json/getrincitu";
