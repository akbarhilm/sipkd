...
function getbanyaksetorrinci() {
    $.getJSON(getbasepath() + "/setor/json/getlistsetorrincibanyakbantuan", {idSetor: $("#idSetor").val(), idkegiatan: $("#idkegiatan").val(), tahunAnggaran: $("#tahun").val(), idspj: $("#idspj").val()},
    function(result) {
...
function gridsetor() {
    ...
    bootbox.alert("ID KEGIATAN = "+ $('#idkegiatan').val());
