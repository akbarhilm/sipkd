...
function prosesSetujui() {
    ...
    var varurl = getbasepath() + "/bapkasbos/json/prosesupdate";
    var dataac = [];
...
function setTriwulan() {
    ...
    $.getJSON(getbasepath() + "/bapkasbos/json/getTriwulan", {tahun: tahun,
        idsekolah: idsekolah},
    function(result) {
...
function setData() {
    ...
    if (triwulan != '-') {
        $.getJSON(getbasepath() + "/bapkasbos/json/getbapkas", {tahun: tahun,
