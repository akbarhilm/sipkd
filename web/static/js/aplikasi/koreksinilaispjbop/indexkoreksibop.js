...
function cekSekolah() {
    ...
    if ($('#idsekolah').val() == "") {
        ...
        a.href = getbasepath() + "/koreksinilaispjbop/addkoreksi/" + $('#idsekolah').val();
    }
}
...
function getMaxTriwulan() {
    ...
    $.getJSON(getbasepath() + "/koreksinilaispjbop/json/getMaxTriwulan", {tahun: tahun, idsekolah: idsekolah},
    function(result) {
...
function grid() {
    var urljson = getbasepath() + "/koreksinilaispjbop/json/listindex";
    ...
    if (typeof myTable == 'undefined') {
        myTable = $('#bkutable').dataTable({
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {///cetakspp
                ...
                var edit = "<a href='" + getbasepath() + "/koreksinilaispjbop/editkoreksi/" + "?idbku=" + aData['idBku'] + "' class='icon-edit' ></a> - <a href='" + getbasepath() + "/koreksinilaispjbop/deletekoreksi/" + "?idbku=" + aData['idBku'] + "' class='icon-remove' ></a> ";
                var arsip = "<a href='" + getbasepath() + "/koreksinilaispjbop/arsipkoreksi/" + "?idbku=" + aData['idBku'] + "&idsekolah=" + "' class='icon-file-text' ></a>";
