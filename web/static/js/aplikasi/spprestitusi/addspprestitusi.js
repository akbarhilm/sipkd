    ...
    if (typeof myTable == 'undefined') {
        myTable = $('#restitusirinci').dataTable({
            ...
            "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                var nilaiSppSaatini = "<input type='text' name='nilaiSppSaatini" + index + "' id='nilaiSppSaatini" + index + "'  class='inputmoney'   readonly='true'  onkeyup='pasangvalidatebesarperfield(" + index + ");hitungnilaispp()'  value='" + aData['nilaiSppSaatini'] + "' />";
