...
function gridsppbtl() {
    var urljson = getbasepath() + "/restitusi/json/getlistspprestitusi";
    if (typeof myTable == 'undefined') {
        myTable = $('#btlspdtable').dataTable({
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                var edit = "<a href='" + getbasepath() + "/restitusi/editspprestitusi/" + aData['id'] + "' class='icon-edit' ></a> - <a href='" + getbasepath() + "/restitusi/deletespprestitusi/" + aData['id'] + "' class='icon-remove' ></a>";
...
function pindahhalamanadd() {
    ...
    if (idskpd) {
        window.location.replace(getbasepath() + "/restitusi/addspprestitusi/" + idskpd);
    } else {
        window.location.replace(getbasepath() + "/restitusi/addspprestitusi");
    }
