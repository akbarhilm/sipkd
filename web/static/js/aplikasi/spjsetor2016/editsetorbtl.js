$(document).ready(function() {
    ...
    //bootbox.alert("idSetor = "+ $('#idSetor').val());
    gridsetor();
...
function getbanyaksetorrinci() {
    $.getJSON(getbasepath() + "/setor/json/getlistsetorrincibanyakbtl", {idskpd: $("#idskpd").val(),idSetor: $("#idSetor").val(), tahunAnggaran: $("#tahun").val(), idspj: $("#idspj").val()},
    function(result) {
