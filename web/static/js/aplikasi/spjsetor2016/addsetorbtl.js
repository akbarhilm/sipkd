...
function getbanyaksetorrinci() {
    $.getJSON(getbasepath() + "/setor/json/getlistaddsetorrincibanyakbtl", {idskpd: $("#idskpd").val(),idSetor: $("#idSetor").val(), tahunAnggaran: $("#tahun").val()},
    function(result) {
...
function gridsetor() {
    var urljson = getbasepath() + "/setor/json/getforaddsetorrincibtl";
