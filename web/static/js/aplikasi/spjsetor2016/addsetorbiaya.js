...
function getbanyaksetorrinci() {
    $.getJSON(getbasepath() + "/setor/json/getlistaddsetorrincibanyakbiaya", {idSetor: $("#idSetor").val(), tahunAnggaran: $("#tahun").val(), idspj: $("#idspj").val()},
    function(result) {
...
function gridsetor() {
    var urljson = getbasepath() + "/setor/json/getforaddsetorrincibiaya";
