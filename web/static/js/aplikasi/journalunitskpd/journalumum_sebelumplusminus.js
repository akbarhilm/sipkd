...
function tambahRow() {
    ...
    cell4.innerHTML = "<td> <input type='text' name='debet" + idrow + "' id='debet" + idrow + "' class='inputmoney'  onkeyup='getTotal(),validasiDebet(" + idrow + ")' onclick = 'validasiDebet(" + idrow + ")' /> </td>";
    cell5.innerHTML = "<td> <input type='text' name='kredit" + idrow + "' id='kredit" + idrow + "' class='inputmoney'  onkeyup='getTotal(),validasiKredit(" + idrow + ")' onclick = 'validasiKredit(" + idrow + ")' /> </td>";
    ...
    cell6.innerHTML = "<td class ='center'><select id='jenis" + idrow + "' name='jenis" + idrow + "' onchange='setkriteria(this.value," + idrow + ")' > </select> </td>";
    cell7.innerHTML = "<td class ='center'><select id='beban" + idrow + "' name='beban" + idrow + "' ><option></option></select> </td>";
    cell8.innerHTML = "<td class ='center'><input type='text' id='kegiatan" + idrow + "' name='kegiatan" + idrow + "' readonly='true' size='15' > <input type='hidden' id='idkegiatan" + idrow + "' name='idkegiatan" + idrow + "' > <a id='pilihkegiatan" + idrow + "' class='fancybox fancybox.iframe FontSmall' onclick='getbutton(" + idrow + "), ambilakun(" + idrow + ")' href='" + getbasepath() + "/kegiatan/listkegiatan?target='_top'' title='Pilih Kode Akun'  > <i class='icon-zoom-in'></i> Pilih</a> </td>";
    cell9.innerHTML = "<td class ='center'><textarea  id='namakegiatan" + idrow + "' name='namakegiatan" + idrow + "' class='m-wrap large valid' readonly='true' style='margin: 0px; width: 200px; height: 42px;'> </textarea> </td>";
