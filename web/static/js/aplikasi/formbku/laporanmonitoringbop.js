...
function cetak() {
    ...
    /*
     ...
     window.location.href = getbasepath() + "/formbku/json/prosescetakmon?tahun="
...
function setPanelAkun() {
    ...
    if ($('#jenislap').val() == '1') { //Rincian Pengajuan Pembayaran Anggaran BOP
        $('#labeltriwulan').hide();
        $('#labeltanggal').show();
        $('#bulan1').hide();
        ...
        $('#idsekolah').val('');
        $('#sekolah').val('');
    } else if ($('#jenislap').val() == '6') { //Report_MonitoringTransfer-BOP
        $('#labeltriwulan').show();
        $('#labeltanggal').show();
        $('#bulan1').hide();
        $('#labelakunbelanja').hide();
        ...
        $('#idsekolah').val('');
        $('#sekolah').val('');
    } else if ($('#jenislap').val() == '10') { //ditambahkan report jenis baru pada 190104 -- report RealisasiKegiatan_SKPD-BOP
        $('#labeltriwulan').show();
        $('#labeltanggal').hide();
        $('#bulan1').hide();
        $('#labelakunbelanja').hide();
...
function grid() {
    var urljson = getbasepath() + "/formbku/json/listcetaksetor";
