...
function gridbku() {
    ...
    if (typeof myTable == 'undefined') {
        myTable = $('#bkustable').dataTable({
            ...
            "bFilter": false,
            "sAjaxSource": getbasepath() + "/pajaktf/json/listbkubos",
            "aaSorting": [[1, "asc"]],
...
function getSaldoKas() {
    ...
    $.getJSON(getbasepath() + "/pajaktf/json/getSaldoKasBos", {tahun: tahun, idsekolah: idsekolah, triwulan: triwulan},
    function(result) {
...
function simpanCreate(npwprekanan, namawp, alamatwp, kotawp, npwppenyetor, namapenyetor, norek, masapajak, uraian) {
    ...
    var datajour = {
        ...
        kodeapp: "002" // 002 untuk SIAP-BOS
    };
    dataac = datajour;
    return   $.ajax({
        type: "POST",
...
function simpanRinciPotPajak(bulkidreq, idrequest, kodebilling, tglbillexp) {
    ...
    var varurl = getbasepath() + "/pajaktf/json/simpanpotrincibos";
    var dataac = [];
    var datajour = {
        tahun: $('#tahun').val(),
        idbku: $('#idBku').val(),
...
function updateRinciPotPajak(kodereq, bulkidreq, idrequest, kodebilling, tglbillexp, tglbuku, statusbpn, tglbayar, ntb, ntpn, masapajak, kodestan) {
    ...
    var varurl = getbasepath() + "/pajaktf/json/updatepotrincibos";
    var dataac = [];
    var datajour = {
        tahun: $('#tahun').val(),
        idbku: $('#idBku').val(),
...
function updateStatusTransferBku() {
    ...
    var varurl = getbasepath() + "/pajaktf/json/updateBkuByIdBos";
    var dataac = [];
    var datajour = {
        tahun: $('#tahun').val(),
        tglposting: tanggal,
