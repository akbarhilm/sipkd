function getlistspdbtlrev(id) {

    $.getJSON(getbasepath() + "/common/json/getpagudansisarev/" + id,
            function(result) {
                console.log(result)
    ...
    gridspdbtlmasterlistrev(getbasepath());

}
function gridspdbtlmasterlistrev(baseurl) {
...
//alert("2143");
    var urljson = baseurl + "/spd/pengajuanrev/btl/json/getlistspdrev";
        ...
        myTable = $('#btlspdtable').dataTable({
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
               ...
               // $('td:eq(3)', nRow).html(accounting.formatNumber(aData['nilaiSpd']));
                var urledit = baseurl + "/spd/pengajuanrev/btl/editrev";
                var urldel = "#"
                //alert(urledit);
