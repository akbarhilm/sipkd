...
function setHeader(xhr) {
    xhr.setRequestHeader('Authorization', 'Basic ' + window.btoa('sipkddev:sipkddev'));
...
function setTriwulan() {
    ...
    function(result) {
        ...
        var opt = "";
        if (result == 1) {
            opt = '<option value="1" selected="true">Triwulan I</option>';
        } else if (result == 2) {
            opt = '<option value="2" selected="true">Triwulan II</option>';
        } else if (result == 3) {
            opt = '<option value="3" selected="true">Triwulan III</option>';
        } else if (result == 4) {
            opt = '<option value="4" selected="true">Triwulan IV</option>';
        } else {
...
function getCountSaldoAwal(callback) {
    var tahun = $('#tahun').val();
    var idsekolah = $('#idsekolah').val();
    $.getJSON(getbasepath() + "/bkubos/json/getCountSaldoAwal", {tahun: tahun, idsekolah: idsekolah},
    function(result) {
        if (result != 0 || $("#triwulan").val() != '1') {
            callback(true);
        } else {
            callback(false);
        }
...
function clickCheckbox() {
    getCountSaldoAwal(function(value) {
        if (value) {
            $('#cbSaldoAwal').prop('checked', false);
            $('#kodeSaldoAwal').val(0);
            bootbox.alert("Saldo awal hanya bisa diinput pada triwulan 1 atau belum pernah diinput sebelumnya.");
        } else {
            setSaldoAwal();
        }
    });
...
//    $.getJSON(getbasepath() + "/bkubos/json/getStatusSpj", {tahun: tahun, idsekolah: idsekolah, triwulan: triwulan},
//    function(result) {

    var opt = "";
//        if (result > 0) { // SPJ Tidak Bisa Input
...
function setSaldoAwal() {
    if (document.getElementById("cbSaldoAwal").checked == true) {
        $('#kodeSaldoAwal').val(1);
    } else {
        $('#kodeSaldoAwal').val(0);
    }
...
function getWpPjPg() {
    var idbku = $('#idbku').val();
    $.getJSON(getbasepath() + "/bkubos/json/getWpPjPg", {idbku: idbku},
    function(result) {
        if (result != null) {
            var npwp = result;
            $('#npwp').val(npwp);
...
function setPanel() {
    ...
    document.getElementById("labelcbsaldo").style.display = "none";
    ...
    if (jenistransaksi == "JO") {
        ...
        document.getElementById("labelcbsaldo").style.display = "block";
        $('#tglDokJo').val("");
        ...
        document.getElementById('textnamarekan').innerHTML = 'Nama Rekanan :';
        ...
        document.getElementById('textnpwp').innerHTML = 'NPWP Rekanan :';
        document.getElementById('textnamanpwp').innerHTML = 'Nama NPWP Rekanan :';
        document.getElementById('textalamatnpwp').innerHTML = 'Alamat NPWP Rekanan :';
        document.getElementById('textkotanpwp').innerHTML = 'Kota NPWP Rekanan :';
        clearrow();
...
//            $('#rumuspajakp1').val("-");
        ...
        a.href = getbasepath() + "/bkubos/listpjpn?target='_top'";
        $('#uraian').val("Diterima Pajak " + ketpajak + " atas SPJ ");
        getDataWP();
        ...
        document.getElementById("labelrumuspajakp4").style.display = "none";
        document.getElementById("labelrumuspajakp5").style.display = "none";
        a.href = getbasepath() + "/bkubos/listpjpg?target='_top'";
        $('#uraian').val("Disetor Pajak " + ketpajak + " atas Penerimaan Pajak ");
    } else {
        document.getElementById("labelrumuspajakp1").style.display = "none";
        document.getElementById("labelrumuspajakp2").style.display = "none";
...
function validateP2P3() {
    ...
    var idsekolah = $('#idsekolah').val();
    console.log(idbku + " idbku");
    $.getJSON(getbasepath() + "/bkubos/json/validateP2P3", {idbku: idbku, idsekolah: idsekolah},
    function(result) {
        var p2 = result['P2'];
        var p3 = result['P3'];
        $('#p2').val(p2);
...
// set button pilih kegiatan jika TW = "-"
        if (tw == "-") {
            ...
            a.href = getbasepath() + "/common/listkegiatanbos?target='_top'";
        }
...
function getSaldoAwal() {
    ...
    function(result) {
        ...
        //console.debug("Saldo Awal " + saldoawal);
...
function simpan() {
    ...
    if (jenistransaksi == "JJ") {
        ...
        var saldoawal = accounting.unformat($("#saldoawal").val(), ","); // saldoawal (JO - JJ - ST tahun + (tahun - 1))
        ...
        if ((jum3 > 0) && ($("#akunnama1").val() !== "")) {
            ...
            if ((sk == "1" && kodesk == "") || nrk == "" || nobukti == "" || tglDok == "" || filling == "" || idKegiatanSpj == "" || nippptk == "" || namapptk == "" || namarekan == "" || bank == "" || norek == "" || banyak == 0 || (npwp != "" && namanpwp == "")) {
                ...
                bootbox.alert("Tahun Dokumen Harus Sesuai Tahun yang Login");
                $('#btnSimpan').attr("disabled", false);
            } else if (nilaitotalspj > sisakas && (sisakas < saldoawal)) {
                bootbox.alert("Total SPJ Tidak Boleh Lebih Besar dari Sisa Pagu AKB Kegiatan");
                $('#btnSimpan').attr("disabled", false);
            } else if (nilaitotalspj > saldoawal && (saldoawal <= sisakas)) {
                bootbox.alert("Total SPJ Tidak Boleh Lebih Besar dari Saldo Kas");
                $('#btnSimpan').attr("disabled", false);
        ...
        if (nrk == "" || nobukti == "" || tglDok == "" || filling == "" || idKegiatanPj == "" || nippptk == "" || namapptk == "" || namarekan == "" || ($("#jenisPembayaran").val() == "PN" && npwp == "") || (npwp != "" && namanpwp == "") || $('#tahunpajak').val() == "") {
            bootbox.alert("Pengisian Data Harus Lengkap");
            $('#btnSimpan').attr("disabled", false);
        } else if (TW == "-") {
            bootbox.alert("Pilih Triwulan Terlebih Dulu");
...
function simpanJO() {
    ...
    var idbas, kodeakun, bkututup, bkustatus, tgldok, kodesaldo = "-";
    if (kodetrx == "JO") {
        tgldok = $("#tglDokJo").val();
    } else {
        tgldok = $("#tglDok").val();
    ...
    if (kodetrx == "JO") {
        ...
        nilaikeluar = "0";
        idbas = "12792";
        kodeakun = "1.1.01.03.05.002.02";
        bkututup = "1";
        bkustatus = "3";
        kodesaldo = $("#kodeSaldoAwal").val();
    } else if (kodetrx == "JG") {
        idbas = "12781";
    ...
    var varurl = getbasepath() + "/bkubos/json/prosessimpanjo";
    var dataac = [];
    var datajour = {
        tahun: $("#tahun").val(),
...
function simpanC12() {
    ...
    bkututup = "0";
    bkustatus = "1";
    var varurl = getbasepath() + "/bkubos/json/prosessimpanc12";
    var dataac = [];
    var datajour = {
        tahun: $("#tahun").val(),
        idsekolah: $("#idsekolah").val(),
...
function simpanPajak() {
    ...
    if (jumlah > 0) {
        ...
        var varurl = getbasepath() + "/bkubos/json/prosessimpanpajak";
        var dataac = [];
        var nilailist = [];
        var i;
        var banyak = 0;
...
function simpanSPJ() {
    ...
    if (jumbarisspj > 0) {
        ...
        var varurl = getbasepath() + "/bkubos/json/prosessimpanspj";
        var dataac = [];
        var nilailist = [];
        var i;
        var banyak = 0;
...
function gridspj() {
    ...
    if (typeof myTable == 'undefined') {
        myTable = $('#spjtable').dataTable({
            ...
            "bFilter": false,
            "sAjaxSource": getbasepath() + "/bkubos/json/listspj",
            "aaSorting": [[1, "asc"]],
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                var akun = "<textarea id='akun" + index + "'readonly style='border:none;margin:0;width:180px;'>" + aData['kodeakun'] + "/" + aData['namaakun'] + "</textarea>";
                var komponen = "<textarea id='komponen" + index + "'readonly style='border:none;margin:0;width:190px;'>" + aData['namaKomponen'] + "</textarea>"; // aData['kodeKomponen'] + "/" +
            ...
            "aoColumns": [
                ...
                {"mDataProp": "volume", "bSortable": false, sClass: "center", "sWidth": "5%"},
...
function hitungP1(index) {
    ...
    var pengali;
    console.log("kode pegawai " + kodepegawai);
...
function getPkBlj() {
    var tahun = $('#tahun').val();
    var idsekolah = $('#idsekolah').val();
    $.getJSON(getbasepath() + "/bkubos/json/getPkBlj", {tahun: tahun, idsekolah: idsekolah},
    function(result) {
...
function setJgSt() {
    ...
    if (kodetrans == "ST") {
        a.href = getbasepath() + "/bkubos/listsetoran?target='_top'";
    } else if (kodetrans == "JG") {
        a.href = getbasepath() + "/bkubos/listjgpn?target='_top'";
    }
