...
function update() {
    ...
    var varurl = getbasepath() + "/bkubos/json/prosesupdatec12";
    var dataac = [];
...
function getNilai() {
    ...
    $.getJSON(getbasepath() + "/bkubos/json/getNilaiC12", {idbku: idbku, tahun: tahun, trx: $("#kodeTransaksi").val()},
    function(result) {
        var nilai = result.aData;
        console.log("INI NILAI " + nilai);
