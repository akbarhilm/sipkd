...
<ul class="breadcrumb">
    <li>
        <i class="icon-home"></i>
        <a href="${pageContext.request.contextPath}/beranda">Cetak SPM</a> 
...
<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Cetak  SPM</div>
        <div class="actions">            
        </div>
    </div>
        ...
        <form class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    <input type="hidden" id="beban" name="beban" value="${kodeBeban}"  />
                    <input type="hidden" id="jenis" name="jenis" value="${kodeJenis}"  />
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/cetak/spm/cetakspm.js"></script>  
