                ...
                <label class="col-md-3 control-label">No Jurnal :</label>
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <a id="nojourpilih"  class="fancybox fancybox.iframe btn dark" href="${pageContext.request.contextPath}/journal/listjournal?target='_top'" title="Pilih No Jurnal"  ><i class="icon-zoom-in"></i> Pilih</a>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/journal/journalumumrevisi.js"></script>    
