...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spjsetor/listsbbtl.js"></script>    
...
<script type="text/javascript">
    ...
    function ambilskpd(id) {
        $('#ketbku', window.parent.document).val($("#ket" + id).val()).change();
    ...
    <div class="portlet-body">
        ...
        <div class="form-horizontal" >
            ...
            <div class="form-group">
                <label class="col-md-4 control-label">No Bukti BKU : </label>
                <div class="col-md-6">
                    <div class="input-group">
