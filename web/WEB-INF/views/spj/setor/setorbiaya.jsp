...
<ul class="breadcrumb">
 ...
 <div class="portlet box red">
    <div class="portlet-title">
        ...
        <div class="actions">
            <a href="${pageContext.request.contextPath}/setor/addsetorbiaya"  class="btn dark"  ><i class="icon-plus"></i> Tambah</a> 
        </div>
    </div>
...
<div class="portlet box">
       ...
       <script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spjsetor/setorbiaya.js"></script>  