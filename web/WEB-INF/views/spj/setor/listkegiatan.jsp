...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spjsetor/listkegiatan.js"></script>    

<script type="text/javascript">
    $(document).ready(function() {
        ketjenis = window.localStorage.getItem("ketJenis");
        ketidsetor = window.localStorage.getItem("ketIdSetor");
        tampil();
    });
    ...
    function ambilskpd(id) {
        ...
        $('#noBku', window.parent.document).val($("#nobku" + id).val()).change();
