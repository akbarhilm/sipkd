    ...
    <div class="portlet box red">
        ...
        <div class="portlet-body flip-scroll">
           ...
           <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="kegiatan" name="kegiatan" type="text" size="15" maxlength="14" placeholder="x.xx.xx.xxx"> 
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group">                        
                       ...
                       <input type="text"  name="idkegiatan"  id="idkegiatan" readonly="true" onchange='gridsetor()'>
                    </div>
                </div>
            </div>
            <div class="form-group">
