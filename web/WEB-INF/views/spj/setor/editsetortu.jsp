...
<script type="text/javascript">
    ...
    function ambilketerangan() {
        window.localStorage.setItem("keteranganKeg", "SETORAN");
        window.localStorage.setItem("ketBeban", "TU");
    }
...
<form:form  method="post" commandName="refsetor"  id="refsetor"   action="${pageContext.request.contextPath}/setor/simpansetor2tu" class="form-horizontal">
        ...
        <div class="portlet-body flip-scroll">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:select path="beban" >
                            <form:option value="TU">Tambah Uang</form:option>
                        </form:select>
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <div class="col-md-9">
                    ...
                    <form:hidden path="idKegiatan" id='idKegiatan' onchange="gridedit()"   />
                    <form:input path="namakegiatan" id="namakegiatan" type="text" size="70"  readonly="true" cssClass="required cekKegiatan" /> &nbsp;<a  class="fancybox fancybox.iframe btn green" id="pilihKegSpj" onclick="ambilketerangan()" href="${pageContext.request.contextPath}/bku/listkegiatansetoranTU?target='_top'" title="Pilih Kegiatan"  ><i class="icon-zoom-in"></i> Pilih</a> 
            ...
            <div class="form-actions fluid">
                <div class="col-md-offset-3 col-md-9">
                    ...
                    <a class="btn blue"  href="${pageContext.request.contextPath}/setor/indextu" >Kembali</a>
                </div>
            </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spjsetor/editsetortu.js"></script>    
