...
<form:form  method="post" commandName="refsetor"  id="refsetor"   action="${pageContext.request.contextPath}/setor/simpansetor2bantuan" class="form-horizontal">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-actions fluid">
                <div class="col-md-offset-3 col-md-9">
                    ...
                    <a class="btn blue"  href="${pageContext.request.contextPath}/setor/indexbantuan" >Kembali</a>
                </div>
            </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spjsetor/editsetorbantuan.js"></script>    
