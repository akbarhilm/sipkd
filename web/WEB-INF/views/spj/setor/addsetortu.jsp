...
<form:form  method="post" commandName="refsetor"  id="refsetor"   action="${pageContext.request.contextPath}/setor/simpansetortu" class="form-horizontal">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    ...
                    <form:hidden path="idKegiatan" id='idKegiatan' onchange="gridsetor()"   />
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spjsetor/addsetortu.js"></script>    
