...
<ul class="breadcrumb">
    ...
    <li><a href="#">Proses Journal SPJ</a></li>
</ul>
 
<div  ${pesan != null ?"class='alert alert-success'":""}   >${pesan}</div>
<form:form   method="post" commandName="refsppup"  id="refsppup"   action="${pageContext.request.contextPath}/spj/prosejournal" class="form-horizontal">
    <div onload="" class="portlet box red">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Proses Journal SPJ</div>       
        </div>
           ...
           <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:select  path="bulan" id="bulan" onchange="gridspj()">  
                            <form:options items="${listBulanJournal}"  itemValue="kodeBulan" itemLabel = "namaBulan"  />
                        </form:select >
            ...
            <div class="form-actions fluid">
                <div class="col-md-offset-3 col-md-9">
                    <!-- -->
                    <button id="buttoninduk" type="submit" class="btn blue" > Proses Journal </button>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spj/indexjournalspj.js"></script>  