        ...
        <form:form  method="post" commandName="refspj"  id="refspj"   action="${pageContext.request.contextPath}/spj/prosessimpan" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    ...
                    <form:input type="text"  path="kegiatan.namaKegiatan" name="namaKegiatan"  id="namaKegiatan"  class="m-wrap large" size="80" readOnly="true"/>  &nbsp;<a  class="fancybox fancybox.iframe btn green" href="${pageContext.request.contextPath}/spj/pilihkegiatan/${refspj.idSpj}?target='_top'" title="Pilih Kegiatan"  ><i class="icon-zoom-in"></i> Pilih</a> 
