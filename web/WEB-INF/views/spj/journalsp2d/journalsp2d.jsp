...
<script>
    $(document).ready(function() {
        $('#wilayah').val($('#kodeproses').val());
        setTanggal($('#kodeproses').val());
        //gridsp2d();
...
<form:form   method="post" commandName="refsppup"  id="refsppup"   action="${pageContext.request.contextPath}/journalsp2d/prosejournal" class="form-horizontal">
        ...
        <div class="portlet-body flip-scroll">
            <div class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    <form:hidden path="pengguna.kodeProses" id='kodeproses' value="${pengguna.kodeProses}"  />
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:select  path="tglsah" id="tglsah" onchange="gridsp2d();getKodeProsesJour()" >  
                            <form:options  />
                        </form:select >
            ...
            <div id="labelproses" class="form-group">
                <label class="col-md-7 control-label ">JURNAL PROCESSING...</label> 
            </div>        
    ...
    <div class="form-actions fluid">
        <div class="col-md-offset-3 col-md-9" align="Right">
            ...
            <button type="button" id="btnproses" class="btn blue" onclick='cekJourSp2d()' href="#" > Proses Jurnal </button>
