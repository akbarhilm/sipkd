...
<ul class="breadcrumb">
 ...
 <div class="portlet box red">
    <div class="portlet-title">
        ...
        <div class="actions">
            <a id="btnTambah" href="${pageContext.request.contextPath}/setor_old/addsetorupgu"  class="btn dark"><i class="icon-plus"></i> Tambah</a> 
        </div>
    </div>
...
<div class="portlet box">
       ...
       <script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spjsetor2016/setorupgu.js"></script>  