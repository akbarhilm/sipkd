...
<form:form  method="post" commandName="refsetor"  id="refsetor"   action="${pageContext.request.contextPath}/setor_old/simpansetor2bantuan" class="form-horizontal">
    <div class="portlet box red">
        ...
        <div class="portlet-body flip-scroll">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:select path="jenis" disabled="true">
                            ...
                            <option value="2">Biaya Tidak Langsung Bantuan</option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="kegiatan" name="kegiatan" type="text" size="15" maxlength="14" readonly="true" placeholder="x.xx.xx.xxx"> 
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group">   
                        ...
                        <input type="text"  name="namakegiatan"  id="namakegiatan" size="100" readonly="true">
                    </div>
                </div>
            </div>
            ...
            <div class="form-actions fluid">
                <div class="col-md-offset-3 col-md-9">
                    ...
                    <a class="btn blue"  href="${pageContext.request.contextPath}/setor_old/indexbantuan" >Kembali</a>
                </div>
            </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spjsetor2016/editsetorbantuan.js"></script>    
