...
<ul class="breadcrumb">
    ...
    <li><a href="#">Setor Biaya Tidak Langsung Bantuan</a></li>
</ul>
 ...
 <div class="portlet box red">
    <div class="portlet-title">
        ...
        <div class="actions">
            <a href="${pageContext.request.contextPath}/setor_old/addsetorbantuan"  class="btn dark"><i class="icon-plus"></i> Tambah</a> 
        </div>
    </div>
...
<div class="portlet box">
       ...
       <script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spjsetor2016/setorbantuan.js"></script>  