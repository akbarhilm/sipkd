...
<form:form  method="post" commandName="refsetor"  id="refsetor"   action="${pageContext.request.contextPath}/setor_old/simpansetor2upgu" class="form-horizontal">
    <div class="portlet box red">
        ...
        <div class="portlet-body flip-scroll">
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <form:hidden path="idSetor" id='id'    />   
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <input name="textbeban" id="textbeban" type="text" size="7" readonly="true"/>
            ...
            <div id="labelkegiatan" class="form-group">
                ...
                <div class="col-md-9">
                    <form:input type="text" path="kegiatan" name="kegiatan" id="kegiatan" onchange="setNilaiTU()"  class="m-wrap large" size="80" readOnly="true"/>  &nbsp;<a  class="fancybox fancybox.iframe btn green" id="pilihKeg" href="${pageContext.request.contextPath}/setor/listkegiatantu?target='_top'" title="Pilih Kegiatan"  ><i class="icon-zoom-in"></i> Pilih</a> 
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group">                        
                        <form:input path="nilaiSetor" type="text" id="nilaiSetor"  class="m-wrap large" size="20" readonly="false"/>
                    </div>
                </div>
            </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spjsetor2016/editsetorupgu.js"></script>    
