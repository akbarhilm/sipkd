...
<form:form  method="post" commandName="refsetor"  id="refsetor"   action="${pageContext.request.contextPath}/setor_old/simpansetorupgu" class="form-horizontal">
    <div class="portlet box red">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div id="labelkegiatan" class="form-group">
                ...
                <div class="col-md-9">
                    <input type="text" name="kegiatan"  id="kegiatan" onchange="setNilaiTU()"  class="m-wrap large" size="80" readOnly="true"/>  &nbsp;<a  class="fancybox fancybox.iframe btn green" id="pilihKeg" href="${pageContext.request.contextPath}/setor_old/listkegiatantu?target='_top'" title="Pilih Kegiatan"  ><i class="icon-zoom-in"></i> Pilih</a> 
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <form:input path="tahunAngg" id="tahunAngg" type="text" size="6" maxlength="4" readonly='true' value="${tahunAnggaran}" /> 
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group">                        
                        <form:input path="nilaiSetor" type="text" id="nilaiSetor" class="m-wrap large" size="20" onkeyup="cekNilai(this.value)" readonly="false" />
                    </div>
                </div>
            </div>
            ...
            <div class="form-actions fluid">
                <div class="col-md-offset-3 col-md-9">
                    ...
                    <a class="btn blue"  href="${pageContext.request.contextPath}/setor_old/indexupgu" >Kembali</a>
                </div>
            </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spjsetor2016/addsetorupgu.js"></script>    
