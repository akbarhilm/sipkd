...
<form:form  method="post" commandName="refsetor"  id="refsetor"   action="${pageContext.request.contextPath}/setor_old/simpansetor" class="form-horizontal">
                ...
                <div class="col-md-5">
                    <div class="input-group">                        
                       ...
                       <form:input path="namakegiatan" id="namakegiatan" type="text" size="70"  readonly="true" cssClass="required cekKegiatan" /> 
                        <form:hidden path="keterangan" id='keterangan'  cssClass="required cekKegiatan"  />
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spjsetor2016/addsetor.js"></script>    
