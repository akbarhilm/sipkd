...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spjsetor2016/listkegiatantu.js"></script>    
...
<script type="text/javascript">
    ...
    function ambilskpd(id) {
        $('#kegiatan', window.parent.document).val($("#ket" + id).val()).change();
