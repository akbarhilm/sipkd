<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/journalunitskpd/jurnallistpopup.js"></script>    
...
<script type="text/javascript">
    ...
    function ambilskpd(id) {
        ...
        $('#ketupdate', window.parent.document).val($("#noJournal"+ id).val()).change();
...
<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Jurnal SKPD</div>
