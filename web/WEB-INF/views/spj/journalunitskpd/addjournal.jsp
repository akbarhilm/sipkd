...
<ul class="breadcrumb">
    ...
    <li><a href="#">Jurnal Umum SKPD </a></li>
</ul>
<div  ${pesan != null ?"class='alert alert-success'":""} >${pesan}</div>

<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Jurnal Umum SKPD</div>
        <div class="actions">
        </div>
    </div>
                ...
                <label class="col-md-3 control-label">Tahun :</label>
                    <div class="col-md-4">
                        <div class="input-group">
                            <input type="text" id="tahunAngg" size="5"  class="m-wrap medium inputnumber" readonly="true" value="${tahunAnggaran}"  />
                ...
                <label class="col-md-3 control-label">No Jurnal :</label>
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <a id="nojourpilih"  class="fancybox fancybox.iframe btn dark" href="${pageContext.request.contextPath}/journalunitskpd/listjournal?target='_top'" title="Pilih No Jurnal"  ><i class="icon-zoom-in"></i> Pilih</a>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/journalunitskpd/journalumum.js"></script>    
