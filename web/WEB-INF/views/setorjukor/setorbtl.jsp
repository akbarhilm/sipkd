...
<ul class="breadcrumb">
    ...
    <li><a href="#">Setoran Lewat Tahun</a></li>
</ul>
        
 <div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Setor Biaya Tidak Langsung</div>
        <div class="actions">
            <a href="${pageContext.request.contextPath}/setorjukor/addsetorbtl"  class="btn dark"  ><i class="icon-plus"></i> Tambah</a> 
        </div>
    </div>
...
<div class="portlet box">
       ...
       <script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/setorjukor/setorbtl.js"></script>  