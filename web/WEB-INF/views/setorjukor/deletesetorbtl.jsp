...
<form:form  method="post" commandName="refsetor"  id="refsetor"   action="${pageContext.request.contextPath}/setorjukor/deletesetorbtl" class="form-horizontal">
    <div class="portlet box red">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group">       
                        <form:textarea path="keterangan" readonly="true" id="keterangan" cols="50" rows="3" maxlength="150"/> 
                    </div>
                </div>
            </div>
