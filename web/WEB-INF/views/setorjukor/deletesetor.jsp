...
<ul class="breadcrumb">
    <li>
        <i class="icon-home"></i>
        <a href="${pageContext.request.contextPath}/beranda">Hapus Setoran Lewat Tahun</a> 
...
<form:form  method="post" commandName="refsetor"  id="refsetor"   action="${pageContext.request.contextPath}/setorjukor/deletesetorbl" class="form-horizontal">
    <div class="portlet box red">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input type="text" name="tglSetor" path="tglSetor" id="tglSetor" readonly="false" class="required  date-picker2 entrytanggal2 valid" size="14" disabled="true" value="" />
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:select path="jenis" disabled="true" readonly="true">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:select path="temuan" readonly="true">
            ...
            <div class="form-group" id="labelkeg2016" >
                ...
                <div class="col-md-4">
                    ...
                    <input type="hidden"  name="idkegiatan"  id="idkegiatan" readonly="true" >
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group">       
                        <form:textarea path="keterangan" id="keterangan" cols="50" rows="3" maxlength="150" readonly="true" /> 
                    </div>
                </div>
            </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/setorjukor/editsetor.js"></script>    
