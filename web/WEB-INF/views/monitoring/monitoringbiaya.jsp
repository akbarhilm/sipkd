<ul class="breadcrumb">
    ...
    <li><a href="#">Monitoring SP2D Belanja Biaya</a></li>
</ul>

<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Monitoring SP2D Belanja Biaya</div>
        <% /* <div class="actions">
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/monitoring/sp2dmonitoringbiaya.js"></script>   