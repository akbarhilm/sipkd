<ul class="breadcrumb">
    ...
    <li><a href="#">Monitoring SPJ Belanja Biaya</a></li>
</ul>

<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Monitoring SPJ Belanja Biaya</div>
        <% /* <div class="actions">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                      ...
                      <a class="fancybox fancybox.iframe icon-book" onclick='cetakmonbiaya()' href="#" ></a>
                    </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/monitoring/spjmonitoringbiaya.js"></script>   