<ul class="breadcrumb">
    ...
    <li><a href="#">Monitoring SPP Belanja Langsung</a></li>
</ul>

<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Monitoring SPP Belanja Langsung</div>
        <% /* <div class="actions">
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/monitoring/sppmonitoringbl.js"></script>   