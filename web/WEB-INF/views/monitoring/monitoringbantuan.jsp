<ul class="breadcrumb">
    ...
    <li><a href="#">Monitoring SPJ Belanja Bantuan</a></li>
</ul>

<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Monitoring SPJ Belanja Bantuan</div>
        <% /* <div class="actions">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                      ...
                      <a class="fancybox fancybox.iframe icon-book" onclick='cetakmonbantuan()' href="#" ></a>
                    </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/monitoring/spjmonitoringbantuan.js"></script>   