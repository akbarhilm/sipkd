<ul class="breadcrumb">
    ...
    <li><a href="#">Monitoring SPM Belanja Bantuan</a></li>
</ul>

<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Monitoring SPM Belanja Bantuan</div>
        <% /* <div class="actions">
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/monitoring/spmmonitoringbantuan.js"></script>   