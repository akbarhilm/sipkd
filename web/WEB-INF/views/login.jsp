                ...
                <div class="content">	
                    ...
                    <form:form id="formlogin" action="${pageContext.request.contextPath}/login" method="POST" class="form-vertical login-form"  modelAttribute="loginForm"  >
                        ...
                        <div class="form-group">
                            <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                            <div class="">
                                <input type="text"  name="captchaCode" id="captchaCode" cssClass="m-wrap placeholder-no-fix  required"  placeholder="Kode Verifikasi"  size="22"   autocomplete="off" cssStyle="width:100%;height:30px;"  />
