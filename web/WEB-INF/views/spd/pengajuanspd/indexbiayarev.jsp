...
<ul class="breadcrumb">
    ...
    <li>
        <a href="${pageContext.request.contextPath}/spd/pengajuanbiayarev/biaya/indexbiayarev">Pengajuan SPD</a>
        <span class="icon-angle-right"></span>
    </li>
    <li><a href="#">Pembiayaan APBDP</a></li>
</ul>
<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Form Biaya APBDP</div>
      <!--  <div class="actions">
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spd/spdbiayarev.js"></script>   