...
<!--[if !IE]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    ...
    <body  >
        <div id="Container" style="text-align: center; font:  10px arial, sans-serif;"  >
            <div id="Copyright" >
                <img src="${pageContext.request.contextPath}/spd/pengajuancetakrev/print/cetakbarcodepengesahanbynospd/${ispd}"> <br/>
