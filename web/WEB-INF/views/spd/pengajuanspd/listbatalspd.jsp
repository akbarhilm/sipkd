...
<form:form  method="post" commandName="refsetor"  id="refsetor"   action="${pageContext.request.contextPath}/spd/pembatalanspd/simpanbatal" class="form-horizontal">
        ...
        <div class="form-horizontal" >
            ...
            <div class="form-actions fluid">
                <div class="col-md-offset-3 col-md-9">
                    ...
                    <a class="btn blue"  href="${pageContext.request.contextPath}/spd/pembatalanspd/pembatalanspd" >Kembali</a>
                </div>
            </div>        
