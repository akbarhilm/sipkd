...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spd/spdbtlbantuanadddetail.js"></script>   
<ul class="breadcrumb">
    <li>
        <i class="icon-home"></i>
    ...
    <li><a href="#">Belanja Tidak Langsung Bantuan <span id='statusaddedit'></span></a></li>
</ul>
<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Form SPD Belanja Tidak Langsung Bantuan</div>       
    </div>
    <div class="portlet-body flip-scroll">
        <form:form  method="post" commandName="spdBTLMaster"  id="spdBTLMasterform"   action="${pageContext.request.contextPath}/spd/pengajuanbtlbantuan/btlbantuan/prosessimpan" class="form-horizontal">
    ...
    <table id="btlspdtable" class="table table-striped table-bordered table-condensed table-hover display"   >
        <thead>
            <tr>
                ...
                <th rowspan="2" style="	vertical-align: middle;">Nilai Anggaran</th>
