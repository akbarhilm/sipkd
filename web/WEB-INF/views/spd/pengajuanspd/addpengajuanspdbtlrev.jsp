...
<ul class="breadcrumb">
    ...
    <li><a href="#">Belanja Tidak Langsung APBDP<span id='statusaddedit'></span></a></li>
</ul>
<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Form SPD Belanja Tidak Langsung APBDP</div>       
    </div>
    <div class="portlet-body flip-scroll">
        <form:form  method="post" commandName="spdBTLMaster"  id="spdBTLMasterform"   action="${pageContext.request.contextPath}/spd/pengajuanrev/btl/prosessimpanrev" class="form-horizontal">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        loadupdate("${pageContext.request.contextPath}/spd/pengajuanrev/json/getlistspddetailbyskpddantahunrev");
        statusbreadcrum();
    ...
    function getpagudanspd(id) {
        ...
        if (noSpd && $.trim(noSpd).length > 0) {
           // console.log(" kosong " + noSpd + "  : " + id);
            ...
            gridspdbtllist("${pageContext.request.contextPath}/spd/pengajuanrev/json/getlistspddetailbyskpddantahunrev", id, idSpd, tahunAnggaran);
        }
        $.getJSON("${pageContext.request.contextPath}/spd/pengajuanrev/json/getanggarandanspd/" + id,
                function(result) {
    ...
    function simpan() {
        ...
        var idSpd = $("#idSpd").val();
        var tahunAnggaran = $("#tahunAnggaran").val();
        submispddetail('${pageContext.request.contextPath}/spd/pengajuanrev/json/addspddetailrev', "${pageContext.request.contextPath}/spd/pengajuan/json/getlistspddetailbyskpddantahun", idskpd, idSpd, tahunAnggaran);
    }
    function pindahhalamanadepan() {
        if ($("#idskpd").val().trim()) {
            window.location.replace("${pageContext.request.contextPath}/spd/pengajuanrev/btl/indexskpd/" + $("#idskpd").val().trim());
        } else {
            window.location.replace("${pageContext.request.contextPath}/spd/pengajuanrev/btl/indexbtlrev");
        }
    }

</script>
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spd/spdbtlrev.js"></script>   