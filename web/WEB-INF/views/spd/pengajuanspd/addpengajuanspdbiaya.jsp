...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spd/spdbiayaadddetail.js"></script>   
<ul class="breadcrumb">
    <li>
        <i class="icon-home"></i>
    ...
    <li><a href="#">Pembiayaan <span id='statusaddedit'></span></a></li>
</ul>
<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Form SPD Pembiayaan</div>       
    </div>
    <div class="portlet-body flip-scroll">
        <form:form  method="post" commandName="spdBTLMaster"  id="spdBTLMasterform"   action="${pageContext.request.contextPath}/spd/pengajuanbiaya/biaya/prosessimpan" class="form-horizontal">
