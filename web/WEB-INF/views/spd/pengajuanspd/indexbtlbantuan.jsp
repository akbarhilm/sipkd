...
<ul class="breadcrumb">
    ...
    <li>
        <a href="${pageContext.request.contextPath}/spd/pengajuanbtlbantuan/btlbantuan/index">Pengajuan SPD</a>
        <span class="icon-angle-right"></span>
    </li>
    <li><a href="#">Belanja Tidak Langsung Bantuan</a></li>
</ul>
<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Form Belanja Tidak Langsung Bantuan</div>
        <div class="actions">
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spd/spdbtlbantuan.js"></script>   