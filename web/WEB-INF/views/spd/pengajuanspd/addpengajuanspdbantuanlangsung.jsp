...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spd/spdbantuanlangsungdetail.js"></script>   
<ul class="breadcrumb">
    <li>
        <i class="icon-home"></i>
    ...
    <li><a href="#">Belanja  Langsung <span id='statusaddedit'></span></a></li>
</ul>
<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Form SPD Belanja Langsung</div>       
    </div>
    <div class="portlet-body flip-scroll">
        <form:form  method="post" commandName="spdBTLMaster"  id="spdBTLMasterform"   action="${pageContext.request.contextPath}/spd/pengajuanbl/bl/prosessimpan" class="form-horizontal">
