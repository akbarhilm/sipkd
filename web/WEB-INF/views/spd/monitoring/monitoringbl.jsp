<ul class="breadcrumb">
    ...
    <li><a href="#">Monitoring SPD Belanja Langsung</a></li>
</ul>

<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Monitoring SPD Belanja Langsung</div>
        <% /* <div class="actions">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                       ...
                       <input type="text"  name="tgl"  id="tgl"  class="m-wrap large date-picker entrytanggal" size="14"  value="" /> 
                      <a class="icon-book" onclick='cetakmonbl()' href="#" ></a>
                    </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spd/spdmonitoringbl.js"></script>   