<ul class="breadcrumb">
    ...
    <li><a href="#">Monitoring SPD Belanja Tidak Langsung</a></li>
</ul>

<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Monitoring SPD Belanja Tidak Langsung</div>
        <% /* <div class="actions">
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spd/spdmonitoringbtl.js"></script>   