...
<ul class="breadcrumb">
    ...
    <li><a href="#">Cetak Jurnal SKPD</a></li>
</ul>
...
<form:form   method="post" commandName="refcetak"  id="refsppup"   action="${pageContext.request.contextPath}/spj/prosessimpan" class="form-horizontal">
    <div onload="" class="portlet box red">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Cetak Jurnal SKPD</div>       
        </div>
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 col-md-9">
                    ...
                    <a id="pilihnojur"  class="fancybox fancybox.iframe btn dark" href="${pageContext.request.contextPath}/nojurnal/listnojurnalskpd?target='_top'" title="Pilih Nomor Jurnal"  ><i class="icon-zoom-in"></i> Pilih</a>
                </div>
            </div>   
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/cetak/jurnalskpd.js"></script>  
