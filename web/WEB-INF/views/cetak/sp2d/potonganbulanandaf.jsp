...
<ul class="breadcrumb">
    <li>
        <i class="icon-home"></i>
        <a href="${pageContext.request.contextPath}/beranda">Daftar Laporan SP2D Potongan Bulanan</a> 
...
<div class="portlet box red">
    ...
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Daftar Laporan SP2D Potongan Bulanan</div>
             ...
             <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                       ...
                       <a class="icon-book" onclick='cetakpotbuldaf()' href="#" ></a>
                    </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/cetak/sp2d/cetaksp2dpotbuldaf.js"></script>  
