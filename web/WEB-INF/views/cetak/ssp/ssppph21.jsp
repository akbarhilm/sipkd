...
<div class="portlet box red">
    ...
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Cetak SSP PPh 21</div>
                ...
                <div class="col-md-4">
                    <div class="input-group">
                      ...
                      <input type="text" class="required" name="nsp2d"  id="nsp2d"  size="20"  value="${nsp2d}" />  
                       <a class="icon-book" onclick='cetakssppph21()' href="#" ></a>
                    </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/cetak/ssp/ssppph21.js"></script>  
