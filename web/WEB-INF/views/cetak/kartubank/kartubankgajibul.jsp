...
<ul class="breadcrumb">
    <li>
        <i class="icon-home"></i>
        <a href="${pageContext.request.contextPath}/beranda">Kartu Bank Gaji Bulanan</a> 
        <span class="icon-angle-right"></span>
    </li>    
    <li><a href="#">Kartu Bank Gaji Bulanan</a></li>
</ul>
<div class="portlet box red">
    ...
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Kartu Bank Gaji Bulanan</div>
      ...
      <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                       ...
                       <a class="icon-book" onclick='cetakkbgajibul()' href="#" ></a>
                    </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/cetak/kartubank/kartubankgajibul.js"></script>  
