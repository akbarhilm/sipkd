<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/listskpd/skpdlistpopupID1.js"></script>    
...
<script type="text/javascript">
    ...
    function ambilskpd(id) {
        ...
        $('#namaskpdpop', window.parent.document).val($("#nSkpd" + id).val()).change();
        $('#kodeskpdpop', window.parent.document).val($("#kodeSkpd" + id).val()).change();
