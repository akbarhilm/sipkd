...
<ul class="breadcrumb">
    ...
    <li><a href="#">Buku Besar Jurnal SKPD</a></li>
</ul>
...
<form:form   method="post" commandName="refbukubesar"  id="refsppup"   action="${pageContext.request.contextPath}/spj/prosessimpan" class="form-horizontal">
    <div onload="" class="portlet box red">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Buku Besar Jurnal SKPD</div>       
        </div>
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 col-md-9">
                    ...
                    <a id="akunpilih" onclick="setbtnproses()" class="fancybox fancybox.iframe btn dark" href="${pageContext.request.contextPath}/akun/listakunbukubesarskpd?target='_top'" title="Pilih Kode Akun"  ><i class="icon-zoom-in"></i> Pilih</a>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bukubesar/bukubesarskpd.js"></script>  
