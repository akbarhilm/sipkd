    ...
    <div onload="" class="portlet box red">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input type="text" path="tglPosting" id="tglPosting" readonly='true'  class="required  date-picker2 entrytanggal2 valid" size="14" value="" disabled="true"  />
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input type="text" path="tglDok" id="tglDok"  readonly='true'  class="required  date-picker2 entrytanggal2 valid" size="14" value="" disabled="true"  />
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/monitoringbku/editbkuspjkoreksi.js"></script>  
