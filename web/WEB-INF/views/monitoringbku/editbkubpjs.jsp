    ...
    <div onload="" class="portlet box red">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <div class="input-group" id="nobuktiketerangan">
                        <form:input path="noBukti" id="noBukti" type="text"  size="55" readonly="true" /> 
                    </div>
                </div>  
            </div>
            ...
            <div id="labeljenisbpjs" name="labeljenisbpjs" class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <select name="jenisbpjs" id="jenisbpjs" onchange="getSaldoBpjs()" disabled="true">
            ...
            <div id="labelpengeluaran" name="labelpengeluaran" class="form-group">
                ...
                <div class="col-md-4">
                    <input name="pengeluaran" id="pengeluaran" type="text" readonly="true" onchange="setformatpengeluaran(this.value)"  />
