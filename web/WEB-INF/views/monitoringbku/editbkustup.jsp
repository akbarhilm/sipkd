    ...
    <div onload="" class="portlet box red">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input type="text" path="tglPosting" id="tglPosting"  class="required  date-picker2 entrytanggal2 valid" size="14" value="" readonly="true"/>
            ...
            <div id="labelbeban" name="labelbeban"  class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:select id="beban" path="beban" disabled="true" >
            ...
            <div id="labeljenis" name="labeljenis"  class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:select id="jenis" path="jenis" disabled="true">
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/monitoringbku/editbkustup.js"></script>  
