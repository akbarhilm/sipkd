    ...
    <div onload="" class="portlet box red">
        ...
        <div class="portlet-body flip-scroll">
           ...
           <div id="labelakunlainlain" class="form-group">
                ...
                <div class="col-md-9">
                    <input type="text" name="keteranganAkunLain"  id="keteranganAkunLain"  class="m-wrap large" size="80" readOnly="true"/>  
                    <input type="hidden" id="idbaslain" name="idbaslain"  value="" onchange="setAkun()">
                    <input type="hidden" id="kodeAkunLain" name="kodeAkunLain"  value="">
                    <form:hidden path="idBas" id="idBas"  />
                    <form:hidden path="kodeakun" id="kodeakun"  />
                    <form:hidden path="ketakun" id="ketakun"  />
                </div>
            </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/monitoringbku/editbkulainlain.js"></script>  
