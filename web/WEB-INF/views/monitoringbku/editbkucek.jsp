        ...
        <div class="portlet-body flip-scroll">
            ...
            <div  class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    <form:input path="nilaiCek" id="nilaiCek" readonly='true' />
                </div>
            </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/monitoringbku/editbkucek.js"></script>  
