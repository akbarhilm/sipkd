    ...
    <div onload="" class="portlet box red">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:select path="bulan" id='bulan' onchange="" disabled="true">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <form:select path="kodeTransaksi" id="kodeTransaksi" disabled="true" readonly="true" >
                            ...
                            <form:option value="NP">NPD KE PPTK/dll (Pemberian Uang Panjar kepada PPTK)</form:option>
                            <form:option value="NM">PPTK/dll KE NPD (Pengembalian sisa Uang Panjar oleh PPTK)</form:option>
                            ...
                            <form:option value="P6">PPH</form:option>
            ...
            <div id="labelcarabayar" name="labelcarabayar" class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:select path="kodePembayaran" id="kodePembayaran" disabled="true" onchange="">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <form:input type="text" path="ketKegiatan"  id="ketKegiatan" readonly='true' class="m-wrap large" size="80" readOnly="true"/> 
            ...
            <div id="labelnippptk" name="labelnippptk" class="form-group">
                ...
                <div class="col-md-4">
                    <form:input path="nipPptk" id="nipPptk" type="text" readonly='true' class="required "  /> 
                </div>
            </div>
            ...
            <div id="labelnamapptk" name="labelnamapptk" class="form-group">
                ...
                <div class="col-md-4">
                    <form:input path="namaPptk" id="namaPptk" type="text" readonly='true' class="required " size="50" /> 
                </div>
            </div>
            ...
            <div id="labeluraianterima" name="labeluraianterima" class="form-group">
                ...
                <div class="col-md-4">
                    <form:textarea path="uraianPg" id="uraianPg" readonly='true' class="required " cols="80" ROWS="3" maxlength="400" />
                </div>
            </div>
            ...
            <div id="labeluraiankeluar" name="labeluraiankeluar" class="form-group">
                ...
                <div class="col-md-4">
                    <form:textarea path="uraianPn" id="uraianPn" readonly='true' class="required " cols="80" ROWS="3" maxlength="400" />
                </div>
            </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/monitoringbku/editbkunpnm.js"></script>  
