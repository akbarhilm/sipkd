    ...
    <div onload="" class="portlet box red">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input type="text" path="tglPosting" readonly='true' id="tglPosting"  class="required  date-picker2 entrytanggal2 valid" size="14" value="" />
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group" id="nobuktiketerangan">
                        <form:input path="noBukti" id="noBukti" readonly='true'  type="text" size="55" /> 
                    </div>
                </div>  
            </div> 
            ...
            <div id="labelcarabayar" name="labelcarabayar" class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:select path="kodePembayaran" id="kodePembayaran" onchange="setPembayaran(this.value)" disabled="true">
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/monitoringbku/editbkuspj.js"></script>  
