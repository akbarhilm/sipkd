...
<form:form   method="post" commandName="refsppup"  id="refsppup"   action="${pageContext.request.contextPath}/bapkas/prosesview" class="form-horizontal">
        ...
        <div class="portlet-body flip-scroll">
           ...
           <!-- <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input type="text"  path="tglBkuBa" id="tglBkuBa" readonly='true'  class="required  date-picker2 entrytanggal2 valid"  size="14"   />  
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input  cssClass="required" path="blnBkuBa" readonly='true' id="blnBkuBa"  size="3" maxlength="2"   />  
                    </div>
                </div>
            </div>        
            <div class="form-group">
           ...
           <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                       <form:input  type="text"  path="nilaiUangSuratBerharga"  id="nilaiUangSuratBerharga" readonly='true'  class="inputmoneyX" size="19"  style="text-align:right" />&nbsp;&nbsp;&nbsp;(5) 
                    </div>
                </div>
            </div> 
            <div class="form-group">
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bapkas/viewbapkas.js"></script>  
