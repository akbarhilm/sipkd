...
<ul class="breadcrumb">
    ...
    <li>
        <a href="${pageContext.request.contextPath}/sp2dbantuanls/indexsp2dbantuanls/${refsp2d.skpd.idSkpdkoord}">Daftar SP2D Bantuan LS</a> 
        <span class="icon-angle-right"></span>
    </li>
    <li><a href="#">Pengajuan SP2D LS Bantuan</a></li>
</ul>



<form:form  method="post" commandName="refsp2d"  id="refsp2d" action="${pageContext.request.contextPath}/sp2dbantuanls/prosessimpan" class="form-horizontal">
    <div class="portlet box red">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Pengajuan SP2D Bantuan LS</div>       
        </div>
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                <label class="col-md-3 control-label">SKPD Koord:</label>
                <div class="col-md-9">
                    <div class="input-group">
                        <form:hidden path="skpd.idSkpdkoord" id='idskpdkoord'     />
                        <form:input path="skpd.kodeSkpdkoord" id='kodeskpdkoord' readOnly="true" size="10"/> / <form:input path="skpd.namaSkpdkoord" id="skpd"  cssClass="required"   type="text" size="55" maxlength="80" readonly='true'  />
                    </div>
                </div>
            </div>  
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input type="text" name="tanggalSp2d" path="tanggalSp2d" id="tanggalSp2d" size="12" readonly="true" /> </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <form:input  cssClass="required" path="nipKbud" id="nipKbud" readOnly="true" size="30" maxlength="30"   />  &nbsp; <a  class="fancybox fancybox.iframe btn green" href="${pageContext.request.contextPath}/sp2dbtlls/listkbud?target='_top'" title="Pilih KBUD"  ><i class="icon-zoom-in"></i> Pilih</a>
            ...
            <div class="form-actions fluid">
                <div class="col-md-offset-3 col-md-9">
                    ...
                    <a class="btn blue"   href="${pageContext.request.contextPath}/sp2dbantuanls/indexsp2dbantuanls/${refsp2d.skpd.idSkpdkoord}">Kembali</a>
                </div>
            </div>
            ...
            <table id="btllssp2drincitable" class="table table-striped table-bordered table-condensed table-hover " >
                ...
                <tfoot>
                    <tr>
                        ...
                        <th >
                            <form:input path='nilaiSp2d'  type='text' id="totalsp2d"  name="totalsp2d" readonly="true" style='border:none;margin:0;width:99%;text-align:right;'    />
                        </th>
                    </tr>
                </tfoot>
            </table>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/sp2d/bantuanls/addsp2dbantuanls.js"></script>
