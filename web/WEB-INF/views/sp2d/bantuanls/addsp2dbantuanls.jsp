    ...
    <div class="portlet box red">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <div class="input-group">
                        <form:hidden path="skpd.idSkpdkoord" id='idskpdkoord'  value="${skpd.idSkpd}"  />
            ...
            <table id="btllssp2drincitable" class="table table-striped table-bordered table-condensed table-hover " >
                ...
                <tfoot>
                    <tr>
                        ...
                        <th >
                            <form:input path='nilaiSp2d'  type='text' id="totalsp2d"  name="totalsp2d" readonly="true"      style='border:none;margin:0;width:99%;'    />
                        </th>
