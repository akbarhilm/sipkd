            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <form:input  cssClass="required" path="nipKbud" id="nipKbud" readOnly="true" size="21" maxlength="18"   />  &nbsp; <a  class="fancybox fancybox.iframe btn green" href="${pageContext.request.contextPath}/sp2dbtlls/listkbud?target='_top'" title="Pilih KBUD"  ><i class="icon-zoom-in"></i> Pilih</a>
