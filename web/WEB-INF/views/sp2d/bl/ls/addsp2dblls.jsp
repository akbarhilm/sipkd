...
<ul class="breadcrumb">
    ...
    <li><a href="#">Pengajuan SP2D LS Belanja Langsung</a></li>
</ul>
...
<form:form  method="post" commandName="refsp2d"  id="refsp2d"   action="${pageContext.request.contextPath}/sp2dblls/prosessimpan" class="form-horizontal">
    <div class="portlet box red">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Pengajuan SP2D Belanja Langsung </div>       
        </div>
        <div class="portlet-body flip-scroll">
            <div class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    <form:hidden path="nilaiBersihSp2d" id='nilaiBersihSp2d'   value="${nilaiBersihSp2d}"  />
                    <form:hidden path="nilaiPotSp2d" id='nilaiPotSp2d'    />
                    <form:hidden path="nilaiSp2d" id='nilaiSp2d'    />
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <form:hidden  cssClass="required" path="nipPenggunaAnggaran" id="nipPenggunaAnggaran" readOnly="true" size="30" maxlength="18"   /> 
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input  path="nilaiBersihSp2d" id="nilaiBersihSp2d" readOnly="true" size="30" maxlength="80"  value= "${nilaiBersihSp2d}"  />  
                        <form:errors path="nilaiBersihSp2d"  cssClass="error"  />
                    </div>
                </div>
            </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/sp2d/blls/addsp2dblls.js"></script>
