        ...
        <form class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-md-8">
                    ...
                    <input type="hidden" id="idskpd"  name="idskpd" value="${idskpds}" onchange="gridsp2dblls()"  /> 
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/sp2d/blls/indexsp2dblls.js"></script> 