...
<ul class="breadcrumb">
    ...
    <li>
        <a href="${pageContext.request.contextPath}/sp2dbiayals/indexsp2dbiayals">Daftar SP2D Biaya LS</a> 
        <span class="icon-angle-right"></span>
    </li>
    <li><a href="#">Pengajuan SP2D LS Biaya</a></li>
</ul>



<form:form  method="post" commandName="refsp2d"  id="refsp2d"   action="${pageContext.request.contextPath}/sp2dbiayals/proseshapus" class="form-horizontal">
    <div class="portlet box red">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Pengajuan SP2D Biaya LS</div>       
        </div>
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-actions fluid">
                <div class="col-md-offset-3 col-md-9">
                    ...
                    <a class="btn blue"   href="${pageContext.request.contextPath}/sp2dbiayals/indexsp2dbiayals">Kembali</a>
                </div>
            </div>
    ...
    <div class="portlet" id="rincibl">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Rincian SP2D Biaya</div>  
        </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/sp2d/biayals/editsp2dbiayals.js"></script>
