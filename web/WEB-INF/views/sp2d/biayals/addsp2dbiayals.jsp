...
<form:form  method="post" commandName="refsp2d"  id="refsp2d"   action="${pageContext.request.contextPath}/sp2dbiayals/prosessimpan" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <div class="input-group">
                        <form:hidden path="skpd.idSkpd" id='idskpd'  value="${idskpd}"  />
                        <form:input path="skpd.namaSkpd" id="skpd"  value="${namaskpd}" cssClass="required"   type="text" size="55" maxlength="80" readonly='true'  />
                    </div>
                </div>
            </div>     
            <div class="form-group">
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/sp2d/biayals/addsp2dbiayals.js"></script>
