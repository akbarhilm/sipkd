...
<ul class="breadcrumb">
    ...
    <li>
        <a href="${pageContext.request.contextPath}/sp2dupgu/indexsp2dupgu/${refsp2d.skpd.idSkpd}">Daftar SP2D UP/GU</a> 
        <span class="icon-angle-right"></span>
    </li>
    <li><a href="#">Pengajuan SP2D UP/GU</a></li>
</ul>



<form:form  method="post" commandName="refsp2d"  id="refsp2d"   action="${pageContext.request.contextPath}/sp2dupgu/prosessimpan" class="form-horizontal">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <div class="input-group">
                        ...
                        <form:input path="skpd.namaSkpd" id="skpd"  cssClass="required"   type="text" size="75" maxlength="100" readonly='true'  />
                    </div>
                </div>
            </div>     
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <form:input  cssClass="required" path="nipKbud" id="nipKbud" readOnly="true" size="30" maxlength="30"   />  &nbsp; <a  class="fancybox fancybox.iframe btn green" href="${pageContext.request.contextPath}/sp2dupgu/listkbud?target='_top'" title="Pilih KBUD"  ><i class="icon-zoom-in"></i> Pilih</a>
            ...
            <div class="form-actions fluid">
                <div class="col-md-offset-3 col-md-9">
                    ...
                    <a class="btn blue"   href="${pageContext.request.contextPath}/sp2dupgu/indexsp2dupgu/${refsp2d.skpd.idSkpd}">Kembali</a>
                </div>
            </div>
    ...
    <div class="portlet" id="rincibl">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Rincian SP2D UP/GU</div>  
        </div>
        <div class="portlet-body">
            <table id="upgusp2drincitable" class="table table-striped table-bordered table-condensed table-hover " >
                <thead>
                    <tr>
                        <th>No</th>
                        <th>No SPD</th>
                        <th>Keterangan SPD</th>
                        <th>Nilai SP2D</th>
                    </tr>
                </thead>
                <tbody>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/sp2d/upgu/addsp2dupgu.js"></script>
