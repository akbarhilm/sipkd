                ...
                <div class="col-md-8">
                  <!--  <input type="hidden" id="idskpd" name="idskpd" value="${skpd.idSkpd}" onchange="gridsppup()"  />
                    ...
                    <c:if test="${isall == 1}"  >  &nbsp; &nbsp;<a  class="fancybox fancybox.iframe btn green" href="${pageContext.request.contextPath}/common/listskpd?target='_top'" title="Pilih SKPD"  ><i class="icon-zoom-in"></i> Pilih</a> </c:if>-->
                        ...
                        <input type="hidden" id="idskpd" onchange="gridsppup()" name="idskpd" value="${idskpd}"  />
...
<div class="portlet box">
    ...
    <div class="form-actions fluid">
        <div class="col-md-offset-3 col-md-9" align="Right">
            ...
            <button type="button" id="prosestransfer" class="btn blue" onclick='cekBanyakTf()' >Proses Transfer</button>
