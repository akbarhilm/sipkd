...
<script type="text/javascript">
    ...
    function halamaninsert() {
        var a = document.getElementById("btnKembali");

        a.href = getbasepath() + "/spmterima/insertspmterima/"+$('#idSpmCetak').val();

        //console.log("a.href = "+getbasepath() + "/spmterima/insertspmterima/"+$('#idSpmCetak').val());
    }
</script>
...
<div class="portlet box red">
    ...
    <div class="portlet-body flip-scroll">
        <form:form  method="post" commandName="progcmd2"  id="progcmd2"   action="${pageContext.request.contextPath}/spmterima/prosesdelete" class="form-horizontal"   >
            ...
            <div class="form-group" >
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input   path="namaSkpd" id="namaSkpd" size="30" maxlength="" readonly="true" />  
    ...
    <div class="form-actions fluid">
        <div class="col-md-offset-3 col-md-9">
           ...
           <!-- <a class="btn blue" id="btnKembali" onclick="" href="${pageContext.request.contextPath}/spmterima" >Kembali</a>  -->
           <a class="btn blue" id="btnKembali" onclick="halamaninsert()" >Kembali</a> 
