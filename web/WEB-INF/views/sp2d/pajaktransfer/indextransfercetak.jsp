...
<ul class="breadcrumb">
    ...
    <li><a href="#"> Cetak Pajak SP2D </a></li>
</ul>
    ...
    <div class="portlet-body flip-scroll">
        <form class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <div class="input-group">
                        ...
                        <!--<input type="hidden" id="pengg"  name="tahun" value="${pengguna.kodeSah}"  />-->
            ...
            <div id="" class="form-group">
                ...
                <div class="col-md-8">
                    <div class="input-group">
                        <input type="text" name="tglsah2" id="tglsah2" class=" date-picker2 valid required" size="14" value="" onchange="gridpajak()"/>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/sp2d/pajaktransfer/indextransfercetak.js"></script>
