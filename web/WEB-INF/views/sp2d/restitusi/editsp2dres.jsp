...
<form:form  method="post" commandName="refsp2d"  id="refsp2d"   action="${pageContext.request.contextPath}/sp2drestitusi/prosesubah" class="form-horizontal">
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/sp2d/restitusi/ubahsp2dres.js"></script>
