...
<ul class="breadcrumb">
    ...
    <li>
        <a href="${pageContext.request.contextPath}/sp2drestitusi/indexsp2dres/${refsp2d.skpd.idSkpd}">Daftar SP2D Restitusi</a> 
        <span class="icon-angle-right"></span>
    </li>
    <li><a href="#">Pengajuan SP2D Restitusi</a></li>
</ul>



<form:form  method="post" commandName="refsp2d"  id="refsp2d"   action="${pageContext.request.contextPath}/sp2drestitusi/prosessimpan" class="form-horizontal">
    <div class="portlet box red">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Pengajuan SP2D Restitusi</div>       
        </div>
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <form:input  cssClass="required" path="nipKbud" id="nipKbud" readOnly="true" size="30" maxlength="18"   />  &nbsp; <a  class="fancybox fancybox.iframe btn green" href="${pageContext.request.contextPath}/sp2drestitusi/listkbud?target='_top'" title="Pilih KBUD"  ><i class="icon-zoom-in"></i> Pilih</a>
            ...
            <div class="form-actions fluid">
                <div class="col-md-offset-3 col-md-9">
                    ...
                    <a class="btn blue"   href="${pageContext.request.contextPath}/sp2drestitusi/indexsp2dres/${refsp2d.skpd.idSkpd}">Kembali</a>
                </div>
            </div>
    ...
    <div class="portlet" id="rincibl">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Rincian SP2D Restitusi</div>  
        </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/sp2d/restitusi/addsp2dres.js"></script>
