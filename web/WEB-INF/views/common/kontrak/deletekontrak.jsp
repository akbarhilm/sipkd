...
<div class="portlet box red">
    ...
    <div class="portlet-body flip-scroll">
        <form:form  method="post" commandName="progcmd"  id="spdBTLMasterform"   action="${pageContext.request.contextPath}/kontrak/deletekontraks" class="form-horizontal">
            ...
            <div class="form-group">
                <label class="col-md-4 control-label">Jenis Belanja:</label>
                <div class="col-md-7">
                    <div class="input-group">

                        <form:select path="kodeBelanja" id="kodeBelanja" disabled="true" >
                            <form:option value="-">---- Pilih ----</form:option>
                            <form:option value="1">Belanja Pegawai</form:option>
                            <form:option value="2">Belanja Barang</form:option>
                            <form:option value="3">Belanja Jasa</form:option>
            ...
            <div class="form-group">
                <label class="col-md-3 control-label">No Perusahaan Tender:</label>
                <div class="col-md-4">
                    <div class="input-group">
            ...
            <div class="form-group">
                <label class="col-md-3 control-label">No Perusahaan DIKDIP:</label>
                <div class="col-md-4">
                    <div class="input-group">
            ...
            <div class="form-group">
                <label class="col-md-3 control-label">Tgl Perusahaan DIKDIP:</label>
                <div class="col-md-4">
                    <div class="input-group">
            ...
            <div class="form-group">
                <label class="col-md-3 control-label">No Akte Perusahaan:</label>
                <div class="col-md-4">
                    <div class="input-group">
            ...
            <div class="form-group">
                <label class="col-md-3 control-label">Tanggal Akte Perusahaan:</label>
                <div class="col-md-4">
                    <div class="input-group">
            ...
            <div class="form-group">
                <label class="col-md-3 control-label">Nama Perusahaan (Tujuan):</label>
                <div class="col-md-4">
                    <div class="input-group">
            ...
            <div class="form-actions fluid">
                <div class="col-md-offset-3 col-md-9">
                    <button id="btndelete"   type="submit" class="btn blue" > Delete </button>
