            ...
            <div class="col-md-7">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <div class="input-group">
                            ...
                            <form:input path="nilaiSpd" id="nilaiSpd" value="${nilaiSpd}" cssClass="required " onkeyup="validasiAngg(this.value)" onchange="validasiAngg(this.value)" onkeypress="return isNumberNilai(event); validasiAngg(this.value)"  size="30" maxlength="17" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <div class="input-group">
                            <!-- ruleCekNamaRekanan -->
                            <form:input path="rekanan.namaRekanan" id="rekanan"    size="40" maxlength="50"  cssClass="required ruleCekGeneralError"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <div class="input-group">
                            ...
                            <form:input path="rekeningBank" id="rekeningBank"    size="40"   maxlength="30"  onKeyPress="return numbersonly(this, event)" onchange=""/>
