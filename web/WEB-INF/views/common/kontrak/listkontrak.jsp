            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <input type="text" onkeyup="if (event.keyCode == 13)gridkontrak()" value="${tahunAnggaran}" name="tahun" id="tahun" readonly="true" maxlength="4" size="10"  class="m-wrap medium inputnumber" /> 
                    </div>
                </div>
            </div>
             <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group">
                        <input  name='kodeMetode' id='kodeMetode' onkeyup="if (event.keyCode == 13)gridkontrak()" />
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <input name='rekanan' id="rekanan" size="40"  onkeyup="if (event.keyCode == 13)gridkontrak()" />  
                ...
                <div class="col-md-9">
                    <div class="input-group">
                        <input name='nilai1' id="nilai1" size="30" class="inputinvoice valid"  onkeyup="if (event.keyCode == 13)gridkontrak()" />&nbsp; &nbsp; s/d &nbsp; &nbsp;<input name='nilai2' id="nilai2" size="30"  class="inputinvoice valid"  onkeyup="if (event.keyCode == 13)gridkontrak()" />  
                    </div>
                </div>  
            </div>
                <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <input name='namakegiatan' id="namakegiatan" size="40"  onkeyup="if (event.keyCode == 13)gridkontrak()" />  
                        <form:errors  class="error" />                       
                    </div>
                </div>  
            </div>
