...
<ul class="breadcrumb">
    ...
    <li>
        <a href="#" onclick="pindahhalamanadepan()">Daftar SPM UP</a> 
        <span class="icon-angle-right"></span>
    </li>
    <li><a href="#">Entry  SPM UP</a></li>
</ul>
<div  ${pesan != null ?"class='alert alert-success'":""}   >${pesan}</div>
<form:form  method="post" commandName="refsppup"  id="refsppup"   action="${pageContext.request.contextPath}/spmup/prosessimpan" class="form-horizontal">
    <div class="portlet box red">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Form SPM UP</div>       
        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group">
                        ...
                        <input type="text" name="skpd.namaSkpd" id="skpd" value="${skpd.kodeSkpd}/${skpd.namaSkpd}"  class="required"     size="55"   readonly='true'  />
...
<c:if test="${status == false}">
    <script type="text/javascript">
                        $(document).ready(function() {
                            bootbox.alert("PROSES SPM UP SUDAH DITUTUP");
                        });
