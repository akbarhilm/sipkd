    ...
    <div class="portlet box red">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input path="noKontrak" id="noKontrak" readOnly="true" type="text" size="30" maxlength="30" tabindex="0"  cssStyle="background-color: #F1F1D9"   /> 
                    </div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input path="namaRekanan" id="namaRekanan" readOnly="true" type="text" size="30" maxlength="30" tabindex="0"  cssStyle="background-color: #F1F1D9"   /> 
                    </div>
                </div>
            </div> 
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input path="alamatBank" id="alamatBank" type="text"  readOnly="true" size="50" maxlength="50" tabindex="0"  cssStyle="background-color: #F1F1D9"   /> 
                    </div>
                </div>
            </div>
            <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <c:if test="${cek1 == 0}">
                            <form:checkbox path="potongan" id="potongan" /> Non Ayat 
                             ...
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                        <c:if test="${cek2 != 0}">
                            <form:checkbox path="potonganUangMuka" id="potonganUangMuka" readOnly="true"  /> Uang Muka     
                        </c:if>
                        <c:if test="${cek2 == 0}">
