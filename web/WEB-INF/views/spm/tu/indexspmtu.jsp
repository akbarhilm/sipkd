...
<ul class="breadcrumb">
    ...
    <li><a href="#">  SPM TU</a></li>
</ul>
<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Daftar  SPM TU</div>
        ...
        <form class="form-horizontal">
            ...
            <div class="form-actions fluid">
                <div class="col-md-offset-3 col-md-9">
                    <button type="button" class="btn dark" onclick='gridpaguspptu()'>Cari</button>
                </div>
            </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spmtu/spmtu.js"></script>  
