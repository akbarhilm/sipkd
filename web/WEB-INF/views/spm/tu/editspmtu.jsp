...
<ul class="breadcrumb">
    ...
    <li>
        <a href="#" onclick="pindahhalamanadepan()">Daftar SPM TU</a> 
        <span class="icon-angle-right"></span>
    </li>
    <li><a href="#">Entry  SPM TU</a></li>
</ul>
<div  ${pesan != null ?"class='alert alert-success'":""}   >${pesan}</div>
<form:form  method="post" commandName="refspptu"  id="refspptu"   action="${pageContext.request.contextPath}/spmtu/prosessimpan" class="form-horizontal">
    <div class="portlet box red">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Form SPM TU</div>       
        </div>
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:textarea  cols="45" rows="3"    path="keteranganSpm" id="keteranganSpm" readonly='true' cssClass="required"    maxlength="175" cssStyle="background-color: #F1F1D9" tabindex="0"  />  
    ...
    <div class="portlet">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Rincian SPM TU</div>       
        </div> 
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spmtu/addspmtu.js"></script>  
...
<c:if test="${status == false}">
    <script type="text/javascript">
                        $(document).ready(function() {
                            bootbox.alert("PROSES SPM TU SUDAH DITUTUP");
                        });
