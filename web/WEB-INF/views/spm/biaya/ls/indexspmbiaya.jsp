...
<ul class="breadcrumb">
    ...
    <li><a href="#">  SPM BIAYA LS</a></li>
</ul>
<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Daftar  SPM BIAYA LS</div>
        ...
        <form class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text"  name="skpd"  readonly="true" id="skpd"  class="m-wrap large" size="90"  value="${skpd.kodeSkpd} / ${skpd.namaSkpd}" />
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spmbiayals/spmbiayals.js"></script>  
