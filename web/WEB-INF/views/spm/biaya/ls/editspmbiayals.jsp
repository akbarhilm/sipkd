...
<c:if test="${status == true}">
    ...
    <li>
        <a href="${pageContext.request.contextPath}/spmbiayals/indexspmbiayals" onclick="">Daftar SPM BIAYA LS</a> 
        <span class="icon-angle-right"></span>
    </li>
    <li><a href="#">Entry  SPM BIAYA LS</a></li>
</ul>
<div  ${pesan != null ?"class='alert alert-success'":""}   >${pesan}</div>
<form:form  method="post" commandName="refsppbiaya"  id="refsppbiaya"   action="${pageContext.request.contextPath}/spmbiayals/prosessimpan" class="form-horizontal">
    <div class="portlet box red">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Form SPM BIAYA LS</div>       
        </div>
    ...
    <div class="portlet">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>SPM BIAYA LS</div>       
        </div> 
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spmbiayals/addspmbiayals.js"></script> 
</c:if> 