...
<c:if test="${status == true}">
    <ul class="breadcrumb">
        ...
        <li>
            <a href="${pageContext.request.contextPath}/spmrestitusi/indexres" onclick="">Daftar SPM Restitusi</a> 
            <span class="icon-angle-right"></span>
        </li>
        <li><a href="#">Entry  SPM  Restitusi</a></li>
    </ul>
    <div  ${pesan != null ?"class='alert alert-success'":""}   >${pesan}</div>
    <form:form  method="post" commandName="refsppbtl"  id="refsppbtl"   action="${pageContext.request.contextPath}/spmrestitusi/prosessimpan" class="form-horizontal">
        <div class="portlet box red">
            <div class="portlet-title">
                <div class="caption"><i class="icon-cogs"></i>Form SPM Restitusi</div>       
            </div>
            <div class="portlet-body flip-scroll">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            ...
                            <form:input path="skpd.namaSkpd" id="skpd" value="${skpd.kodeSkpd}/${skpd.namaSkpd}"  cssClass="required"   type="text" size="55" maxlength="80" readonly='true'  />
               ...
               <!-- <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="input-group">
                            <form:textarea  cols="30" rows="3"    path="keteranganSpm" id="keteranganSpm"  cssClass="required"    cssStyle="background-color: #F1F1D9" tabindex="0"  />  
                ...
                <div class="form-actions fluid">
                    <div class="col-md-offset-3 col-md-9">
                        ...
                        <a class="btn blue"  href="${pageContext.request.contextPath}/spmrestitusi/indexres" onclick="" >Kembali</a>
                    </div>
                </div>
        ...
        <div class="portlet">
            <div class="portlet-title">
                <div class="caption"><i class="icon-cogs"></i>Rincian SPP Restitusi</div>       
            </div> 
    ...
    <script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spmrestitusi/tambahspmrestitusi.js"></script>  
    
<c:if test="${status == false}">
    <script type="text/javascript">
                        $(document).ready(function() {
                            bootbox.alert("PROSES SPM RESTITUSI SUDAH DITUTUP");
                        });
