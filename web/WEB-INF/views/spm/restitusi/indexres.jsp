...
<ul class="breadcrumb">
    ...
    <li><a href="#">  SPM RESTITUSI</a></li>
</ul>
<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Daftar  SPM  Restitusi</div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spmrestitusi/spmrestitusi.js"></script>  
