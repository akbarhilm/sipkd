...
<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>SPM Potogan Uang Muka / Ayat</div>
        <div class="actions">
                ...
                <label class="col-md-3 control-label">NO.SPM:</label>
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <input id="idkontrak" type="hidden" name="idkontrak" value="${idkontrak}"/>
                            <input id="ketUmkpop" type="hidden" name="ketUmkpop" onchange="grid()" />
                ...
                <label class="col-md-3 control-label">TGL.SPM:</label>
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <input id="kodeumk" type="hidden" name="kodeumk" value="${kodeumk}"/>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spmpotayat/spmpotuangmuka.js"></script>  
