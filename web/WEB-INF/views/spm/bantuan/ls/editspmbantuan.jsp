...
<form:form  method="post" commandName="refsppbtl"  id="refsppbtl"   action="${pageContext.request.contextPath}/spmbtlbantuan/prosessimpan" class="form-horizontal">
    <div class="portlet box red">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group">
                        ...
                        <form:input path="skpd.namaSkpd" id="skpd" value="${skpd.kodeSkpd}/${skpd.namaSkpd}" type="text" size="55"  readonly='true'  />
            ...
            <div class="form-group">
                <label class="col-md-3 control-label">Kode / Nama SKPD Koor:</label>
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input   path="kodeSkpdKoor" id="kodeSkpdKoor"  size="10" maxlength="21" readonly='true'  />  / <form:input   path="namaSkpdKoor" id="namaSkpdKoor"   size="30" maxlength="75" readonly='true'  />  
                    </div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input   path="kodeKegiatan" id="kodeKegiatan" readOnly="true"   size="15" /> / <form:input   path="namaKegiatan" id="namaKegiatan" readOnly="true"   size="37"  /> 
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spmbantuan/addspmbantuan.js"></script>  
</c:if>

<c:if test="${status == false}">
    <script type="text/javascript">
                        $(document).ready(function() {
                            bootbox.alert("PROSES SPM BANTUAN SUDAH DITUTUP");
                        });
