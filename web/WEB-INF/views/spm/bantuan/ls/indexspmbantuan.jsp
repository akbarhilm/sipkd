...
<ul class="breadcrumb">
    ...
    <li><a href="#">  SPM Bantuan</a></li>
</ul>
<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Daftar  SPM Bantuan</div>
        ...
        <div class="portlet-body">
            <table id="btlspdtable" class="table table-striped table-bordered table-condensed table-hover " >
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Kode SKPD Koor</th>
                        <th>Nama SKPD Koor</th>
                        <th>Nomor SPP</th>  
                        <th>Nilai SPP</th> 
                        <th>Nomor SPM</th> 
                        <th>Nama Kegiatan</th>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spmbantuan/spmbantuan.js"></script>  
