...
<ul class="breadcrumb">
    ...
    <li><a href="#">  SPM BTL LS</a></li>
</ul>
<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Daftar  SPM BTL LS</div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spmbtlgaji/spmbtlgaji.js"></script>  
