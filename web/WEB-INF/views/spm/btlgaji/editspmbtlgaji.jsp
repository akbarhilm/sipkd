...
<c:if test="${status == true}">
    ...
    <form:form  method="post" commandName="refsppbtl"  id="refsppbtl"   action="${pageContext.request.contextPath}/spmbtlgaji/prosessimpan" class="form-horizontal">
        <div class="portlet box red">
            ...
            <div class="portlet-body flip-scroll">
                    ...
                    <div class="col-md-4">
                        <div class="input-group">
                            <c:if test="${cek != 0}">
                                ...
                                <input type="checkbox" id="pot" checked="true" disabled="true" />
                            </c:if>
                            <c:if test="${cek == 0}">
                                <%--form:checkbox  path="potongan" id="potongan" /--%>
                                <input type="checkbox" id="pot"  disabled="true" />
                            </c:if>
                            
                            <form:hidden path="kodePot" id="kodepot" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="input-group">
                            <form:textarea  cols="45" rows="3"    path="keteranganSpm" id="keteranganSpm"  cssClass="required"  maxlength="175"  cssStyle="background-color: #F1F1D9" tabindex="0" readonly="true" />  
    ...
    <script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spmbtlgaji/addspmbtlgaji.js"></script>  
</c:if>
