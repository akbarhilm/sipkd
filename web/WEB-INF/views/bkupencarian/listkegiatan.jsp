...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bkupencarian/listkegiatan.js"></script>    

<script type="text/javascript">
    $(document).ready(function() {
        jeniscarival = window.localStorage.getItem("ketJenisCari");
        tampil();
    });
