...
<ul class="breadcrumb">
    ...
    <li><a href="#">Hapus  SPP BL</a></li>
</ul>
        <div  ${pesan != null ?"class='alert alert-success'":""}   >${pesan}</div>
<form:form  method="post" commandName="refsppbl"  id="refsppbl"   action="${pageContext.request.contextPath}/bl/prosesdelete" class="form-horizontal">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input   path="nipPptk" id="nipPptk"  cssClass="required"   size="20" maxlength="18" readonly="true"   />  
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input   path="keterangan" id="uraian"  cssClass="required"   size="55" maxlength="70" readonly="true"   />  
            ...
            <div class="form-actions fluid">
                <div class="col-md-offset-3 col-md-9">
                    <button id="buttoninduk" onkeyup="enableddetail()" type="submit" class="btn blue" >Hapus</button>
