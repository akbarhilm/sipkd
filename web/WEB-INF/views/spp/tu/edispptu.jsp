...
<ul class="breadcrumb">
    ...
    <li><a href="#">Ubah  SPP TU</a></li>
</ul>
<div  ${pesan != null ?"class='alert alert-success'":""}   >${pesan}</div>
<form:form  method="post" commandName="refspptu"  id="refspptu"   action="${pageContext.request.contextPath}/spptu/prosesupdate" class="form-horizontal">
    <div class="portlet box red">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <div class="input-group">
                        <form:input   path="nipPptk" id="nipPptk"  cssClass="required"   size="20" maxlength="18"   /> / <form:input   path="namaPptk" id="namaPptk"  cssClass="required"   size="45" maxlength="50"   />  
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input   path="keterangan" id="uraian"    cssClass="required"   size="68" maxlength="110" readonly="true"  />  
    ...
    <div class="portlet">
        ...
        <table id="spprincitable" class="table table-striped table-bordered table-condensed table-hover " >
            <thead>
                <tr>
                    <th rowspan="2">No</th>
                    <th><input type="text"  style="border:none;margin:0;width:98%;" id="nospdfilter" /></th>
                    <th><input type="text"  style="border:none;margin:0;width:98%;" id="kodekegiatanfilter" /></th>
                    <th rowspan="2">Nama Kegiatan</th>
                    <th rowspan="2">Kode Akun</th>
                    <th rowspan="2">Nama Akun</th>
                    <th rowspan="2">SPD+Setoran TU</th>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spptu/editspptu.js"></script>  