...
<form:form  method="post" commandName="refspptu"  id="refspptu" onsubmit="return cek()" action="${pageContext.request.contextPath}/spptu/prosessimpan" class="form-horizontal">
