...
<ul class="breadcrumb">
    ...
    <li><a href="#">  SPP TU</a></li>
</ul>
<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Daftar  SPP TU</div>
        <div class="actions">
            <a href="#" onclick="cekSpjTu()" class="btn dark"><i class="icon-plus"></i> Tambah</a> 
        </div>
    </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spptu/spptu.js"></script>  
