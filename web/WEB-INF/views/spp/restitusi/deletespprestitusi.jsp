...
<ul class="breadcrumb">
    ...
    <li><a href="#">Hapus  SPP Restitusi</a></li>
</ul>
        <div  ${pesan != null ?"class='alert alert-success'":""}   >${pesan}</div>
<form:form  method="post" commandName="refsppbtl"  id="refsppbtl"   action="${pageContext.request.contextPath}/restitusi/prosesdelete" class="form-horizontal">
  <div class="portlet box red">
       ...
       <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input   path="validasi" id="validasi"  cssClass="required"   size="31" maxlength="30"   />  
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/spprestitusi/editspprestitusi.js"></script>  