...
<form:form  method="post" commandName="refsppbtl"  id="refsppbtl" onsubmit="return cek()"  action="${pageContext.request.contextPath}/btl/prosesupdate" class="form-horizontal">
        ...
        <div class="portlet-body flip-scroll">
            <div class="col-md-7">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <div class="input-group">
                            <form:input   path="nomorRekBank" id="nomorRekBank"  cssClass="required " onchange="getDataBankDki()"  onkeypress="return isNumber(event)"  size="31" maxlength="30"   /> &nbsp; <label class="control-label" id="labelCIF111" style="color: red">No Rekening Tidak Terdaftar</label> 
