...
<ul class="breadcrumb">
    ...
    <li><a href="#">Tambah  SPP BTL PENGHASILAN</a></li>
</ul>
<div  ${pesan != null ?"class='alert alert-warning'":""}   >${pesan}</div>
<form:form  method="post" commandName="refsppbtl"  id="refsppbtl" onsubmit="return cek()"  action="${pageContext.request.contextPath}/btlgaji/prosessimpan" class="form-horizontal">
        ...
        <div class="portlet-body flip-scroll">
            <div class="col-md-7">
                ...
                <div id="" class="form-group">
                    <label class="col-md-4 control-label">Pilih Data SIMPEG :</label>
                    <div class="col-md-7">
                        <input type="text"   id="ketgaji"  class="m-wrap large" size="40" readOnly="true"/>  &nbsp;<a  class="fancybox fancybox.iframe btn green" id="" href="${pageContext.request.contextPath}/btlgaji/listgaji?target='_top'" title="Pilih Data SIMPEG"  ><i class="icon-zoom-in"></i> Pilih Data SIMPEG</a> 
                        <form:hidden path="idSimpeg" id="idlist" name="idlist" onchange="getNilaiSPP()" />
                        <!--form:hidden path="kodeSimpeg" id='kodesimpeg' onchange="gridspprinci()"   /-->
                ...
                <div id="" class="form-group">
                    ...
                    <div class="col-md-7">
                        <input type="hidden"   id="textjumkotsimpeg"  name="textjumkotsimpeg" />
                        <form:input path="jumkotSimpeg" id='jumkotsimpeg' name="jumkotsimpeg" readonly="true" size="20" maxlength="20" cssClass="required cekJumkotSimpeg" value="0"/>
                        <form:errors path="jumkotSimpeg" cssClass="error" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <div class="input-group">
                            ...
                            <form:input   path="nomorRekBank" id="nomorRekBank"  cssClass="required ruleCekCIF111"  readonly="true" size="31" maxlength="30" onchange="getDataBankDki()" onkeypress="return isNumber(event)" />  &nbsp; <label class="control-label" id="labelCIF111" style="color: red">No Rekening Tidak Terdaftar</label>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/sppbtlgaji/addsppbtl.js"></script>  