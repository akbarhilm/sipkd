...
<ul class="breadcrumb">
    ...
    <li><a href="#">SPP BTL PENGHASILAN</a></li>
</ul>
<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Daftar SPP BTL PENGHASILAN</div>
        <div class="actions">
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/sppbtlgaji/sppbtl.js"></script>  
