...
<form:form  method="post" commandName="refsppgu"  id="refsppgu"   action="${pageContext.request.contextPath}/sppgu/prosessimpan" class="form-horizontal">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input path="totalAngaran" id="totalAngaran" cssClass="required inputinvoice"    size="25"   readonly='true'  /> 
                         ...
                         <div class="form-group">
                <label class="col-md-3 control-label">Total SPP UP/GU:</label>
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input path="totalSpp" id="totalSpp" value="${totalSpp}" cssClass="required inputinvoice"    size="25"   readonly='true'  /> 
                    </div>
                </div>
            </div>
                    <div class="form-group">
                <label class="col-md-3 control-label">Total SPJ:</label>
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input path="totalSpj" id="totalSpj" value="${totalSpj}" cssClass="required inputinvoice"    size="25"   readonly='true'  /> 
                    </div>
                </div>
            </div>
                     <div class="form-group">
                <label class="col-md-3 control-label">Pagu SPP Saat Ini:</label>
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input path="nilaiSisaPaguSpp" id="nilaiSisaPaguSpp" value="${nilaiSisaPaguSpp}" cssClass="required inputinvoice"    size="25"   readonly='true'  /> 
                    </div>
                </div>
            </div>
            <div class="form-group">
