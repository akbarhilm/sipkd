...
<ul class="breadcrumb">
    ...
    <li><a href="#">  SPP GU</a></li>
</ul>
<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Daftar  SPP GU  </div>
        <div class="actions">
            <a id="alamattambah" href="#" onclick="pindahhalamanadd()" class="btn dark"><i class="icon-plus"></i> Tambah</a>  
        </div>
    </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/sppgu/sppgu.js"></script>  
