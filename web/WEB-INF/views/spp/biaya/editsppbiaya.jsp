...
<form:form  method="post" commandName="refsppbiaya"  id="refsppbiaya" onsubmit="return cek()"  action="${pageContext.request.contextPath}/biaya/prosesupdate" class="form-horizontal">
