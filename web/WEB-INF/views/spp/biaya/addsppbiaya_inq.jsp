...
<form:form  method="post" commandName="refsppbiaya"  id="refsppbiaya"   action="${pageContext.request.contextPath}/biaya/prosessimpan" class="form-horizontal">
        ...
        <div class="portlet-body flip-scroll">
            <div class="col-md-7">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <div class="input-group">
                            <form:input   path="nomorRekBank" id="nomorRekBank"  cssClass="required ruleCekCIF111" onchange="getDataBankDki()" onkeypress="return isNumber(event)"  size="31" maxlength="30"  />  
                ...
                <div class="form-group" >
                    ...
                    <div class="col-md-7">
                        <div class="input-group">
                            <form:input   path="namaYayasan" id="namaYayasan"  cssClass="required ruleCekNamaBantuan"  size="45" maxlength="50"   />  
