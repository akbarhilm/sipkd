...
<ul class="breadcrumb">
    ...
    <li><a href="#">Tambah  SPP BTL BANTUAN</a></li>
</ul>
<div  ${pesan != null ?"class='alert alert-success'":""}   >${pesan}</div>
<form:form  method="post" commandName="refsppbantuan"  id="refsppbantuan"   action="${pageContext.request.contextPath}/sppbantuan/prosessimpan" class="form-horizontal">
        ...
        <div class="portlet-body flip-scroll">
            <div class="col-md-7">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            <form:hidden path="skpd.idSkpd" id='idskpd' readnoly="true"  value="${idskpdd}"  />
                            <form:hidden path="idskpdkoor" id='idskpdkoor' readnoly="true"    />
                            <form:input path="namaSkpdKoor" id="namaSkpdKoor"  cssClass="required" value="${namaSkpdKoor}"   type="text" size="55" maxlength="80" readonly='true'  />
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <form:input   path="kodeBankTransfer" id="kodeBankTransfer"  cssClass="required"   size="10" maxlength="7" onchange="getDataBankDki()" readonly="true" />  &nbsp;<a  class="fancybox fancybox.iframe btn green" href="${pageContext.request.contextPath}/kontrak/listbankinduk?target='_top'" title="Pilih Bank"  ><i class="icon-zoom-in"></i> Pilih</a> 
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            <form:input   path="rekeningBank" id="rekeningBank" cssClass="required ruleCekCIF111" onchange="getDataBankDki()" onkeypress="return isNumber(event)" size="45" maxlength="50"   />  
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            <!-- ruleCekNamaBantuan -->
                            <form:input   path="namaPenerima" id="namaPenerima"  cssClass="required ruleCekNamaBantuan"   size="50" maxlength="55"   />  
    ...
    <div class="portlet box red">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <form:hidden path="idSpd" id='idSpd' readonly="true"   />
                        <form:hidden path="idBtlBantuan" id='idBtlBantuan'   />
                        <form:input  path="noSpd" id="noSpd"  size="5"  readonly="true" required="true"   />  
                        <span id='noSpd'></span>
                        &nbsp;<a class="fancybox fancybox.iframe btn dark" href="${pageContext.request.contextPath}/sppbantuan/listspdpopup/${refsppbantuan.skpd.idSkpd}?target='_top" title="Pilih SPD"><i class="icon-zoom-in"></i> Pilih</a>
                    </div>
                </div>  
            </div>      
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <form:input path="kegiatan.namaKegiatan" id="namaKegiatan" type="text" size="68"  readonly='true' required="true"   /> 
                    </div>
                </div>
            </div>    
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <form:input path="akun.namaAkun" id="namaAkun" type="text" size="68" readonly='true' required="true"  />  
                    </div>
                </div>
            </div>     
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input path="nilaiSpd" id="nilaiSpd" type="text" size="25"   maxlength="20"  readonly="true" /> 
                    </div>
                </div>
            </div> 
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input path="nilaiSpp" id="nilaiSpp"  onblur="hitungnilaisppsisa(this.value)" size="25" cssClass="inputinvoice required" /> 
                    </div>
                </div>
            </div> 
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <span id="nilaiSppSisaAkhir"></span>
                        <form:hidden path="nilaiSppSisa" id="nilaiSppSisa"   value="0" /> 
                    </div>
                </div>
            </div> 
