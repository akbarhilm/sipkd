...
<form:form  method="post" commandName="refsppbantuan"  id="refsppbantuan"  onsubmit="return cek()" action="${pageContext.request.contextPath}/sppbantuan/prosessimpan" class="form-horizontal">
            ...
            <div class="col-md-7">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <!-- onchange => getDataBankDki() -->
                            <form:input   path="kodeBankTransfer" id="kodeBankTransfer" onchange="getDataBankDki()" cssClass="required"   size="10" maxlength="7" readonly="true" />  &nbsp;<a  class="fancybox fancybox.iframe btn green" href="${pageContext.request.contextPath}/kontrak/listbankinduk?target='_top'" title="Pilih Bank"  ><i class="icon-zoom-in"></i> Pilih</a> 
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            <!-- ruleCekCIF111 -->
                            <form:input   path="rekeningBank" id="rekeningBank" cssClass="required " onchange="getDataBankDki()" onkeypress="return isNumber(event)" size="45" maxlength="50"   />  
