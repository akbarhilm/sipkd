...
<ul class="breadcrumb">
    ...
    <li><a href="#">Ubah  SPP UP</a></li>
</ul>
<div  ${pesan != null ?"class='alert alert-success'":""}   >${pesan}</div>
<form:form  method="post" commandName="refsppup"  id="refsppup"   action="${pageContext.request.contextPath}/sppup/prosesupdate" class="form-horizontal">
    <div class="portlet box red">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input   path="nipPptk" id="nipPptk"  cssClass="required" number='true' maxlength='18'  minlength='16'   size="30"     />  
        ...
        <table id="spprincitable" class="table table-striped table-bordered table-condensed table-hover " >
            ...
            <tfoot>
                <tr>
                    ...
                    <th>
                        <form:input path="totalSpp" id="totalSpp" type="text"  readonly='true' class="inputmoney" cssClass="required  cekPaguUp"  style='border:none;margin:0;width:99%; text-align:right;' />
