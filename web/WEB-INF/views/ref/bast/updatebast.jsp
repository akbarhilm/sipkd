    ...
    <div class="portlet-body flip-scroll">
        ...
        <form:form  method="post" commandName="spdBTLMaster"  id="spdBTLMasterform"   action="${pageContext.request.contextPath}/bast/updatebast" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group">
                        ...
                        <form:hidden path="idKegAwal" id='idKegAwal' />
                        <form:hidden path="idkegiatan" id='idkegiatan' readonly='true' value="${idkegiatan}" onchange="gridakun();getbanyakakun();getsisabast();getKodeUMK()"  />
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group">
                        <input type="text" name="sisaBast" id="sisaBast" readonly='true' size="30"/>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group" id="labelUMK">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <input type="checkbox" name="cbUMK" id="cbUMK" onclick="setUMK(), ceknilaientry()" /> &nbsp; &nbsp; *Transaksi sebagai UMK, Bukan Potongan UMK
