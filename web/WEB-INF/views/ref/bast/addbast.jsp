    ...
    <div class="portlet-body flip-scroll">
        ...
        <form:form  method="post" commandName="progcmd"  id="spdBTLMasterform"   action="${pageContext.request.contextPath}/bast/simpanbast" class="form-horizontal">         
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group">
                        ...
                        <form:input   path="akun.namaAkun" id="namaAkun"   size="82" cssClass="required"   />  
                        <form:errors path="idAkun" class="error" />
                        &nbsp;  &nbsp;<a class="fancybox fancybox.iframe btn dark" id="popupakun" href="${pageContext.request.contextPath}/bast/listpopupakun/?target='_top" title="Pilih Akun"><i class="icon-zoom-in"></i> Pilih</a>
                    </div>
                </div>  
            </div>   
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input   path="nilaiBast" id="nilaiBast"    size="25" maxlength="20" class="inputinvoice"  />  
