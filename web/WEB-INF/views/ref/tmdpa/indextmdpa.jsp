        ...
        <form:form  method="post" commandName="cmdTmdpa"  id="spdBTLMasterform"   action="${pageContext.request.contextPath}/refftmdpa/updatetmdpa" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    <a  class="fancybox fancybox.iframe btn dark" href="${pageContext.request.contextPath}/refftmdpa/skpdlistpopup?target='_top'" title="Pilih SKPD"  ><i class="icon-zoom-in"></i> Pilih</a>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input id="namaPa" path="namaPA" size="35" maxlength="50" class="m-wrap large"  />
                    </div>
                </div>
            </div>
            </div>
            ...
            <div id="bendaharaholder">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                <form:input id="namaBenPg" path="namaBenPg" size="35" maxlength="50"  class="m-wrap large"  />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                <form:input id="namaBenPgBantuan" path="namaBenPgBantuan" maxlength="50" size="35"  class="m-wrap large"  />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                <form:input id="namaBenPgBtt" path="namaBenPgBTT" maxlength="50" size="35"  class="m-wrap large"  />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                <form:input id="namaBenPgPembiayaan" path="namaBenPgPembiayaan" maxlength="50" size="35"  class="m-wrap large"  />
                            </div>
                        </div>
                    </div></div>
                    <br>        
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                <form:input id="namaVerifikatorPg" path="namaVerifikatorPg" maxlength="50" size="35"  class="m-wrap large"  />
                            </div>
                        </div>
                    </div>
                ...
                <div id="bendaharalistcpen1">   <br><br>    
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                <form:input id="namaBenPn" path="namaBenPn" size="35" maxlength="50"  class="m-wrap large"  />
                            </div>
                        </div>
                    </div>
                    <br>        
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                <form:input id="namaVerifikatorPn" path="namaVerifikatorPn" maxlength="50" size="35"  class="m-wrap large"  />
                            </div>
                        </div>
                    </div>
                </div>
