...
<div class="portlet box red">
    ...
    <div class="portlet-body flip-scroll">
         <form:form  method="post" commandName="spdBTLMaster"  id="spdBTLMasterform"  action='${pageContext.request.contextPath}/rekanan/deleterekanan' class="form-horizontal">
                    <div class="form-group">
                <label class="col-md-3 control-label">Kode Rekanan:</label>
                <div class="col-md-4">
                    <form:hidden path="idRekanan" id='idRekanan'     />                  
                    <form:input path="kodeRekanan" id="kodeRekanan" type="text" size="6" maxlength="6" readOnly="true"   /> 
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input readOnly="true"  path="idRekananAkte" id="idRekananAkte"    size="40"   />  
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input   readOnly="true" path="idRekananNpwp" id="idRekananNpwp"    size="40"   />  
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input  readOnly="true" path="namaRekanan" id="namaRekanan" size="40"   />  
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input readOnly="true"  path="alamatRekanan" id="alamatRekanan"    size="55"  />  
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input readOnly="true"  path="namaDirekturRekanan" id="namaDirekturRekanan"    size="40"   />  
