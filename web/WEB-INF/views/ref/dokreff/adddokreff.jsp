...
<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Form Tambah Dokreff</div>       
    </div>
    <div class="portlet-body flip-scroll">
        <form:form  method="post" commandName="fungsicmda"  id="spdBTLMasterform"   action="${pageContext.request.contextPath}/dokreff/simpandokreff" class="form-horizontal">
