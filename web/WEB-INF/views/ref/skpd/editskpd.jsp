...
<ul class="breadcrumb">
    ...
    <li>
        <a href="${pageContext.request.contextPath}/refskpd/index"  >Index SKPD</a>
        <span class="icon-angle-right"></span>
    </li>
    <li><a href="#">Edit SKPD<span id='statusaddedit'></span></a></li>
</ul>
<div class="portlet box red">

    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Form Edit SKPD </div>       
    </div>
    <div class="portlet-body flip-scroll">

        <form:form  method="post" commandName="spdBTLMaster"  id="spdBTLMasterform"   action="${pageContext.request.contextPath}/refskpd/editskpds" class="form-horizontal">         
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input   path="idInduk" id="idInduk"    size="10" maxlength="50" readonly="true"    />  
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input   path="kodeSkpd" id="kodeSkpd"    size="55" maxlength="50" readonly="true"   />  
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input   path="kodeKelurahan" id="kodeKelurahan"    size="4" maxlength="50"   />  
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input   path="kodeKecamatan" id="kodeKecamatan"    size="4" maxlength="50"   />  
            ...
            <div class="form-actions fluid">
                <div class="col-md-offset-3 col-md-9">
                    <button id="buttoninduk"   type="submit" class="btn blue" onclick="closepopup()"> Edit </button>
...
<script>
    ...
    function maskkodeskpd() {
        ...
        if (arrskpd.length == 1); {
            ...
            $("#kodeSkpd").mask(arrskpd[0] + "." + arrskpd[1] + ".099");
