...
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            <input type="text"  name="urusan"  id="urusan"   title="klik enter atau tekan tombol cari untuk melakukan pencarian"  class="form-control " size="30" 
    ...
    <div class="portlet box">
        ...
        <script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/referensi/listurusan.js"></script>  