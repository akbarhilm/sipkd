...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bku/listkegiatanSetoranTU.js"></script>    
...
<script type="text/javascript">
    ...
    function ambilskpd(id) {
        ...
        $('#idspdKegpop', window.parent.document).val($("#idspd" + id).val()).change();
        $('#idKegpop', window.parent.document).val($("#idkegiatan" + id).val()).change();
        
        $('#namakegiatan', window.parent.document).val($("#ket" + id).val()).change();
