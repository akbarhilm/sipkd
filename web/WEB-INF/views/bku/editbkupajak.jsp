        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group">
                        ...
                        <form:hidden path="noBkuPj" id='noBkuPj'  />
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <form:select path="kodeTransaksi" id="kodeTransaksi" onchange="getSisaPajak()" disabled="true">
            ...
            <div id="labelkegiatanpajak" class="form-group">
                ...
                <div class="col-md-9">
                    ...
                    <!-- &nbsp;<a  class="fancybox fancybox.iframe btn green" id="pilihKegPajak" onclick="ambilketerangan()" href="${pageContext.request.contextPath}/bku/listkegiatan?target='_top'" title="Pilih Kegiatan"  ><i class="icon-zoom-in"></i> Pilih</a> -->
            ...
            <div id="labeljenisbayar" name="labeljenisbayar" class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <select name="jenisPembayaran" id="jenisPembayaran" onchange="jenisBayar()" disabled="true">
            ...
            <div id="labelpengeluaran" name="labelpengeluaran" class="form-group">
                ...
                <div class="col-md-4">
                    <form:input type="text" path="nilaiBku"  id="nilaiBku" readOnly="true"/>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bku/editbkupajak.js"></script>  
