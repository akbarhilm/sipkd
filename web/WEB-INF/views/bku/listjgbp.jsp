...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bku/listjgbp.js"></script>    

<script type="text/javascript">
    $(document).ready(function() {
        jenistrans = $('#jenisTransaksi', window.parent.document).val();
    ...
    function ambilskpd(id) {
        ...
        $('#pengeluaran', window.parent.document).val($("#nilaiterima" + id).val()).change();
        $('#jenisbpjs', window.parent.document).val($("#idbas" + id).val()).change();
...
<form:form   method="post" commandName="refkegiatan"  id="refkegiatan"   action="" class="form-horizontal">
    <div class="portlet box red">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Daftar Penerimaan</div>
        </div>
