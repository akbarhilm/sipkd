...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bku/listakun.js"></script>    

<script type="text/javascript">
    $(document).ready(function() {
        ketsaldoawal = $('#keteranganSA', window.parent.document).val(); //window.localStorage.getItem("ketSaldoAwal");
        //console.log("ket Saldo Awal = "+ketsaldoawal);
        tampil();
    });
    ...
    function ambilskpd(id) {
        $('#keteranganAkunLain', window.parent.document).val($("#ket" + id).val()).change();
        $('#kodeAkunLain', window.parent.document).val($("#kode" + id).val()).change();
        $('#idbaslain', window.parent.document).val(id).change();
