...
<script type="text/javascript">
    ...
    function setNoBku() {
        ...
        //window.localStorage.setItem("ketBeban", "UP");
    }
</script>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <div class="input-group" id="nobuktiketerangan">
                        <form:input path="noBukti" id="noBukti" type="text"  size="55" readonly="true" /> &nbsp;<a  class="fancybox fancybox.iframe btn green" id="pilihAkunLain" onclick="setNoBku()" href="${pageContext.request.contextPath}/bku/liststbl?target='_top'" title="Pilih Setoran"  ><i class="icon-zoom-in"></i> Pilih</a> 
                    </div>
                </div>  
            </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bku/editbkustup.js"></script>  
