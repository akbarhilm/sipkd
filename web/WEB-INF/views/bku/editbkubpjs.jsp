...
<form:form   method="post" commandName="refbku"  id="refbku"   action="${pageContext.request.contextPath}/spj/prosessimpan" class="form-horizontal">
    <div onload="" class="portlet box red">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group">
                        ...
                        <form:hidden path="kodeKoreksi" id='kodeKoreksi' value="0"  />
                    </div>
                </div>
            </div>  
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <form:select path="bulan" id='bulan' onchange="keteranganBulan()">
            ...
            <div id="labelsaldobpjs" name="labelsaldobpjs"  class="form-group" style="display: none">
            ...
            <div class="form-group" id="labelSA" style="display: none">
                <label class="col-md-3 control-label">Saldo Awal :</label>
                <div class="col-md-4">
                    <div class="input-group">
                        <input type="checkbox" name="cbSA" id="cbSA" onclick="" disabled="true"/> 
                    </div>
                </div>  
            </div>

            <div id="labelpengeluaran" name="labelpengeluaran" class="form-group">
                <label class="col-md-3 control-label">Nilai BPJS :</label>
                <div class="col-md-4">
                    <input name="pengeluaran" id="pengeluaran" type="text" onchange="setformatpengeluaran(this.value)"  />  &nbsp <a  class="fancybox fancybox.iframe btn green" id="pilihjgbp"  href="${pageContext.request.contextPath}/bku/listterimajgbp?target='_top'" title="Pilih Penerimaan"  ><i class="icon-zoom-in"></i> Pilih</a> 
    ...
    <div class="form-actions fluid">
        <div class="col-md-offset-3 col-md-9" align="Right">
            <button type="button" class="btn blue" onclick='cekupdate()'>Simpan</button>
            <a class="btn blue"  href="${pageContext.request.contextPath}/bku/indexbku" >Kembali</a>
        </div>
    </div>                    
</form:form>
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bku/editbkubpjs.js"></script>  
