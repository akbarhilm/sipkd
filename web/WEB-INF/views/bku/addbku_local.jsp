...
<script type="text/javascript">
    ...
    function ambilketerangan() {
        ...
        if (jenistrans.substr(0, 1) == "P") {
            ketcombo = "SPJ";
            $('#ketJenisPajak').val($('#jenisTransaksi').val());
            //window.localStorage.setItem("ketJenisPajak", $('#jenisTransaksi').val());
        }
         ...
         */
        $('#keteranganKeg').val(ketcombo);
        $('#ketCaraBayar').val($("#kodePembayaran").val());

    }

    function ketsaldoawal() {
        // window.localStorage.setItem("ketSaldoAwal", ketSaldoAwal);
        $('#keteranganSA').val(ketSaldoAwal);
    }
...
<form:form   method="post" commandName="refbku"  id="refbku"   action="${pageContext.request.contextPath}/spj/prosessimpan" class="form-horizontal">
        ...
        <div class="portlet-body flip-scroll">
            <div class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    <input type="hidden" id="noBKU" name="noBKU"  value="-999" >
                    <input type="hidden" id="keteranganSA" name="keteranganSA" >

                    <input type="hidden" id="ketJenisPajak" name="ketJenisPajak" >
                    <input type="hidden" id="keteranganKeg" name="keteranganKeg" >
                    <input type="hidden" id="ketCaraBayar" name="ketCaraBayar" >
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group">
                        ...
                        <form:hidden path="kodeWilayah" id='namaskpd' value="${pengguna.kodeProses}"  />
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <input type="hidden" id="stjenis"  value="" onchange=""/>
                        <input type="hidden" id="stbeban"  value="" onchange="setST()"/>

                        <input type="hidden" id="idspd"  value="" onchange=""/>
                        <input type="hidden" id="nosetor"  value="" onchange="setgridst();
                                setST()"/>
                        <input type="hidden" id="kodeSA"  value="" onchange=""/>
                        ...
                        <!-- <input type="hidden" id="kodeAnggSekolah" name="kodeAnggSekolah"  onchange="" > -->
                    </div>
                </div>  
            </div>
            ...
            <div id="labeljenisbpjs" name="labeljenisbpjs" class="form-group">
                <label class="col-md-3 control-label">Jenis BPJS :</label>
                <div class="col-md-4">
                    <div class="input-group">
                        <select name="jenisbpjs" id="jenisbpjs" onchange="getSaldoAawalJGBP()" >
                            <option value="3911">BPJS Kesehatan</option> 
                            <option value="3912">BPJS Ketenagakerjaan</option>
                        </select>
                    </div>
                </div>  
            </div>
            ...
            <div id="labelakunlainlain" class="form-group">
                ...
                <div class="col-md-9">
                    <input type="text" name="keteranganAkunLain"  id="keteranganAkunLain"  class="m-wrap large" size="80" readOnly="true"/>  &nbsp;<a  class="fancybox fancybox.iframe btn green" id="pilihAkunLain" onclick="ketsaldoawal()" href="${pageContext.request.contextPath}/bku/listakun?target='_top'" title="Pilih Kegiatan"  ><i class="icon-zoom-in"></i> Pilih</a> 
            ...
            <div id="labelkegiatanspj" class="form-group">
                ...
                <div class="col-md-9">
                    <input type="text" name="keteranganKegPop"  id="keteranganKegPop"  class="m-wrap large" size="80" readOnly="true"/>  &nbsp;<a  class="fancybox fancybox.iframe btn green" id="pilihKegSpj" onclick="ambilketerangan()" href="${pageContext.request.contextPath}/bku/listkegiatan?target='_top'" title="Pilih Kegiatan"  ><i class="icon-zoom-in"></i> Pilih</a> 
            ...
            <div id="labelkegiatannm" class="form-group">
                <label class="col-md-3 control-label">Kegiatan :</label>
                <div class="col-md-9">
                    <input type="text" name="keteranganKegPopNm"  id="keteranganKegPopNm"  class="m-wrap large" size="80" readOnly="true"/>  &nbsp;<a  class="fancybox fancybox.iframe btn green" id="pilihKegNM"  href="${pageContext.request.contextPath}/bku/listkegiatannm?target='_top'" title="Pilih Kegiatan"  ><i class="icon-zoom-in"></i> Pilih</a> 
            ...
            <div id="labelkegiatannp" class="form-group">
                <label class="col-md-3 control-label">Kegiatan :</label>
                <div class="col-md-9">
                    <input type="text" name="keteranganKegPopNp"  id="keteranganKegPopNp"  class="m-wrap large" size="80" readOnly="true"/>  &nbsp;<a  class="fancybox fancybox.iframe btn green" id="pilihKegNP"  href="${pageContext.request.contextPath}/bku/listkegiatannp?target='_top'" title="Pilih Kegiatan"  ><i class="icon-zoom-in"></i> Pilih</a> 
            ...
            <div id="labelkegiatanpajak" class="form-group">
                <label class="col-md-3 control-label">Kegiatan :</label>
                <div class="col-md-9">
                    <input type="text" name="keteranganKegPopPj"  id="keteranganKegPopPj"  class="m-wrap large" size="80" readOnly="true"/>  &nbsp;<a  class="fancybox fancybox.iframe btn green" id="pilihKegPajak" onclick="ambilketerangan()" href="${pageContext.request.contextPath}/bku/listpajakterima?target='_top'" title="Pilih Kegiatan"  ><i class="icon-zoom-in"></i> Pilih</a> 
                    <input type="hidden" id="idKegiatanPajak" name="idKegiatanPajak"  value="" >
                    <input type="hidden" id="kodeKegPajak" name="kodeKegPajak"  value="">
                    <input type="hidden" id="bayarPajak" name="bayarPajak"  value="" onchange="">
                    <input type="hidden" id="bebanPajak" name="bebanPajak"  value="" onchange="setjenisbebanpj()">
                    <input type="hidden" id="jenisPajak" name="jenisPajak"  value="" onchange="setjenisbebanpj()">
                    <input type="hidden" id="nobkupn" name="nobkupn"  value="" onchange="gridpgpajak()">
                </div>
            </div>

            <div id="labelkegiatansb" class="form-group">
                <label class="col-md-3 control-label">Kegiatan :</label>
                <div class="col-md-9">
                    <input type="text" name="keteranganKegPopSb"  id="keteranganKegPopSb"  class="m-wrap large" size="80" readOnly="true"/>  &nbsp;<a  class="fancybox fancybox.iframe btn green" id="pilihKegSb" onclick="ambilketerangan()" href="${pageContext.request.contextPath}/bku/listkegiatansetoran?target='_top'" title="Pilih Kegiatan"  ><i class="icon-zoom-in"></i> Pilih</a> 
                    <input type="hidden" id="idKegiatanSb" name="idKegiatanSb"  value="" >
                    <input type="hidden" id="kodeKegSb" name="kodeKegSb"  value="">
                </div>
            </div>
            ...
            <div id="labelsisapajak" name="labelsisapajak"  class="form-group">
                <label class="col-md-3 control-label">Saldo Awal Pajak :</label>
                <div class="col-md-4">
                    <div class="input-group">
            ...
            <div class="form-group" id="labelSAPajak">
            ...
            <div id="labelsaldobpjs" name="labelsaldobpjs"  class="form-group">
                <label class="col-md-3 control-label">Saldo BPJS :</label>
                <div class="col-md-4">
                    <div class="input-group">
                        <input name="saldobpjs" id="saldobpjs" type="text" readonly="true"/>
                    </div>
                </div>  
            </div>
            ...
            <div id="labelpengeluaran" name="labelpengeluaran" class="form-group">
                ...
                <div class="col-md-4">
                    <input name="pengeluaran" id="pengeluaran" type="text" onchange="setformatpengeluaran(this.value)" readonly=""/> &nbsp <a  class="fancybox fancybox.iframe btn green" id="pilihjgbp"  href="${pageContext.request.contextPath}/bku/listterimajgbp?target='_top'" title="Pilih Penerimaan"  ><i class="icon-zoom-in"></i> Pilih</a> 
    ...
    <div id="mygrid" class="portlet box">
        ...
        <div id="tabelPNPJ" class="portlet-body">

            <table id="pnpajaktable" class="table table-striped table-bordered table-condensed table-hover " >
                <thead>
                    <tr>
                        <th>No</th>
                        <th>No Bku Ref</th>
        ...
        <div id="tabelStBl" class="portlet-body">

            <table id="stbltable" class="table table-striped table-bordered table-condensed table-hover " >
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Kegiatan</th>
        ...
        <div id="tabelStBtl" class="portlet-body">

            <table id="stbtltable" class="table table-striped table-bordered table-condensed table-hover " >
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Akun</th>
