        ...
        <div class="portlet-body flip-scroll">
           ...
           <div id="labelpengeluaran" name="labelpengeluaran" class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    <input name="pengeluaran" id="pengeluaran" type="text" onchange="setformatpengeluaran(this.value)" onkeypress="return isNumber(event)"/>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bku/editbkukasmasuk.js"></script>  
