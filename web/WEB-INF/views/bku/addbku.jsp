    ...
    <div onload="" class="portlet box red">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group">
                        ...
                        <form:hidden path="kodeWilayah" id='kodewil' value="${pengguna.kodeProses}"  />
            ...
            <div id="labelpengeluaran" name="labelpengeluaran" class="form-group">
                ...
                <div class="col-md-4">
                    <input name="pengeluaran" id="pengeluaran" type="text" onchange="setformatpengeluaran(this.value)" readonly="" onkeypress="return isNumber(event)"/> &nbsp <a  class="fancybox fancybox.iframe btn green" id="pilihjgbp"  href="${pageContext.request.contextPath}/bku/listterimajgbp?target='_top'" title="Pilih Penerimaan"  ><i class="icon-zoom-in"></i> Pilih</a> 
