            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <div class="input-group" id="nobuktiketerangan" >
                        <form:input path="noBukti" id="noBukti" type="text"  size="55" readonly="true" onchange="gridstbtl()"/> &nbsp;<a  class="fancybox fancybox.iframe btn green" onclick="setNoBku()" id="pilihAkunLain" href="${pageContext.request.contextPath}/bku/liststbtl?target='_top'" title="Pilih Setoran"  ><i class="icon-zoom-in"></i> Pilih</a> 
                    </div>
                </div>  
            </div> 
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bku/editbkustbtl.js"></script>  
