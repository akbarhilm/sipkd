...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bku/listkegiatan.js"></script>    

<script type="text/javascript">
    $(document).ready(function() {
        ketval = $('#keteranganKeg', window.parent.document).val();//window.localStorage.getItem("keteranganKeg");
        ketcarabayar = $('#ketCaraBayar', window.parent.document).val(); //window.localStorage.getItem("ketCaraBayar");
        ketjenistrx = $('#jenisTransaksi', window.parent.document).val();
        console.log("ketjenistrx = "+ketjenistrx);
        tampil();
    });
    ...
    function ambilskpd(id) {
        //$('#kodeAnggSekolah', window.parent.document).val($("#kodeanggsekolah" + id).val()).change();
