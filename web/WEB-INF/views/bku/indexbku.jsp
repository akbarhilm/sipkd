...
<ul class="breadcrumb">
    ...
    <li><a href="#">Entry Buku Kas Umum - Pengeluaran</a></li>
</ul>
...
<form:form   method="post" commandName="refbku"  id="refbku"   action="${pageContext.request.contextPath}/spj/prosessimpan" class="form-horizontal">
    <div onload="" class="portlet box red">
        <div class="portlet-title">
            ...
            <div class="actions">
                <a onclick="ambilbulan()" href="${pageContext.request.contextPath}/bku/addbku"  class="btn dark"  ><i class="icon-plus"></i> Tambah</a> 
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <select path="bulan" id="bulan" onchange="getTotal(), cekgrid()">
    ...
    <div class="portlet box">
        <div class="portlet-body" id="tabelindex">
        ...
        <div class="portlet-body" id="tabelindexppkd">
            <table id="jourtableppkd" class="table table-striped table-bordered table-condensed table-hover " >
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Tanggal</th>
                ...
                <tfoot id="jourtablefootppkd" >
                    <tr>
                        <th colspan="7" style="text-align:right">Jumlah sampai periode ini : </th>

                        <th colspan="1">
                            <input  type='text' id="totmasukppkd"  name="totmasuk" readonly="true" style='border:none;margin:0;width:90%;text-align: right'    />
                        </th>
                        <th colspan="1" >
                            <input type='text' id="totkeluarppkd"   name="totkeluar" readonly="true" style='border:none;margin:0;width:90%;text-align: right'    />
                        </th> 
                        <th colspan="1">
                            <input  type='text' id="totsaldokasppkd"  name="totsaldokas" readonly="true" style='border:none;margin:0;width:90%;text-align: right'    />
                        </th>
