...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bku/listSetoran.js"></script>    

<script type="text/javascript">
    $(document).ready(function() {
        bebanval = $('#beban', window.parent.document).val(); //window.localStorage.getItem("ketBeban");
        jenisval = $('#jenis', window.parent.document).val(); //window.localStorage.getItem("ketJenis");
        nobkuval = $('#noBKU', window.parent.document).val(); //window.localStorage.getItem("ketNoBku");
        tampil();
    });
    ...
    function ambilskpd(id) {
        $('#stjenis', window.parent.document).val($("#jenis" + id).val()).change();
        $('#stbeban', window.parent.document).val($("#beban" + id).val()).change();
        ...
        $('#kodeSA', window.parent.document).val($("#kodesa" + id).val()).change();
