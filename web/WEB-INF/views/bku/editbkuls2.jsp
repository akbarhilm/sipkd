    ...
    <div onload="" class="portlet box red">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div id="labelkegiatansb" class="form-group">
                ...
                <div class="col-md-9">
                    <form:input path="ketKegiatan" id="ketKegiatan" type="text"  class="required " size="80" readOnly="true"  />  
                    <!-- &nbsp;<a  class="fancybox fancybox.iframe btn green" id="pilihKegSb" onclick="ambilketerangan()" href="${pageContext.request.contextPath}/bku/listkegiatansetoran?target='_top'" title="Pilih Kegiatan"  ><i class="icon-zoom-in"></i> Pilih</a> -->
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:select id="beban" path="beban" disabled="true" readonly="true" >
                            <form:option value="UP" >UP/GU/TU</form:option> 
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bku/editbkuls2.js"></script>  
