        ...
        <div class="portlet-body flip-scroll">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <select id="jenislaporan" name="jenislaporan" onchange="setpanel(this.value)">
                            <option value="1" selected>1 - Jurnal Umum SKPD By No Jurnal</option> 
                            <option value="2">2 - Jurnal Umum SKPD By Akun</option>
                            <option value="3">3 - Jurnal SKPD</option> 
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 col-md-9">
                    ...
                    <!-- -->
                    <a id="pilihnojur"  class="fancybox fancybox.iframe btn dark" href="#" title="Pilih Nomor Jurnal"  ><i class="icon-zoom-in"></i> Pilih</a>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/laporanskpd11/laporanskpd11.js"></script>  
