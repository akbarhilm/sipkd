...
<div class="portlet box red">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Daftar  NPD</div>
        <div class="actions">
            <a href="#" onclick="pindahhalaman()" class="btn dark" id="tambahnpd"><i class="icon-plus"></i> Tambah</a> 
        </div>
    </div>
    ...
    <div class="portlet box">
        <form id="formpagusppgup">
            ...
            <div class="portlet-body">
                <table id="npdspjtable" class="table table-striped table-bordered table-condensed table-hover " >
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>No NPD</th>
    ...
    <script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/npd/indexnpd.js"></script>  
