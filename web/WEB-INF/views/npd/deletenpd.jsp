...
<form:form  method="post" commandName="npd"  id="npd"   action="${pageContext.request.contextPath}/npd/prosesdelete" class="form-horizontal">
    <div class="portlet box red">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input type="text" name="tanggalNpd" path="tanggalNpd" readOnly="true" id="tanggalNpd" class="required" size="14" value=""/>
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group">
                        <form:input path="nipPptk" id="nipPptk" readOnly="true" cssClass="required"   type="text" size="55" maxlength="80" />
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group">
                        <form:input path="namaPptk" id="namaPptk"  readOnly="true" cssClass="required"   type="text" size="55" maxlength="80" />
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    ...
                    <form:input path="kegiatan.namaKegiatan"  cssClass="required" id="namaKegiatan" type="text" size="75" maxlength="275" readonly='true' />
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <form:input path="ketNpd" id="ketNpd" type="text" size="55" maxlength="55"  readOnly="true"/> 
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/npd/deletenpd.js"></script>  