    ...
    <div onload="" class="portlet box red">
        ...
        <div class="portlet-body flip-scroll">
           ...
           <div id="labelakunlainlain" class="form-group">
                ...
                <div class="col-md-9">
                    <input type="text" name="keteranganAkunLain"  id="keteranganAkunLain"  class="m-wrap large" size="80" readOnly="true"/>  &nbsp;<a  class="fancybox fancybox.iframe btn green" id="pilihAkunLain" onclick="" href="${pageContext.request.contextPath}/bku2016/listakun?target='_top'" title="Pilih Kegiatan"  ><i class="icon-zoom-in"></i> Pilih</a> 
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bku2016/editbkulainlain.js"></script>  
