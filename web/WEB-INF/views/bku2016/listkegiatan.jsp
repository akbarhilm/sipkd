...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bku2016/listkegiatan.js"></script>    
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        ketcarabayar = window.localStorage.getItem("ketCaraBayar");
        console.log("ket carabayar = "+ketcarabayar);
        //console.log("list keg, ket val = "+ketval);
        tampil();
    });
