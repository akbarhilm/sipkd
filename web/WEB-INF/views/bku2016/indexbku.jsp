...
<form:form   method="post" commandName="refbku"  id="refbku"   action="${pageContext.request.contextPath}/spj/prosessimpan" class="form-horizontal">
    <div onload="" class="portlet box red">
        <div class="portlet-title">
            ...
            <div class="actions">
                <a onclick="ambilbulan()" href="${pageContext.request.contextPath}/bku2016/addbku"  class="btn dark"  ><i class="icon-plus"></i> Tambah</a> 
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <select path="bulan" id="bulan" onchange="getTotal(), gridbku()">
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bku2016/indexbku.js"></script>  
