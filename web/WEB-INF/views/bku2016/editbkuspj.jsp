    ...
    <div onload="" class="portlet box red">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div id="labelcarabayar" name="labelcarabayar" class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:select path="kodePembayaran" id="kodePembayaran" onchange="setPembayaran(this.value)">
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bku2016/editbkuspj.js"></script>  
