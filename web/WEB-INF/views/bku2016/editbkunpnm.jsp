    ...
    <div onload="" class="portlet box red">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <form:input type="text" path="ketKegiatan"  id="ketKegiatan"  class="m-wrap large" size="80" readOnly="true"/>  &nbsp;<a  class="fancybox fancybox.iframe btn green" id="pilihKeg" href="" title="Pilih Kegiatan"  ><i class="icon-zoom-in"></i> Pilih</a> 
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bku2016/editbkunpnm.js"></script>  
