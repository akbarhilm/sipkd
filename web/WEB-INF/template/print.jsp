...
<head>
 ...
 <!--  <meta content="Diskominfomas Pemprov DKI Jakarta" name="author" />-->
   ...
   <link href="${pageContext.request.contextPath}/static/assets/css/print.css" rel="stylesheet" type="text/css" media="print"/>
   ...
   <link href="${pageContext.request.contextPath}/static/assets/css/pages/invoice.css" rel="stylesheet" type="text/css"/>
