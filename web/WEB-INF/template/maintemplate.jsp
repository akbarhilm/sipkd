...
<!--[if !IE]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    <head>
        ...
        <!-- BEGIN THEME STYLES -->
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/assets/css/pages/image-popup.css" />
                    ...
                    <ul class="nav navbar-nav">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <c:if test="${skpd.levelSkpd == '3'}">
                                                <li><a href="${pageContext.request.contextPath}/sppbantuan/indexsppbantuan">BANTUAN</a></li>
                                                <li><a href="${pageContext.request.contextPath}/biaya/listbiaya">BIAYA</a></li>
                                                </c:if>
                                        </ul>
                                    </li>
                        ...
                        <c:if test="${pengguna.kodeGrup == '8'}">
                            <li  >
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="${pageContext.request.contextPath}/halamanpostdata/teskirim">Tes Kirim Data</a></li>
                                    <li><a href="${pageContext.request.contextPath}/transaksiBankDki/indextrx">Transaksi Bank DKI</a></li>
                                    <li><a href="${pageContext.request.contextPath}/spmterima">Tanda Terima SPM</a></li>
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="${pageContext.request.contextPath}/sp2drestitusi/indexsp2dres">RESTITUSI</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="${pageContext.request.contextPath}/sp2dbltu/indexsp2dbltu">SP2D TU</a></li>
                                    <li><a href="${pageContext.request.contextPath}/bankpfk/indexbankpfk">Referensi Bank PFK</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <c:if test="${pengguna.kodeSah == '3' || pengguna.kodeSah == '1'}">
                                        <li><a   href="${pageContext.request.contextPath}/sp2dsah/indexsp2dsah">
                                                VALIDASI SP2D
                                            </a></li>
                                                                                <!--li><a   href="${pageContext.request.contextPath}/sp2dsahtransfer/indextransfer">
                                            VALIDASI SP2D - TRANSFER
                                            </a></li-->
                                    ...
                                    <c:if test="${pengguna.kodeSah == '3' || pengguna.kodeSah == '2'}">
                                        <li><a   href="${pageContext.request.contextPath}/sp2dpajaktransfer/indextransfer">
                                                TRANSFER PAJAK SP2D
                                            </a></li>

                                        <li><a   href="${pageContext.request.contextPath}/sp2dpajaktransfer/indextransfercetak">
                                                Cetak PAJAK SP2D
                                            </a></li>
                                    ...
                                    <li><a   href="${pageContext.request.contextPath}/monpajaktransfer/indexmon">
                                            Monitoring PAJAK SP2D
                                        </a></li>
                                    <li><a   href="${pageContext.request.contextPath}/sp2dbatalsah/indexsp2dbatalsah">
                                            BATAL VALIDASI SP2D
                                        </a></li>
                                </ul>
                            </li>
                            ...
                            <li  >
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="${pageContext.request.contextPath}/cetaksspppn/indexppn">SSP PPN</a></li>
                                            <li><a href="${pageContext.request.contextPath}/cetakssppph21/indexpph21">SSP PPh 21</a></li>
                                            <li><a href="${pageContext.request.contextPath}/cetakssppph22/indexpph22">SSP PPh 22</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="${pageContext.request.contextPath}/cetakkartubankgaji/indexgaji">Gaji Harian</a></li>
                                            <li><a href="${pageContext.request.contextPath}/cetakkartubanknongaji/indexnongaji">Non Gaji Harian</a></li>
                                            <li><a href="${pageContext.request.contextPath}/cetakkartubankgajibul/indexgajibul">Gaji Bulanan</a></li>
                                            <li><a href="${pageContext.request.contextPath}/cetakkartubanknongajibul/indexnongajibul">Non Gaji Bulanan</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="${pageContext.request.contextPath}/registerhar/indexreghar">Register Harian</a></li>
                                            <li><a href="${pageContext.request.contextPath}/registerbul/indexregbul">Register Bulanan</a></li>
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="${pageContext.request.contextPath}/cetaksp2dpothardaf/indexsp2dpothardaf">Daftar Potongan Non Ayat Harian</a></li>
                                         <!--   <li><a href="${pageContext.request.contextPath}/cetaksp2dpotharrek/indexsp2dpotharrek">Rekap Potongan Harian</a></li>  -->
                                            <li><a href="${pageContext.request.contextPath}/cetaksp2dpotbtlblhardaf/indexsp2dpotbtlblhardaf">Daftar Potongan BTL & BL Harian</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="${pageContext.request.contextPath}/cetaksp2dpotbuldaf/indexsp2dpotbuldaf">Daftar Potongan Bulanan</a></li>
                                            <li><a href="${pageContext.request.contextPath}/cetaksp2dpotbtlblbulanan/indexpotongan">Daftar Potongan BTL & BL Bulanan</a></li>
                                         <!--   <li><a href="${pageContext.request.contextPath}/cetaksp2dpotbulrek/indexsp2dpotbulrek">Rekap Potongan Bulanan</a></li> -->

                                        </ul>
                                    </li>

                                    <li><a href="${pageContext.request.contextPath}/rekon/indexrekon">Rekon</a></li>
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="${pageContext.request.contextPath}/lappnrm/indexpnrmskpd">Realisasi Penerimaan SKPD</a></li>
                                            <li><a href="${pageContext.request.contextPath}/lappnrm/indexpnrmharian">Rekap Penerimaan Harian</a></li>
                                ...
                                <ul class="dropdown-menu">
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="${pageContext.request.contextPath}/statusspm">Monitoring Tanda Terima SPM</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <a   href="${pageContext.request.contextPath}/journalsp2d/indexjournalsp2d">
                                    JURNAL SP2D
                                </a>
                            </li>
                            ...
                            <!--   <li  >
                                 ...
                                 <ul class="dropdown-menu">
                                     <li class="dropdown-submenu">
                                         ...
                                         <ul class="dropdown-menu">
                                             <li><a href="${pageContext.request.contextPath}/cetakkartubankgaji/indexgaji">Gaji</a></li>
                                             <li><a href="${pageContext.request.contextPath}/cetakkartubanknongaji/indexnongaji">Non Gaji</a></li>
                        ...
                        <c:if test="${pengguna.kodeGrup == '12'}">
                            <li><a href="${pageContext.request.contextPath}/rekonbankdki/indexrekon">
                                    Rekonsiliasi SP2D
                                </a></li>
