...
<jsp:useBean id="bulanup" class="java.util.Date" />
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <c:if test="${pengguna.kodeGrup == '9'}">  
                            <c:if test="${tahunAnggaran == '2015'}">
                                ...
                                <li>
                                <a   href="${pageContext.request.contextPath}/bapkas/indexbapkas">
                                     BA Pemeriksaan Kas
                                </a>
                            </li>
                            ...
                            <c:if test="${tahunAnggaran > '2015'}"> 
                                <li  > 
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li> <a   href="${pageContext.request.contextPath}/saldoAwalBku/indexsaldoawal">
                                                Saldo Kas BKU
                                            </a>
                                        </li>

                                        <li> <a   href="${pageContext.request.contextPath}/bku/indexbku">
                                                Entry BKU Pengeluaran
                                            </a>
                                        </li>

					<li> <a   href="${pageContext.request.contextPath}/bkuspjpajak/indexbku">
                                                Entry BKU SPJ dengan Pajak
                                            </a>
                                        </li>
                                        

                                        <li> <a   href="${pageContext.request.contextPath}/prosesBku/indexprosesbku">
                                                Proses Jurnal BKU
                                            </a>
                                        </li>

                                        <li>
                                            <a href="${pageContext.request.contextPath}/laporanbkukeluar/indexlaporanbkukeluar">
                                                BKU Pengeluaran (Tutup)
                                            </a>
                                        </li> 

                                        <li>
                                            <a href="${pageContext.request.contextPath}/formbku/indexlaporan10">
                                                BKU Laporan Bulanan
                                            </a>
                                        </li>
                                        ...
                                        <li> <a   href="${pageContext.request.contextPath}/bkupencarian/indexbku">
                                                Pencarian BKU
                                            </a>
                                        </li>                              
                            ...
                            <li>
                                ...
                                <ul class="dropdown-menu">
                                    <c:if test="${pengguna.skpd[0].levelSkpd != '3'}">  
                                        ...
                                        <li> <a   href="${pageContext.request.contextPath}/setor/indextu">
                                                SETORAN BL - TU
                                            </a>
                                        </li>

                                        <c:set var="cekbulanup"  value="${bulanup.month+1}"/>
                                        
                                        <fmt:formatDate value="${bulanup}" pattern="yyyy" var="currentYear" />
                                        <c:set var="cektahunup"  value="${currentYear}"/>
                                        
                                        <c:if test="${cektahunup > tahunAnggaran and (cekbulanup == '01')}">
                                        ...
                                        <c:if test="${cekbulanup == '12' and cektahunup == tahunAnggaran }">
                                            <li> <a   href="${pageContext.request.contextPath}/setor/indexupgu">
                                                    SETORAN BL - UP/GU
                                                </a>
                                            </li>
                                    ...
                                    <li> <a   href="${pageContext.request.contextPath}/setor/indexbtl">
                                            SETORAN LS - BTL
                                        </a>
                                    </li>
                                    ...
                                    <li class="dropdown-submenu">
                                        <a tabindex="-1" href="javascript:;">
                                            STS Lewat Tahun - Un-Audited
                                        </a>
                                        <ul class="dropdown-menu">
                                            <li><a href="${pageContext.request.contextPath}/setorjukor">STS BL</a></li>
                                            <li><a href="${pageContext.request.contextPath}/setorjukor/indexbtl">STS BTL</a></li> 
                                        </ul>
                                    </li>
                                </ul>
                                ...
                                <ul class="dropdown-menu">
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="${pageContext.request.contextPath}/kartukendali/indexkartukendali">Form 21 : Kartu Kendali Kegiatan</a></li> 

                                        </ul>
                                    </li>
				    <li> <a   href="${pageContext.request.contextPath}/lapbelanja/indexlapblj10">
                                             LAPORAN BELANJA
                                         </a>
                                    </li>
                                </ul>
                        ...
                        <c:if test="${pengguna.kodeGrup == '11'}">  
                            <c:if test="${tahunAnggaran == '2015'}"> 
                                <li>
                                    <a   href="${pageContext.request.contextPath}/spj/indexspj">
                                        SPJ
                                ...
                                <li  > 
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="dropdown-submenu">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="${pageContext.request.contextPath}/laporanprovinsi/indexlaporan">Provinsi</a></li>
                                                <li><a href="${pageContext.request.contextPath}/laporanskpd/indexlaporan11">Jurnal</a></li>
                                                <li><a href="${pageContext.request.contextPath}/laporanlra/indexlraprovinsi">Laporan Keuangan SKPD</a></li> 
                                                <li><a href="${pageContext.request.contextPath}/bukubesarskpd/indexbbskpdall">Buku Besar</a></li> 
                                                <li><a href="${pageContext.request.contextPath}/laporanbkukeluar/indexlaporanbkukeluarprovinsi">BKU Pengeluaran</a></li> 
                                            </ul>
                                        </li>

                                        <li> <a   href="${pageContext.request.contextPath}/bkupencarian/indexbku11">
                                                Pencarian BKU
                                            </a>
                                        </li>
                                    </ul>
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown user">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="${pageContext.request.contextPath}/static/pdf/Usman_BKU-SKPD-V1.2.pdf" target="_new"><i class="icon-key"></i> User Manual </a></li>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $.validator.addMethod("ruleCekBulanSekarang", function(value, element) {
                    ...
                    var tahunlogin = ${tahunAnggaran};
                    //console.log("Tahun sysdate = " + tahun);
                    //console.log("Tahun login === " + tahunlogin);
                    var bulan = tgl.getMonth() + 1

                    if (tahun > tahunlogin) {
                        return true;//false;
                    } else {
                        //console.log("else tahun > tahunlogin");
                        if (arrbulan.length == 2)
            ...
            function formatnumberonkeyup() {
                ...
                $(".inputmoneyX").autoNumeric('init', {aSep: '.', aDec: ','});
            }
