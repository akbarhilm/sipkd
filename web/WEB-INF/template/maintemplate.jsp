...
<![endif]-->  
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $(".entrybulanlisting").mask("99/9999");
                ...
                $.validator.addMethod("ceknokontrakexist", function(value, element) {
                    var result = false;
                    if (!result) {
                        $.ajax({type: "GET", async: false, url: "${pageContext.request.contextPath}/kontrak/json/ceknokontrakeksis?nokontrak=" + value,
                            success: function(data) {
                                result = data;
                            }});
                    }
                    return result;
                }, "No Kontrak Sudah Digunakan");
                $.validator.addMethod("ruleCeknilaiKontrak", function(value, element) {
                    var nilai = accounting.unformat(value, ",");
                    return Number(nilai) <= Number($("#nilaiKontrakOrg").val());
                }, "Tidak boleh lebih besar dari nilai kontrak .");
                $.validator.addMethod("ruleCeknilaiKontrakMultiyear", function(value, element) {
                    //console.log("ruleCeknilaiKontrak nilaiKontrakOrg = "+$("#nilaiKontrakOrg").val());
                    var nilai = accounting.unformat(value, ",");
                    var nilaikontrak = accounting.unformat($("#nilaiSpd").val(), ",");
                    return Number(nilai) >= Number(nilaikontrak);
                }, "Tidak boleh lebih kecil dari nilai kontrak.");
                $.validator.addMethod("ruleCeknilaiKontrakMultiyear2", function(value, element) {
                    var nilai = accounting.unformat(value, ",");
                    var nilaitotal = accounting.unformat($("#nilaiKontrakTotal").val(), ",");
                    //console.log("ruleCeknilaiKontrakMultiyear2 nilaiKontrakTotal = " + nilaitotal);
                    //console.log("ruleCeknilaiKontrakMultiyear2 nilai input = " + nilai);
                    return Number(nilai) < Number(nilaitotal);
                }, "Tidak boleh lebih besar dari nilai kontrak multiyear.");
                $.validator.addMethod("ruleCekPersenSPj", function(value, element) {
                    //var totalAngaran = accounting.unformat($("#totalAngaran").val(), ",");
                    //var strtotalAngaran = Number(totalAngaran);
                    //var nilaiSisaPagu = Number(accounting.unformat(value, ","));//$("nilaiSisaPaguSpp").val(); 
                    //console.log(nilaiSisaPagu + "--> " + totalAngaran + " = " + (nilaiSisaPagu / strtotalAngaran))

                    var persen = $("#presentase").val();
                    //console.log("presentase == " + persen);
                    //return nilaiSisaPagu / strtotalAngaran >= 0.8;
                    return persen <= 20;
                }, "Persentase Sisa Uang Saat ini harus <= 20%.");
                //}, "SPJ harus >= 80% dari Nilai Pagu UP.");
                $.validator.addMethod("ruleCekNamaBtlPpkd", function(value, element) {
                    ...
                    if ($("#idskpd").val() == 761 || $("#idskpd").val() == 1234) {
                        if ($("#kodeBankTransfer").val() == "111") {
                            ...
                            dkinamarekan = value.toLowerCase();
                        }
                    } else {
                        dkinamarekan = value.toLowerCase();
                    }
                    console.log("ruleCekNamaBtlPpkd namarekan = " + namarekan);
                    console.log("ruleCekNamaBtlPpkd dkinamarekan = " + dkinamarekan);
                    return namarekan == dkinamarekan;
                }, "Nama Harus Sesuai dengan Nama dari Data Bank DKI");

                $.validator.addMethod("ruleCekCIF", function(value, element) {

                    var norek = value;
                    var dkinama = $("#dkinama").val();

                    if (dkinama == "Rekening Tidak Ada Pada Master/Rekening Tidak Aktif" || dkinama == "") {
                        dkinama = "TIDAK ADA";
                    } else {
                        dkinama = norek;
                    }

                    return norek == dkinama;
                }, "No Rekening Tidak Dikenal");

                $.validator.addMethod("ruleCekCIF111", function(value, element) {

                    var norek = value;
                    var dkinama = $("#dkinama").val();

                    if ($("#kodeBankTransfer").val() == "111") {
                        if (dkinama == "Rekening Tidak Ada Pada Master/Rekening Tidak Aktif") {
                            dkinama = "TIDAK ADA";
                        } else {
                            dkinama = norek;
                        }
                    ...
                    //console.log("dkinama = " + dkinama);

                    return norek == dkinama;
                }, "No Rekening Tidak Dikenal");

                $.validator.addMethod("ruleCekNamaBtlSkpd", function(value, element) {

                    var namarekan = value.toLowerCase();
                    var dkinamarekan; //= $("#dkinama").val().toLowerCase();
                    //console.log("idskpd maintemplate = " + $("#idskpd").val());
                    if ($("#idskpd").val() == 761 || $("#idskpd").val() == 1234) {
                        dkinamarekan = value.toLowerCase();
                    } else {
                        if ($("#kodeBankTransfer").val() == "111") {
                    ...
                    /*
                     if (($("#kodeBankTransfer").val() == "111") && ($("#idskpd").val() !== 761)) {
                     console.log("idskpd maintemplate masuk <> 761 = " + $("#idskpd").val());
                     dkinamarekan = $("#dkinama").val().toLowerCase();
                     } else {
                     dkinamarekan = value.toLowerCase();
                     }*/
                ...
                $.validator.addMethod("ruleCekNamaRekanan", function(value, element) {
                    ...
                    //console.log("kodeBankTransfer maintemplate = " + $("#kodeBankTransfer").val());
                    if ($("#kodeBankTransfer").val() == "111" && kodeva == "0") {
                        dkinamarekan = $("#dkinama").val().toLowerCase();
                    } else {
                        dkinamarekan = value.toLowerCase();
                    }
                ...
                $.validator.addMethod("ruleCekGeneralError", function(value, element) {

                    var cek;
                    var namarekan = value.toUpperCase();
                    var kodeva = $("#kodeVA").val();

                    if ($("#kodeBankTransfer").val() == "111" && kodeva == "0") {
                        if (namarekan == "GENERAL ERROR") {
                            cek = "ERROR";
                        } else {
                            cek = "VALID";
                        }
                    ...
                    return cek == "VALID";
                }, "General Error Data Bank DKI");

                $.validator.addMethod("ruleCekNamaBantuan", function(value, element) {
                ...
                $.validator.addMethod("ruleCekNpwpRekanan", function(value, element) {

                    var npwprekan = value;
                    var dkinpwprekan;
                    if ($("#kodeBankTransfer").val() == "111") {
                        dkinpwprekan = $("#dkinpwp").val();
                    } else {
                        dkinpwprekan = value;
                    }
                    return npwprekan == dkinpwprekan;
                }, "NPWP Perusahaan Harus Sesuai dengan NPWP dari Data Bank DKI");
                $.validator.addMethod("cekPaguUp", function(value, element) {
                    var nilai = accounting.unformat(value, ",");
                    var totalAngaran = accounting.unformat($("#totalAngaran").val(), ",");
                    //console.log("cekPaguUp total spp = " + nilai);
                    //console.log("cekPaguUp pagu up = " + totalAngaran);
                    return nilai == totalAngaran;
                }, "Tolal SPP UP Harus Sama Dengan Pagu UP");
                $.validator.addMethod("cekJumkotSimpeg", function(value, element) {
                    var nilai = accounting.unformat(value, ",");

                    return Number(nilai) > Number(0);
                }, "Pilih Data Simpeg Terlebih Dulu");

                $.validator.addMethod("ruleBulanListing", function(value, element) {
                    var bulan = value.substr(0, 2);
                    var tahun = value.substring(3);
                    //var tahunangg = ${tahunAnggaran};
                    console.log("ruleBulanListing value bulan = " + value.substr(0, 2));
                ...
                }, "Bulan Listing Tidak Boleh Lebih Besar Dari 10/2017");
    ...
    <body class="page-header-fixed page-full-width" >
                    ...
                    <ul class="nav navbar-nav">
                        <c:if test="${pengguna.kodeGrup == '6'}">
                            <li  >
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="${pageContext.request.contextPath}/sppup/indexspppup">SPP UP</a></li>
                                    <li><a href="${pageContext.request.contextPath}/sppgu/indexsppgu">SPP GU</a></li>
                                    <li class="dropdown-submenu">
                                        <a tabindex="-1" href="javascript:;">SPP LS </a>
                                        <ul class="dropdown-menu">
                                            <li><a href="${pageContext.request.contextPath}/kontrak">Kontrak</a></li>
                                            <li><a href="${pageContext.request.contextPath}/bast">Berita Acara Serah Terima</a></li>                                      
                                            <li><hr/></li>
                                            <li><a href="${pageContext.request.contextPath}/bl/indexsppbl">BL</a></li>
                                            <li><a href="${pageContext.request.contextPath}/btl/indexbtl">BTL</a></li>
                                            <li><a href="${pageContext.request.contextPath}/btlgaji/indexbtl">BTL PENGHASILAN</a></li>
                                                <c:if test="${pengguna.skpd[0].isPendapatan == '1'}">   
                                                <li><a href="${pageContext.request.contextPath}/restitusi/indexres">Restitusi</a></li>
                                                </c:if>
                                                <c:if test="${pengguna.skpd[0].levelSkpd == '3'}">   
                                                <li><a href="${pageContext.request.contextPath}/sppbantuan/indexsppbantuan">BANTUAN</a></li>
                                                <li><a href="${pageContext.request.contextPath}/bankbantuan/addbank">Set Bank Spp BANTUAN</a></li>
                                                <li><a href="${pageContext.request.contextPath}/biaya/indexbiaya">BIAYA</a></li>
                                                </c:if>
                                        </ul>
                                    </li>
                                    <li><a href="${pageContext.request.contextPath}/spptu/indexspptu">SPP TU</a></li>
                                </ul>
                            </li>


                            <li>
                                <a   href="${pageContext.request.contextPath}/cetakspp/indexspppup">
                                    CETAK SPP
                                </a>
                            </li>

                            <li>
                                <a   href="${pageContext.request.contextPath}/monitoringbtl/indexmonbtl">
                                    MONITORING BTL 
                                </a>
                            </li>

                            <li>
                                <a   href="${pageContext.request.contextPath}/nrkservice/indexnrk">
                                    NRK
                                </a>
                            </li>
                            ...
                            <% /* <li  > 
                                 ...
                                 <ul class="dropdown-menu">
                                 <li><a href="${pageContext.request.contextPath}/monitoringbtl/indexmonitoringbtl">Belanja Tidak Langsung</a></li>
                                 <li><a href="${pageContext.request.contextPath}/monitoringbantuan/indexmonitoringbantuan">Belanja Tidak Langsung Bantuan</a></li> 
                                 <li><a href="${pageContext.request.contextPath}/monitoringbl/indexmonitoringbl">Belanja Langsung</a></li> 
                                 <li><a href="${pageContext.request.contextPath}/monitoringbiaya/indexmonitoringbiaya">Pembiayaan Pengeluaran</a></li> 
                                 </ul>
                                 </li>
                                 </ul>
                                 </li> */ %>
                        ...
                        <c:if test="${pengguna.kodeGrup == '7'}">   
                            <li  >
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="${pageContext.request.contextPath}/spmup/indexspmup">SPM UP</a></li>
                                    <li><a href="${pageContext.request.contextPath}/spmgu/indexspmgu">SPM GU</a></li>
                                    <li class="dropdown-submenu">
                                        <a tabindex="-1" href="javascript:;">SPM LS </a>
                                        <ul class="dropdown-menu">

                                            <li><a href="${pageContext.request.contextPath}/spmblls/indexspmblls">BL</a></li>
                                            <li><a href="${pageContext.request.contextPath}/spmbtlls/indexspmbtlls">BTL</a></li>
                                                <c:if test="${pengguna[0].skpd.levelSkpd == '3'}">  
                                                <li><a href="${pageContext.request.contextPath}/spmbtlbantuan/indexspmbtlbantuan">BANTUAN</a></li>
                                                <li><a href="${pageContext.request.contextPath}/spmbiayals/indexspmbiayals">BIAYA</a></li>
                                                </c:if>
                                        </ul>
                                    </li>
                                    <li><a href="${pageContext.request.contextPath}/spmtu/indexspmtu">SPM TU</a></li>
                                </ul>
                            </li>    

                            <li>
                                <a   href="${pageContext.request.contextPath}/cetakspm/indexspmup">
                                    CETAK SPM
                                </a>
                            </li>
                        </c:if>
                        <c:if test="${pengguna.kodeGrup == '8'}">   
                            <li  >
                                <a data-toggle="dropdown" data-hover="dropdown" data-close-others="true" class="dropdown-toggle" href="javascript:;">
                                    <span class="selected"></span>
                                    SP2D
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="${pageContext.request.contextPath}/sp2dupgu/indexsp2dupgu">SP2D UP/GU</a></li>
                                        <%/*   <li><a href="${pageContext.request.contextPath}/sp2d/index">SP2D UP/GU</a></li>*/%>
                                    <li class="dropdown-submenu">
                                        <a tabindex="-1" href="javascript:;">SP2D LS </a>
                                        <ul class="dropdown-menu">
                                            <li><a href="${pageContext.request.contextPath}/sp2dblls/indexsp2dblls">BL</a></li>
                                            <li><a href="${pageContext.request.contextPath}/sp2dbtlls/indexsp2dbtlls">BTL</a></li>
                                            <li><a href="${pageContext.request.contextPath}/sp2dbantuanls/indexsp2dbantuanls">BANTUAN</a></li>
                                            <li><a href="${pageContext.request.contextPath}/sp2dbiayals/indexsp2dbiayals">BIAYA</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="${pageContext.request.contextPath}/sp2dbltu/indexsp2dbltu">SP2D TU</a></li>
                                </ul>
                            </li>

                            <li>
                                <a   href="${pageContext.request.contextPath}/cetaksp2d/indexsp2dup">
                                    CETAK SP2D
                                </a>
                            </li>

                            <li>
                                <a   href="${pageContext.request.contextPath}/sp2dsah/indexsp2dsah">
                                    SP2D SAH
                                </a>
                            </li>

                        </c:if>
                        <c:if test="${pengguna.kodeGrup == '9'}">  

                            <li>
                                <a   href="${pageContext.request.contextPath}/spj/indexspj">
                                    SPJ
                                </a>
                            </li>
                            <li>
                                <a   href="${pageContext.request.contextPath}/cetakspj/indexspj">
                                    CETAK SPJ
                                </a>
                            </li>
                            <li>
                                <a   href="${pageContext.request.contextPath}/spjsah/indexspjsah">
                                    SPJ SAH
                                </a>
                            </li>
                            <li>
                                <a   href="${pageContext.request.contextPath}/npd/indexnpd">
                                    NOTA PENCAIRAN DANA (NPD)
                                </a>
                            </li>

                            <li>
                                <a data-toggle="dropdown" data-hover="dropdown" href="javascript:;">SETORAN</a> 
                                <<ul>
                                    <li> <a   href="${pageContext.request.contextPath}/setor">
                                            SETORAN BL
                                        </a>
                                    </li>

                                    <li> <a   href="${pageContext.request.contextPath}/setor/indexupgu">
                                            SETORAN UP/GU
                                        </a>
                                    </li>

                                    <li> <a   href="${pageContext.request.contextPath}/setor/indexbiaya">
                                            SETORAN BIAYA
                                        </a>
                                    </li>

                                    <li> <a   href="${pageContext.request.contextPath}/setor/indexbantuan">
                                            SETORAN BANTUAN
                                        </a>
                                    </li>
                            ...
                            <li>
                                <a   href="${pageContext.request.contextPath}/monitoringspd/indexmonitoringspd">
                                    M SPD
                                </a>
                            </li>
                            <li>
                                <a   href="${pageContext.request.contextPath}/cetaksetor/indexsetor">
                                    Cetak Setoran
                                </a>
                            </li>
                            <li>
                                <a   href="${pageContext.request.contextPath}/cetaknpd/indexnpd">
                                    Cetak NPD
                                </a>
                            </li>
                        </c:if>
                        <c:if test="${pengguna.kodeGrup == '99'}">       
                            <li>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="${pageContext.request.contextPath}/rekanan">Rekanan</a></li>
                                    <li><a href="${pageContext.request.contextPath}/bank">Bank</a></li>
                                    <li><a href="${pageContext.request.contextPath}/urusan">Urusan</a></li>
                                    <li><a href="${pageContext.request.contextPath}/program">Program</a></li>
                                    <li><a href="${pageContext.request.contextPath}/bankrek">Rekening Bank</a></li>

                                    <li><a href="${pageContext.request.contextPath}/refakun/index">Akun</a></li>
                                    <li><a href="${pageContext.request.contextPath}/refskpd/index">Skpd</a></li>
                                    <li><a href="${pageContext.request.contextPath}/refskpd/index">Pejabat Skpd</a></li> 
                                    <li><a href="${pageContext.request.contextPath}/refftmdpa">Pejabat Skpd SPP</a></li>                                                                   
                                </ul>
                            </li>
                        </c:if>
        ...
        <div class="footer">
            <div class="footer-inner">
                ${tahunAnggaran} &copy; Diskominfomas Pemprov DKI Jakarta.
            </div>
