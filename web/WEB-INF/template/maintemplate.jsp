...
<jsp:useBean id="vardate" class="java.util.Date" />
<!DOCTYPE html>
...
<![endif]-->  
    ...
    <body class="page-header-fixed page-full-width" >
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="${pageContext.request.contextPath}/spmrestitusi/indexres">Restitusi</a></li>
                                                <c:if test="${skpd.levelSkpd == '3'}">  
        ...
        <!-- BEGIN FOOTER -->
        <div class="footer">
            <fmt:formatDate value="${vardate}" pattern="yyyy" var="currentYear" />
            <c:set var="cektahun"  value="${currentYear}"/>
            <div class="footer-inner">
                ${cektahun} &copy; Diskominfotik Pemprov DKI Jakarta. 
            </div>
