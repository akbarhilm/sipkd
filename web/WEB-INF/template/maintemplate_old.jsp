    ...
    <body class="page-header-fixed page-full-width" >
        ...
        <div id='header' class="header navbar navbar-inverse navbar-fixed-top">
            ...
            <div class="header-inner">
                ...
                <c:set var="sekolah" value="${pengguna.sekolah[0]}" scope="session" />
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown user">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            <span class="username">Tahun Anggaran : ${tahunAnggaran}</span>|<span class="username">${sekolah.namaSekolahPendek}</span> / <span class="username">${pengguna.namaPengguna} </span>
                            <i class="icon-angle-down"></i>
                        </a>
                        <ul class="dropdown-menu">
